...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626120153746.png" alt="image-20230626120153746"></p>
<blockquote>
<p>基于 token 方式如下图：</p>
</blockquote>
<p>​ 它的交互流程是，用户认证成功后，服务端生成一个 token 发给客户端，客户端可以放到 cookie 或 localStorage 等存储中，每次请求时带上 token，服务端收到 token 通过验证后即可确认用户身份。</p>
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626120345666.png" alt="image-20230626120345666"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626121351820.png" alt="image-20230626121351820"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626121620465.png" alt="image-20230626121620465"></p>
...
<p>修改后数据模型之间的关系如下图：</p>
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626122012499.png" alt="image-20230626122012499"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626125500472.png" alt="image-20230626125500472"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626125950501.png" alt="image-20230626125950501"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626130325795.png" alt="image-20230626130325795"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626130809341.png" alt="image-20230626130809341"></p>
<p>引入如下依赖如下，注意：</p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626134828525.png" alt="image-20230626134828525"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626142432503.png" alt="image-20230626142432503"></p>
<p><strong>填入错误的用户信息，页面返回错误信息：</strong></p>
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626142454601.png" alt="image-20230626142454601"></p>
<p><strong>填入正确的用户信息，页面提示登录成功：</strong></p>
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626142517248.png" alt="image-20230626142517248"></p>
...
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626153953958.png" alt="image-20230626153953958"></p>
<p>成功登录的情况下访问测试资源/r/r1：</p>
<p><img src="@source/notes/record/Spring Security OAuth2.0认证授权/assets/image-20230626154021880.png" alt="image-20230626154021880"></p>
<blockquote>
