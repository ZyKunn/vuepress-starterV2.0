<template><div><h1 id="第-2-章-内容管理模块-v3-1" tabindex="-1"><a class="header-anchor" href="#第-2-章-内容管理模块-v3-1" aria-hidden="true">#</a> <strong>第 2 章 内容管理模块 v3.1</strong></h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-模块需求分析">1 模块需求分析</router-link><ul><li><router-link to="#_1-1-什么是需求分析">1.1 什么是需求分析</router-link></li><li><router-link to="#_1-2-模块介绍">1.2 模块介绍</router-link></li><li><router-link to="#_1-3-业务流程">1.3 业务流程</router-link></li><li><router-link to="#_1-4-界面原型">1.4 界面原型</router-link></li><li><router-link to="#_1-5-数据模型">1.5 数据模型</router-link></li></ul></li><li><router-link to="#_2-创建模块工程">2. 创建模块工程</router-link><ul><li><router-link to="#_2-1-模块工程结构">2.1 模块工程结构</router-link></li><li><router-link to="#_2-2-创建模块工程">2.2 创建模块工程</router-link></li></ul></li><li><router-link to="#_3-课程查询">3.课程查询</router-link><ul><li><router-link to="#_3-1-需求分析">3.1 需求分析</router-link></li><li><router-link to="#_3-2-创建数据库表及-po-类型">3.2 创建数据库表及 PO 类型</router-link></li><li><router-link to="#_3-3-设计接口">3.3 设计接口</router-link></li><li><router-link to="#_3-4-生成接口文档">3.4 生成接口文档</router-link></li><li><router-link to="#_3-5-开发持久层">3.5 开发持久层</router-link></li><li><router-link to="#_3-6-开发业务层">3.6 开发业务层</router-link></li><li><router-link to="#_3-7-接口测试">3.7 接口测试</router-link></li><li><router-link to="#_3-8-前后端联调">3.8 前后端联调</router-link></li></ul></li><li><router-link to="#_4-课程分类查询">4 课程分类查询</router-link><ul><li><router-link to="#_4-1-需求分析">4.1 需求分析</router-link></li><li><router-link to="#_4-2-接口定义">4.2 接口定义</router-link></li><li><router-link to="#_4-3-接口开发">4.3 接口开发</router-link></li></ul></li><li><router-link to="#_5-新增课程">5 新增课程</router-link><ul><li><router-link to="#_5-1-需求分析">5.1 需求分析</router-link></li><li><router-link to="#_5-2-接口定义">5.2 接口定义</router-link></li><li><router-link to="#_5-3-接口开发">5.3 接口开发</router-link></li><li><router-link to="#_5-4-接口测试">5.4 接口测试</router-link></li><li><router-link to="#_5-6-异常处理">5.6 异常处理</router-link></li><li><router-link to="#_5-7-jsr303-校验">5.7 JSR303 校验</router-link></li></ul></li><li><router-link to="#_6-修改课程">6 修改课程</router-link><ul><li><router-link to="#_6-1-需求分析">6.1 需求分析</router-link></li><li><router-link to="#_6-2-接口定义">6.2 接口定义</router-link></li><li><router-link to="#_6-3-接口开发">6.3 接口开发</router-link></li><li><router-link to="#_5-4-接口测试-1">5.4 接口测试</router-link></li></ul></li><li><router-link to="#_7-查询课程计划">7 查询课程计划</router-link><ul><li><router-link to="#_7-1-需求分析">7.1 需求分析</router-link></li><li><router-link to="#_7-2-接口定义">7.2 接口定义</router-link></li><li><router-link to="#_7-3-接口开发">7.3 接口开发</router-link></li><li><router-link to="#_6-4-接口测试">6.4 接口测试</router-link></li></ul></li><li><router-link to="#_8-新增-修改计划">8 新增/修改计划</router-link><ul><li><router-link to="#_8-1-需求分析">8.1 需求分析</router-link></li><li><router-link to="#_8-2-接口定义">8.2 接口定义</router-link></li><li><router-link to="#_8-3-接口开发">8.3 接口开发</router-link></li><li><router-link to="#_8-4-接口测试">8.4 接口测试</router-link></li><li><router-link to="#_8-5-bug-修改">8.5 Bug 修改</router-link></li></ul></li><li><router-link to="#_9-项目实战">9 项目实战</router-link><ul><li><router-link to="#_9-1-实战环境">9.1 实战环境</router-link></li><li><router-link to="#_9-2-删除课程计划">9.2 删除课程计划</router-link></li><li><router-link to="#_9-3-课程计划排序">9.3 课程计划排序</router-link></li><li><router-link to="#_9-4-师资管理">9.4 师资管理</router-link></li><li><router-link to="#_9-5-删除课程">9.5 删除课程</router-link></li></ul></li></ul></nav>
<h2 id="_1-模块需求分析" tabindex="-1"><a class="header-anchor" href="#_1-模块需求分析" aria-hidden="true">#</a> <strong>1 模块需求分析</strong></h2>
<h3 id="_1-1-什么是需求分析" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是需求分析" aria-hidden="true">#</a> <strong>1.1 什么是需求分析</strong></h3>
<p>在百度百科中对需求分析的定义如下：</p>
<p>需求分析也称为软件需求分析、系统需求分析或需求分析工程等，是开发人员经过深入细致的调研和分析，准确理解用户和项目的功能、性能、可靠性等具体要求，将用户非形式的需求表述转化为完整的需求定义，从而确定系统必须做什么的过程。</p>
<p>简单理解就是要搞清楚问题域，问题域就是用户的需求，软件要为用户解决什么问题，实现哪些业务功能，满足什么样的性能要求。</p>
<p>如何作需求分析？</p>
<p><strong>第一：首先确认用户需求</strong></p>
<p>用户需求即用户的原始需求。</p>
<p>通过用户访谈、问卷调查、开会讨论、查阅资料等调研手段梳理用户的原始需求。</p>
<p>产品人员根据用户需求会绘制界面原型，通过界面原型再和用户确认需求。</p>
<p><strong>第二：确认关键问题</strong></p>
<p>用户的原始需求可能 是含糊不清的，需求分析要从繁杂的问题中梳理出关键问题。</p>
<p>比如：教学机构的老师想要将课程发布到网上，这是原始需求，根据这个用户需求我们需要进行扩展分析，扩展出几下几点：</p>
<p>1）课程发布需要发布哪些信息</p>
<p>2）如果发布了不良信息怎么办？</p>
<p>3）课程发布后用户怎么查看课程？</p>
<p>根据以上几点继续延伸性分析：</p>
<p>1）课程发布需要发布哪些信息</p>
<p>课程名称、课程介绍、课程价格、课程图片、师资等信息</p>
<p>继续延伸分析：</p>
<p>这么多课程信息进行归类，方便用户编辑，分为课程基本信息、课程营销信息、课程师资等信息。</p>
...
<p><strong>第三：梳理业务流程</strong></p>
<p>业务流程是由一个或多个用户参与完成为了完成一个目标所进行的一系列的业务操作，不论是整个系统还是一个模块通常首先分析核心的业务流程，比如：内容管理模块的核心业务流程是课程发布，本项目的核心业务流程是学生选课学习流程。</p>
<p><strong>第四：数据建模</strong></p>
<p>数据建模要根据分析的关键问题将其相关的信息全部建模。比如：根据发布课程的用户需求，可创建课程基本信息表、课程营销信息表、课程师资表、课程发布记录表、课程审核记录表等。</p>
<p><strong>第五：编写需求规格说明书</strong></p>
...
<tr>
<td>数据描述</td>
<td>课程基本信息：课程 id、课程名称、课程介绍、课程大分类、课程小分类、课程等级、课程图片、所属机构、课程创建时间、课程修改时间、课程状态</td>
</tr>
<tr>
<td>后置条件</td>
<td>向课程基本信息插入一条记录</td>
...
<h3 id="_1-2-模块介绍" tabindex="-1"><a class="header-anchor" href="#_1-2-模块介绍" aria-hidden="true">#</a> <strong>1.2 模块介绍</strong></h3>
<p>内容管理这个词存在于很多软件系统，什么是内容管理 ？</p>
<p>通过百度百科查询其意思：</p>
<p><a href="https://baike.baidu.com/item/%E5%86%85%E5%AE%B9%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F/2683135?fromtitle=%E5%86%85%E5%AE%B9%E7%AE%A1%E7%90%86&amp;fromid=9868820&amp;fr=aladdin" target="_blank" rel="noopener noreferrer">https://baike.baidu.com/item/内容管理系统/2683135?fromtitle=内容管理&amp;fromid=9868820&amp;fr=aladdin<ExternalLinkIcon/></a></p>
<p>内容管理系统（content management system，CMS），是一种位于 WEB 前端（Web 服务器）和后端办公系统或流程（内容创作、编辑）之间的软件系统。内容的创作人员、编辑人员、发布人员使用内容管理系统来提交、修改、审批、发布内容。这里指的“内容”可能包括文件、表格、图片、数据库中的数据甚至视频等一切你想要发布到 Internet、Intranet 以及 Extranet 网站的信息。</p>
<p>本项目作为一个大型的在线教育平台，其内容管理模块主要对<strong>课程及相关内容进行管理</strong>，包括：课程的基本信息、课程图片、课程师资信息、课程的授课计划、课程视频、课程文档等内容的管理。</p>
<h3 id="_1-3-业务流程" tabindex="-1"><a class="header-anchor" href="#_1-3-业务流程" aria-hidden="true">#</a> <strong>1.3 业务流程</strong></h3>
<p>内容管理的业务由教学机构人员和平台的运营人员共同完成。</p>
<p>教学机构人员的业务流程如下：</p>
<p>1、登录教学机构。</p>
<p>2、维护课程信息，添加一门课程需要编辑课程的基本信息、上传课程图片、课程营销信息、课程计划、上传课程视频、课程师资信息等内容。</p>
<p>3、课程信息编辑完成，通过课程预览确认无误后提交课程审核。</p>
<p>4、待运营人员对课程审核通过后方可进行课程发布。</p>
<p>运营人员的业务流程如下：</p>
<p>1、查询待审核的课程信息。</p>
<p>2、审核课程信息。</p>
<p>3、提交审核结果。</p>
<p>下图是课程编辑与发布的整体流程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012053687.png" alt="image-20230518012053687"></p>
<h3 id="_1-4-界面原型" tabindex="-1"><a class="header-anchor" href="#_1-4-界面原型" aria-hidden="true">#</a> <strong>1.4 界面原型</strong></h3>
<p>产品工程师根据用户需求制作产品界面原型，开发工程师除了根据用户需求进行需求分析以外，还会根据界面原型上的元素信息进行需求分析。</p>
<p>内容管理模块的界面原型如下：</p>
<p>课程列表 ：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012101829.png" alt="image-20230518012101829"></p>
<p>点击添加课程：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012108661.png" alt="image-20230518012108661"></p>
<p>选择录播课程 ，填写课程信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012118795.png" alt="image-20230518012118795"></p>
<p>填写课程计划信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012126607.png" alt="image-20230518012126607"></p>
<p>填写课程师资信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012133592.png" alt="image-20230518012133592"></p>
<p>课程填写完毕进行课程 发布：</p>
<p>当审核状态为通过时发布按钮点亮，点击发布按钮 即可对该课程进行发布。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012141019.png" alt="image-20230518012141019"></p>
<h3 id="_1-5-数据模型" tabindex="-1"><a class="header-anchor" href="#_1-5-数据模型" aria-hidden="true">#</a> <strong>1.5 数据模型</strong></h3>
<p>内容管理模块的基础表涉及 9 张，如下：</p>
<p>使用 PowerDesigner 打开课程资料下的 &quot;数据库\模型\学成在线项目.sws&quot;</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012147207.png" alt="image-20230518012147207"></p>
<h2 id="_2-创建模块工程" tabindex="-1"><a class="header-anchor" href="#_2-创建模块工程" aria-hidden="true">#</a> <strong>2. 创建模块工程</strong></h2>
<h3 id="_2-1-模块工程结构" tabindex="-1"><a class="header-anchor" href="#_2-1-模块工程结构" aria-hidden="true">#</a> <strong>2.1 模块工程结构</strong></h3>
<p>在第一章节创建了项目父工程、项目基础工程，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012155483.png" alt="image-20230518012155483"></p>
<p>接下来要创建内容管理模块的工程结构。</p>
<p>本项目是一个前后端分离项目，前端与后端开发人员之间主要依据接口进行开发。</p>
<p>下图是前后端交互的流程图：</p>
<p>1、前端请求后端服务提供的接口。（通常为 http 协议 ）</p>
<p>2、后端服务的控制层 Controller 接收前端的请求。</p>
<p>3、Contorller 层调用 Service 层进行业务处理。</p>
<p>4、Service 层调用 Dao 持久层对数据持久化。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012204204.png" alt="image-20230518012204204"></p>
<p>整个流程分为前端、接口层、业务层三部分。</p>
<p>所以模块工程的结构如下图所示：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012209876.png" alt="image-20230518012209876"></p>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012216901.png" alt="image-20230518012216901"></p>
<p>xuecheng-plus-content：内容管理模块工程，负责聚合 xuecheng-plus-content-api、xuecheng-plus-content-service、xuecheng-plus-content-model。</p>
<h3 id="_2-2-创建模块工程" tabindex="-1"><a class="header-anchor" href="#_2-2-创建模块工程" aria-hidden="true">#</a> <strong>2.2 创建模块工程</strong></h3>
<p>1、首先在项目根目录创建内容管理模块的父工程 xuecheng-plus-content</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012229315.png" alt="image-20230518012229315"></p>
<p>创建完成，只保留 pom.xml 文件，删除多余的文件。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于 xuecheng-plus-content-api 和 xuecheng-plus-content-service 两个工程还没有创建所以 modules 报错。</p>
<p>2、在 xuecheng-plus-content 下创建 xuecheng-plus-content-model 数据模型工程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012323194.png" alt="image-20230518012323194"></p>
<p>创建完成，只保留包和 pom.xml 文件 ，删除多余的文件。</p>
<p>修改 pom.xml 文件</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8"?></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>project</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0<span class="token punctuation">"</span></span> <span class="token attr-name"><span class="token namespace">xmlns:</span>xsi</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.w3.org/2001/XMLSchema-instance<span class="token punctuation">"</span></span>
         <span class="token attr-name"><span class="token namespace">xsi:</span>schemaLocation</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、在 xuecheng-plus-content 下创建 xuecheng-plus-content-service 接口实现工程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012356986.png" alt="image-20230518012356986"></p>
<p>创建完成，只保留包和 pom.xml 文件 ，删除多余的文件，pom.xml 如下：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8"?></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>project</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0<span class="token punctuation">"</span></span> <span class="token attr-name"><span class="token namespace">xmlns:</span>xsi</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.w3.org/2001/XMLSchema-instance<span class="token punctuation">"</span></span>
     <span class="token attr-name"><span class="token namespace">xsi:</span>schemaLocation</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>modelVersion</span><span class="token punctuation">></span></span>4.0.0<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>modelVersion</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4、在 xuecheng-plus-content 下创建 xuecheng-plus-content-api 接口工程。</p>
<p>xuecheng-plus-content-api 接口工程的父工程是 xuecheng-plus-content，它依赖了 xuecheng-plus-base 基础工程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012443448.png" alt="image-20230518012443448"></p>
<p>编辑 pom.xml</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8"?></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>project</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0<span class="token punctuation">"</span></span> <span class="token attr-name"><span class="token namespace">xmlns:</span>xsi</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.w3.org/2001/XMLSchema-instance<span class="token punctuation">"</span></span>
         <span class="token attr-name"><span class="token namespace">xsi:</span>schemaLocation</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此内容管理模块的四个工程创建完毕，工程结构图如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012510205.png" alt="image-20230518012510205"></p>
<h2 id="_3-课程查询" tabindex="-1"><a class="header-anchor" href="#_3-课程查询" aria-hidden="true">#</a> <strong>3.课程查询</strong></h2>
<h3 id="_3-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_3-1-需求分析" aria-hidden="true">#</a> <strong>3.1 需求分析</strong></h3>
<h4 id="_3-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_3-1-1-业务流程" aria-hidden="true">#</a> <strong>3.1.1 业务流程</strong></h4>
<p>课程查询的业务流程如下：</p>
<p>1、教学机构人员点击课程管理首先进入课程查询界面，如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012519204.png" alt="image-20230518012519204"></p>
<p>2.在课程进行列表查询页面输入查询条件查询课程信息</p>
<p>当不输入查询条件时输入全部课程信息。</p>
<p>输入查询条件查询符合条件的课程信息。</p>
<p>约束：本教学机构查询本机构的课程信息。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012523811.png" alt="image-20230518012523811"></p>
<h4 id="_3-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_3-1-2-数据模型" aria-hidden="true">#</a> <strong>3.1.2 数据模型</strong></h4>
...
<p>2、查询结果：</p>
<p>查询结果中包括：课程 id、课程名称、任务数、创建时间、是否付费、审核状态、类型，操作</p>
<p>任务数：该课程所包含的课程计划数，即课程章节数。</p>
<p>是否付费：课程包括免费、收费两种。</p>
<p>类型：录播、直播。</p>
<p>因为是分页查询所以查询结果中还要包括总记录数、当前页、每页显示记录数。</p>
<h3 id="_3-2-创建数据库表及-po-类型" tabindex="-1"><a class="header-anchor" href="#_3-2-创建数据库表及-po-类型" aria-hidden="true">#</a> <strong>3.2 创建数据库表及 PO 类型</strong></h3>
<h4 id="_3-2-1-创建数据库表" tabindex="-1"><a class="header-anchor" href="#_3-2-1-创建数据库表" aria-hidden="true">#</a> <strong>3.2.1 创建数据库表</strong></h4>
<p>1、创建内容管理数据库</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012532513.png" alt="image-20230518012532513"></p>
<p>2、向创建的内容管理数据库导入数据</p>
<p>选择课程资料中的 xc_content.sql 脚本，这里使用 DataGrid 客户端工具连接 mysql 并执行脚本。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012540653.png" alt="image-20230518012540653"></p>
<p>执行成功，查询 course_base 数据表，如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012552705.png" alt="image-20230518012552705"></p>
<h4 id="_3-2-2-生成-po-类" tabindex="-1"><a class="header-anchor" href="#_3-2-2-生成-po-类" aria-hidden="true">#</a> <strong>3.2.2 生成 PO 类</strong></h4>
<p>PO 即持久对象(Persistent Object)，它们是由一组属性和属性的 get 和 set 方法组成，PO 对应于数据库的表。</p>
<p>在开发持久层代码时需要根据数据表编写 PO 类，在实际开发中通常使用代码生成器（工具）生成 PO 类的代码。</p>
<p>由于在需求分析阶段对数据模型进行分析，PO 类对应于数据模型，所以在需求分析阶段即可使用工具生成 PO 类，为下面的接口定义准备好模型类。</p>
<p>在企业开发中通常使用代码生成工具去自动生成这些文件，</p>
<p>本项目使用 mybatis-plus 的 generator 工程生成 PO 类、Mapper 接口、Mapper 的 xml 文件，地址在：<a href="https://github.com/baomidou/generator" target="_blank" rel="noopener noreferrer">https://github.com/baomidou/generator<ExternalLinkIcon/></a></p>
<p>将课程资料目录下的 xuecheng-plus-generator.zip 解压后拷贝至项目工程根目录，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012629035.png" alt="image-20230518012629035"></p>
<p>打开 IDEA 将其导入项目工程 ，打开 xuecheng-plus-generator 工程的 pom.xml，右键 点击“Add as Maven Project” 自动识别 maven 工程。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012636611.png" alt="image-20230518012636611"></p>
<p>本次生成内容管理模块的 PO 类、Mapper 接口和 Mapper 的 xml 文件 ，找到 ContentCodeGenerator 类，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012644272.png" alt="image-20230518012644272"></p>
<p>修改 ContentCodeGenerator 类中的信息，包括：数据库地址、数据库账号、数据库密码、生成的表、生成路径，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//数据库账号</span>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012819731.png" alt="image-20230518012819731"></p>
<p>在该包下自动生成了内容管理模块的 controller、mapper、po 及 service 相关代码，这里我们只需要 po 类。</p>
<p>将 po 类拷贝到 model 工程</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518012826018.png" alt="image-20230518012826018"></p>
<p>打开一个 PO 类发现编译报错，这是缺少依赖包导致，本项目使用的持久层框架是 MyBatisPlus，在生成的 po 类中加了一些 MyBatisPlus 框架的注解，这里需要添加 MyBatisPlus 框架的依赖，消除错误。</p>
<p>下边在 model 工程添加依赖</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-设计接口" tabindex="-1"><a class="header-anchor" href="#_3-3-设计接口" aria-hidden="true">#</a> <strong>3.3 设计接口</strong></h3>
<h4 id="_3-3-1-接口设计分析" tabindex="-1"><a class="header-anchor" href="#_3-3-1-接口设计分析" aria-hidden="true">#</a> <strong>3.3.1 接口设计分析</strong></h4>
<p>设计一个接口需要包括以下几个方面：</p>
<p>1）协议</p>
<p>通常协议采用 HTTP，查询类接口通常为 get 或 post，查询条件较少的使用 get，较多的使用 post。</p>
<p>本接口使用 http post。</p>
<p>还要确定 content-type，参数以什么数据格式提交，结果以什么数据格式响应。</p>
<p>一般情况没有特殊情况结果以 json 格式响应。</p>
<p>2）分析请求参数</p>
<p>根据前边对数据模型的分析，请求参数为：课程名称、课程审核状态、当前页码、每页显示记录数。</p>
<p>根据分析的请求参数定义模型类。</p>
<p>3）分析响应结果</p>
<p>根据前边对数据模型的分析，响应结果为数据列表加一些分页信息（总记录数、当前页、每页显示记录数）。</p>
<p>数据列表中数据的属性包括：课程 id、课程名称、任务数、创建时间、审核状态、类型。</p>
<p>注意：查询结果中的审核状态为数据字典中的代码字段，前端会根据审核状态代码 找到对应的名称显示。</p>
<p>根据分析的响应结果定义模型类。</p>
<p>4）分析完成，使用 SpringBoot 注解开发一个 Http 接口。</p>
<p>5）使用接口文档工具查看接口的内容。</p>
<p>6）接口中调用 Service 方法完成业务处理。</p>
<p>4）接口请求示例</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /content/course/list?pageNo=<span class="token number">2</span>&amp;pageSize=<span class="token number">1</span>
...
<p>1、分页查询模型类</p>
<p>由于分页查询这一类的接口在项目较多，这里针对分页查询的参数（当前页码、每页显示记录数）单独在 xuecheng-plus-base 基础工程中定义。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013016226.png" alt="image-20230518013016226"></p>
<p>内容如下：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PageParams</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于上边类中用到了 lombok 注解所以在 base 工程添加依赖包如下：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependencies</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
            <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.projectlombok<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
            <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>lombok<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependencies</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、查询条件模型类</p>
<p>除了分页查询参数，剩下的就是课程查询的特有参数，此时需要在内容管理的 model 工程中定义课程查询参数模型类。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013240054.png" alt="image-20230518013240054"></p>
<p>内容如下：</p>
<div class="language-Java line-numbers-mode" data-ext="Java"><pre v-pre class="language-Java"><code>package com.xuecheng.content.model.dto;
...
<p>针对分页查询结果经过分析也存在固定的数据和格式，所以在 base 工程定义一个基础的模型类。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013308881.png" alt="image-20230518013308881"></p>
<p>内容如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们发现此模型类中定义了 List 属性，此属性存放数据列表，且支持泛型，课程查询接口的返回类型可以是此模型类型。</p>
<p>List 中的数据类型用什么呢？根据需求分析使用生成的 PO 类即可，所以课程查询接口返回结果类型如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>泛型中填写<span class="token class-name">CourseBase</span>类型。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-3-定义接口" tabindex="-1"><a class="header-anchor" href="#_3-3-3-定义接口" aria-hidden="true">#</a> <strong>3.3.3 定义接口</strong></h4>
<p>根据分析，此接口提供 HTTP post 协议，查询条件以 json 格式提交，响应结果为 json 格式。</p>
<p>可使用 SpringBoot 注解在 Controller 类中实现。</p>
<p>1、首先在 api 工程添加依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependencies</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.xuecheng<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>xuecheng-plus-content-service<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、定义 controller 方法</p>
...
<p>3、定义启动类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、添加配置文件</p>
<p>创建 log4j2-dev.xml、bootstrap.yml 文件。</p>
<p>log4j2-dev.xml:从课程资料/项目工程 获取.</p>
<p>bootstrap.yml 内容如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4、下边启动服务，测试接口是否可以正常请求</p>
<p>在 controller 方法中打断点，debug 启动微服务，在浏览器访问 http://localhost:63040/content/course/list</p>
<p>浏览器报 400 错误，400 错误通常由于你访问的页面域名不存在或者请求错误。一般是因为我们输入的语法格式有错误，服务器无法理解用户的请求，不知道要表达的是什么。这个时候我们需要认真检查下语义、请求参数是否有误，不然再怎么刷新都没有用。</p>
<p>接口接收两部分参数，一部分是分页参数，它是通过 http url 传递 key/value 串，另一部分是业务查询条件，通过 http body 传入 json 内容。</p>
<p>服务端使用 RequestBody 接收 json 内容，我们在测试并没有传递 json 内容这里导致错误。</p>
<p>下边在@RequestBody 后添加(required=false)表示此参数不是必填项，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course/list"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次测试，运行到 断点处暂停。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013653614.png" alt="image-20230518013653614"></p>
<h4 id="_3-3-4-模型类的作用" tabindex="-1"><a class="header-anchor" href="#_3-3-4-模型类的作用" aria-hidden="true">#</a> <strong>3.3.4 模型类的作用</strong></h4>
<p>现在项目中有两类模型类：DTO 数据传输对象、PO 持久化对象，DTO 用于接口层向业务层之间传输数据，PO 用于业务层与持久层之间传输数据，有些项目还会设置 VO 对象，VO 对象用在前端与接口层之间传输数据，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013658814.png" alt="image-20230518013658814"></p>
<p>当前端有多个平台且接口存在差异时就需要设置 VO 对象用于前端和接口层传输数据。</p>
<p>比如：</p>
<p>课程列表查询接口，根据需求用户在手机端也要查询课程信息，此时课程查询接口是否需要编写手机端和 PC 端两个接口呢？如果用户要求通过手机和 PC 的查询条件或查询结果不一样，此时就需要定义两个 Controller 课程查询接口，每个接口定义 VO 对象与前端传输数据。</p>
<p>手机查询：根据课程状态查询，查询结果只有课程名称和课程状态。</p>
<p>PC 查询：可以根据课程名称、课程状态、课程审核状态等条件查询，查询结果也比手机查询结果内容多。</p>
<p>此时，Service 业务层尽量提供一个业务接口，即使两个前端接口需要的数据不一样，Service 可以提供一个最全查询结果，由 Controller 进行数据整合。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013705897.png" alt="image-20230518013705897"></p>
<p>如果前端的接口没有多样性且比较固定，此时可以取消 VO，只用 DTO 即可。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013711571.png" alt="image-20230518013711571"></p>
<h3 id="_3-4-生成接口文档" tabindex="-1"><a class="header-anchor" href="#_3-4-生成接口文档" aria-hidden="true">#</a> <strong>3.4 生成接口文档</strong></h3>
<p>在前后端分离开发中通常由后端程序员设计接口，完成后需要编写接口文档，最后将文档交给前端工程师，前端工程师参考文档进行开发。</p>
<p>可以通过一些工具快速生成接口文档 ，本项目通过 Swagger 生成接口在线文档 。</p>
<p>什么是 Swagger？</p>
<p>OpenAPI 规范（OpenAPI Specification 简称 OAS）是 Linux 基金会的一个项目，试图通过定义一种用来描述 API 格式或 API 定义的语言，来规范 RESTful 服务开发过程，目前版本是 V3.0，并且已经发布并开源在 github 上。</p>
<p>（<a href="https://github.com/OAI/OpenAPI-Specification" target="_blank" rel="noopener noreferrer">https://github.com/OAI/OpenAPI-Specification<ExternalLinkIcon/></a>）</p>
<p>Swagger 是全球最大的 OpenAPI 规范（OAS）API 开发工具框架，Swagger 是一个在线接口文档的生成工具，前后端开发人员依据接口文档进行开发。 (<a href="https://swagger.io/" target="_blank" rel="noopener noreferrer">https://swagger.io/<ExternalLinkIcon/></a>)</p>
<p>Spring Boot 可以集成 Swagger，Swaager 根据 Controller 类中的注解生成接口文档 ，只要添加 Swagger 的依赖和配置信息即可使用它。</p>
<p>1、在 API 工程添加 swagger-spring-boot-starter 依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- Spring Boot 集成 swagger --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.spring4all<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>swagger-spring-boot-starter<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在 bootstrap.yml 中配置 swagger 的扫描包路径及其它信息，base-package 为扫描的包路径，扫描 Controller 类。</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">swagger</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、在启动类中添加@EnableSwagger2Doc 注解</p>
<p>再次启动服务，工程启动起来，访问<a href="http://localhost:63040/content/swagger-ui.html" target="_blank" rel="noopener noreferrer">http://localhost:63040/content/swagger-ui.html<ExternalLinkIcon/></a>查看接口信息</p>
<p>下图为 swagger 接口文档的界面：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013814710.png" alt="image-20230518013814710"></p>
<p>这个文档存在两个问题：</p>
<p>1、接口名称显示 course-base-info-controller 名称不直观</p>
<p>2、课程查询是 post 方式只显示 post /course/list 即可。</p>
<p>下边进行修改，添加一些接口说明的注解，并且将 RequestMapping 改为 PostMapping，如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>5、再次启动服务，工程启动起来，访问<a href="http://localhost:63040/content/swagger-ui.html" target="_blank" rel="noopener noreferrer">http://localhost:63040/content/swagger-ui.html<ExternalLinkIcon/></a>查看接口信息</p>
<p>下图为 swagger 接口文档的界面：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013939933.png" alt="image-20230518013939933"></p>
<p>接口文档中会有关于接口参数的说明，在模型类上也可以添加注解对模型类中的属性进行说明，方便对接口文档的阅读。</p>
<p>比如：下边标红的属性名称，可以通过 swaager 注解标注一个中文名称，方便阅读接口文档。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518013959006.png" alt="image-20230518013959006"></p>
<p>标注的方法非常简单：</p>
<p>找到模型类，在属性上添加注解：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PageParams</span> <span class="token punctuation">{</span>
 <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启服务，再次进入接口文档，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014025601.png" alt="image-20230518014025601"></p>
<p>Swaager 的常用注解如下：</p>
<p>在 Java 类中添加 Swagger 的注解即可生成 Swagger 接口，常用 Swagger 注解如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Api</span>：修饰整个类，描述<span class="token class-name">Controller</span>的作用
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@ApiImplicitParam 属性如下：</p>
<table>
<thead>
<tr>
<th>属性</th>
...
<td></td>
<td>body</td>
<td>以流的形式提交 仅支持 POST</td>
</tr>
<tr>
<td></td>
<td>header</td>
<td>参数在 request headers 里边提交</td>
</tr>
<tr>
<td></td>
<td>form</td>
<td>以 form 表单的形式提交 仅支持 POST</td>
</tr>
<tr>
<td>dataType</td>
<td></td>
...
<p>使用 Swagger 可以进行接口的测试。</p>
<p>修改接口内容，添加一些测试代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"课程查询接口"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course/list"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token class-name">PageResult</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">CourseBase</span><span class="token punctuation">></span></span> <span class="token function">list</span><span class="token punctuation">(</span><span class="token class-name">PageParams</span> pageParams<span class="token punctuation">,</span> <span class="token annotation punctuation">@RequestBody</span><span class="token punctuation">(</span>required<span class="token operator">=</span><span class="token boolean">false</span><span class="token punctuation">)</span> <span class="token class-name">QueryCourseParamsDto</span> queryCourseParams<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>debug 方式启动，在 return 处打断点，再用 swagger 请求接口。</p>
<p>通过下图可以看到请求参数已经正常请求至 controller 方法</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014127087.png" alt="image-20230518014127087"></p>
<p>放行继续运行，观察 swagger 界面，结果可以正常返回</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014132552.png" alt="image-20230518014132552"></p>
<p>不过存在一个问题就是 LocalDateTime 类型的数据转 json 后数据格式并不是我们要的年月日时分秒</p>
<p>在 base 工程 com.xuecheng.base.config 包下加配置 LocalDateTimeConfig 类实现转 json 时字符串与 LocalDateTime 类型的转换，LocalDateTimeConfig 类可从课程资料下的项目工程目录中直接拷贝。</p>
<h3 id="_3-5-开发持久层" tabindex="-1"><a class="header-anchor" href="#_3-5-开发持久层" aria-hidden="true">#</a> <strong>3.5 开发持久层</strong></h3>
<h4 id="_3-5-1-生成-mapper" tabindex="-1"><a class="header-anchor" href="#_3-5-1-生成-mapper" aria-hidden="true">#</a> <strong>3.5.1 生成 mapper</strong></h4>
<p>本项目使用 MyBatis-Plus 开发持久层，需要创建 PO 类、Mapper 接口、Mapper 的 xml 文件，每个 PO 类对应数据库的每张表，每张表需要创建一个 Mapper 接口和 Mapper 的 xml 映射文件 。</p>
<p>下边将使用 generator 工程成的 mapper 接口和 mapper 映射文件 拷贝到 service 工程 ，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014201284.png" alt="image-20230518014201284"></p>
<p>service 工程即业务层为 api 接口工程提供业务处理支撑，本项目业务层包括了持久层的代码，一些大型公司的团队职责划分更细，会将持久层和业务层分为两个工程，不过这需要增加成本。</p>
<p>本项目使用持久层框架 MyBatis-Plus 进行开发，下边将 mapper 接口和 xml 文件 拷贝到 service 工程 ，拷贝后如下图所示：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014209275.png" alt="image-20230518014209275"></p>
<p>到此 mapper 接口与 mapper 映射文件生成完毕。</p>
<h4 id="_3-5-2-测试-mapper" tabindex="-1"><a class="header-anchor" href="#_3-5-2-测试-mapper" aria-hidden="true">#</a> <strong>3.5.2 测试 mapper</strong></h4>
<p>下边对 mapper 进行单元测试，测试 course_base 表的查询接口。</p>
<p>1、下边在 service 工程的 pom.xml 中添加依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependencies</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.xuecheng<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>xuecheng-plus-content-model<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、配置扫描 mapper 及分页插件</p>
<p>从课程资料/工程目录下拷贝 MybatisPlusConfig 到 service 工程的 com.xuecheng.content.config 包下：</p>
...
<p>首先分页参数放到 ThreadLocal 中，拦截执行的 sql，根据数据库类型添加对应的分页语句重写 sql，例如：(select * from table where a) 转换为 (select count(*) from table where a)和(select * from table where a limit ,)</p>
<p>计算出了 total 总条数、pageNum 当前第几页、pageSize 每页大小和当前页的数据，是否为首页，是否为尾页，总页数等。</p>
<p>4、单元测试所需要的配置文件</p>
<p>在 test/resources 下创建 log4j2-dev.xml、bootstrap.yml：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014324347.png" alt="image-20230518014324347"></p>
<p>log4j2-dev.xml:从课程资料/项目工程 获取.</p>
<p>bootstrap.yml:</p>
...
<p>单元测试工作在 test 目录，在 test 下添加启动类</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014355727.png" alt="image-20230518014355727"></p>
<p>代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng</span><span class="token punctuation">;</span>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014431512.png" alt="image-20230518014431512"></p>
<p>代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>content</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行测试类的测试方法进行测试，测试成功：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014505867.png" alt="image-20230518014505867"></p>
<h3 id="_3-6-开发业务层" tabindex="-1"><a class="header-anchor" href="#_3-6-开发业务层" aria-hidden="true">#</a> <strong>3.6 开发业务层</strong></h3>
<h4 id="_3-6-1-创建数据字典表" tabindex="-1"><a class="header-anchor" href="#_3-6-1-创建数据字典表" aria-hidden="true">#</a> <strong>3.6.1 创建数据字典表</strong></h4>
...
<p>这时你可以需要批量处理数据库中记录了，写一个 update 语句，审核状态等于“审核未通过”的全部更新 为“未通过”。看起来解决了问题，如果有一天客户又让改了呢？</p>
<p>和审核状态同类的有好多这样的信息，比如：课程状态、课程类型、用户类型等等，这一类数据有一个共同点就是它有一些分类项，且这些分类项较为固定。<code v-pre>针对这些数据，为了提高系统的可扩展性，专门定义数据字典表去维护</code>。</p>
<p>下边是课程审核状态的定义：</p>
...
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每一项都由代码和名称组成。</p>
<p>此时我们好像要干什么了 ，该课程 的审核状态为审核未通过，那么我们在课程基本信息表存储 202001，也就是审核未通过对应的代码，这样查询出的数据在前端展示时根据代码取出它对应的内容显示给用户。如果用户要修改“审核未通过”的显示内容只需要在数据字典表修改，无法修改课程基本信息表。</p>
<p>数据字典表在系统管理数据库中存储，首先导入系统管理数据库，创建系统管理服务的数据库</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014533482.png" alt="image-20230518014533482"></p>
<p>创建成功如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014539625.png" alt="image-20230518014539625"></p>
<p>创建系统管理的数据库，导入课程资料中的 xcplus_system.sql 脚本。</p>
<h4 id="_3-6-2-编写-service" tabindex="-1"><a class="header-anchor" href="#_3-6-2-编写-service" aria-hidden="true">#</a> <strong>3.6.2 编写 Service</strong></h4>
<p>接下来开发 Service 方法，首先创建 Service 接口：</p>
...
<p>下边对 service 进行单元测试，编写单元测试类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>content</span><span class="token punctuation">;</span>
...
<p>课下完成 service 方法中的 todo：根据课程发布状态查询课程信息。</p>
<h3 id="_3-7-接口测试" tabindex="-1"><a class="header-anchor" href="#_3-7-接口测试" aria-hidden="true">#</a> <strong>3.7 接口测试</strong></h3>
<h4 id="_3-7-1-接口完善" tabindex="-1"><a class="header-anchor" href="#_3-7-1-接口完善" aria-hidden="true">#</a> <strong>3.7.1 接口完善</strong></h4>
<p>控制层、业务层以及持久层三层通常可以面向接口并行开发，比如：业务层开发的同事可以先只编写一个 Service 接口，接口层的同事即可面向 Service 接口去开发，待接口层和业务层完成后进行连调。</p>
<p>下边课程查询接口的实现。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"课程查询接口"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course/list"</span><span class="token punctuation">)</span>
 <span class="token keyword">public</span> <span class="token class-name">PageResult</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">CourseBase</span><span class="token punctuation">></span></span> <span class="token function">list</span><span class="token punctuation">(</span><span class="token class-name">PageParams</span> pageParams<span class="token punctuation">,</span> <span class="token annotation punctuation">@RequestBody</span> <span class="token class-name">QueryCourseParamsDto</span> queryCourseParams<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>代码编辑完毕，再次打开 Swagger 进行测试。</p>
<p>输入查询条件：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014702331.png" alt="image-20230518014702331"></p>
<p>测试，观察结果是否正确。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014708929.png" alt="image-20230518014708929"></p>
<h4 id="_3-7-2-httpclient-测试" tabindex="-1"><a class="header-anchor" href="#_3-7-2-httpclient-测试" aria-hidden="true">#</a> <strong>3.7.2 Httpclient 测试</strong></h4>
<p>Swagger 是一个在线接口文档，虽然使用它也能测试但需要浏览器进入 Swagger，最关键的是它并不能保存测试数据。</p>
<p>在 IDEA 中有一个非常方便的 http 接口测试工具 httpclient，下边介绍它的使用方法，后边我们会用它进行接口测试。</p>
<p>如果 IDEA 版本较低没有自带 httpclient，需要安装 httpclient 插件</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014720332.png" alt="image-20230518014720332"></p>
<p>进入 controller 类，找到 http 接口对应的方法</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014727003.png" alt="image-20230518014727003"></p>
<p>点击 Generate request in HTTP Client 即可生成的一个测试用例。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014734073.png" alt="image-20230518014734073"></p>
<p>可以看到自己生成了一个.http 结尾的文件</p>
<p>我们可以添加请求参数进行测试</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014806395.png" alt="image-20230518014806395"></p>
<p>参数添加完毕可以运行它</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014815009.png" alt="image-20230518014815009"></p>
<p>观察控制台，测试通过。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>.http 文件即测试用例文档 ，它可以随着项目工程一起保存，这样测试的数据就可以保存下来，方便进行测试。</p>
<p>为了方便保存.http 文件 ，我们单独在项目工程的根目录创建一个目录单独存放它们。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014908501.png" alt="image-20230518014908501"></p>
<p>我们以模块为单位创建.http 文件。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014915405.png" alt="image-20230518014915405"></p>
<p>打开内容管理模块的 http 文件 ，把刚才测试数据拷贝上去</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014924303.png" alt="image-20230518014924303"></p>
<p>为了方便将来和网关集成测试，这里我们把测试主机地址在配置文件 http-client.env.json 中配置</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518014934289.png" alt="image-20230518014934289"></p>
<p>注意：文件名称 http-client.env.json 保持一致，否则无法读取 dev 环境变量的内容。</p>
<p>内容如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再回到 xc-content-api.http 文件，将<a href="http://localhost:63040" target="_blank" rel="noopener noreferrer">http://localhost:63040<ExternalLinkIcon/></a> 用变量代替</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015001450.png" alt="image-20230518015001450"></p>
<p>到此就完成了 httpclient 的配置与使用测试。</p>
<h3 id="_3-8-前后端联调" tabindex="-1"><a class="header-anchor" href="#_3-8-前后端联调" aria-hidden="true">#</a> <strong>3.8 前后端联调</strong></h3>
<h4 id="_3-8-1-准备环境" tabindex="-1"><a class="header-anchor" href="#_3-8-1-准备环境" aria-hidden="true">#</a> <strong>3.8.1 准备环境</strong></h4>
<p>什么是前后端联调？</p>
<p>通常由后端工程师将接口设计好并编写接口文档，将接口文档交给前端工程师，前后端的工程师就开始并行开发，前端开发人员会使用 mock 数据（假数据）进行开发，当前后端代码完成后开始进行接口联调，前端工程师将 mock 数据改为请求后端接口获取，前端代码请求后端服务测试接口是否正常，这个过程是前后端联调。</p>
...
<p>首先从软件工具目录找到 node-v16.17.0-x64.msi 安装 nodejs</p>
<p>安装完成，查看版本号</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015011531.png" alt="image-20230518015011531"></p>
<p>在 idea 中配置 node.js 的路径</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518180644418.png" alt="image-20230518180644418"></p>
<p>下边启动前端工程，从前端工程拷贝 project-xczx2-portal-vue-ts.zip 到代码目录并解压，并使用 IDEA 或 VS Code 打开 project-xczx2-portal-vue-ts 目录，下边以 IDEA 为例进行说明：</p>
<p>右键点击 project-xczx2-portal-vue-ts 目录下的 package.json 文件，</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015024243.png" alt="image-20230518015024243"></p>
<p>点击 Show npm Scripts 打开 npm 窗口</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015036849.png" alt="image-20230518015036849"></p>
<p>点击“Edit 'serve'” setting，下边对启动项目的一些参数进行配置，选择 nodejs、npm。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015051020.png" alt="image-20230518015051020"></p>
<p>右键点击 Serve，点击“Run serve”启动工程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015059010.png" alt="image-20230518015059010"></p>
<p>出现如下访问链接说明启动成功</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015116234.png" alt="image-20230518015116234"></p>
<p>访问 http://localhost:8601 即可访问前端工程。</p>
<p>如果存在问题通过以下命令启动：</p>
<p>1、cmd 进入工程根目录</p>
<p>2、运行以下命令</p>
...
<p>cnpm i</p>
<p>npm run serve</p>
<h4 id="_3-8-2-安装系统管理服务" tabindex="-1"><a class="header-anchor" href="#_3-8-2-安装系统管理服务" aria-hidden="true">#</a> <strong>3.8.2 安装系统管理服务</strong></h4>
<p>启动前端工程成功，在浏览器通过<a href="http://localhost:8601/" target="_blank" rel="noopener noreferrer">http://localhost:8601/<ExternalLinkIcon/></a>地址访问前端工程。</p>
<p>前端工程报错如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015153858.png" alt="image-20230518015153858"></p>
<p><a href="http://localhost:8601/api/system/dictionary/all" target="_blank" rel="noopener noreferrer">http://localhost:8601/system/dictionary/all<ExternalLinkIcon/></a> 指向的是系统管理服务。在前端讲解内容管理模块的需求时我们提到一个数据字典表，此链接正是在前端请求后端获取数据字典数据的接口地址。</p>
<p>数据字典表中配置了项目用的字典信息，此接口是查询字典中的全部数据 ，在此我们不再开发，按照下边的步骤安装系统管理服务即可。</p>
<p>从课程资料/项目工程目录获取 xuecheng-plus-system.zip，并解压</p>
<p>将 xuecheng-plus-system 目录拷贝到项目工程根目录，刷新 maven，或进入 pom.xml 右键转为 pom 工程。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015202091.png" alt="image-20230518015202091"></p>
<p>进入 xuecheng-plus-system-service 工程，找到 resources 下的 application.yml 修改数据库连接参数。</p>
<p>启动系统管理服务，启动成功，在浏览器请求：<a href="http://localhost:63110/system/dictionary/all" target="_blank" rel="noopener noreferrer">http://localhost:63110/system/dictionary/all<ExternalLinkIcon/></a></p>
<p>系统服务的端口是 63110</p>
<p>如果可以正常读取数据字典信息则说明系统管理服务安装成功。</p>
<h4 id="_3-8-3-解决跨域问题" tabindex="-1"><a class="header-anchor" href="#_3-8-3-解决跨域问题" aria-hidden="true">#</a> <strong>3.8.3 解决跨域问题</strong></h4>
<p>在浏览器通过<a href="http://localhost:8601/" target="_blank" rel="noopener noreferrer">http://localhost:8601/<ExternalLinkIcon/></a>地址访问前端工程。</p>
<p>chrome 浏览器报错如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Access to XMLHttpRequest at <span class="token string">'http://localhost:63110/system/dictionary/all'</span> from origin <span class="token string">'http://localhost:8601'</span> has been blocked by CORS policy: No <span class="token string">'Access-Control-Allow-Origin'</span> header is present on the requested resource.

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>firefox 浏览器报错如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>已拦截跨源请求：同源策略禁止读取位于 http://localhost:63110/system/dictionary/all 的远程资源。（原因：CORS 头缺少 <span class="token string">'Access-Control-Allow-Origin'</span>）。状态码：200。

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>提示：从<a href="http://localhost:8601" target="_blank" rel="noopener noreferrer">http://localhost:8601<ExternalLinkIcon/></a>访问<a href="http://localhost:63110/system/dictionary/all" target="_blank" rel="noopener noreferrer">http://localhost:63110/system/dictionary/all<ExternalLinkIcon/></a>被 CORS policy 阻止，因为没有 Access-Control-Allow-Origin 头信息。CORS 全称是 cross origin resource share 表示跨域资源共享。</p>
<p>出这个提示的原因是基于浏览器的同源策略，去判断是否跨域请求，同源策略是浏览器的一种安全机制，从一个地址请求另一个地址，如果协议、主机、端口三者全部一致则不属于跨域，否则有一个不一致就是跨域请求。</p>
<p>比如：</p>
<p>从<a href="http://localhost:8601" target="_blank" rel="noopener noreferrer">http://localhost:8601<ExternalLinkIcon/></a> 到 <a href="http://localhost:8602" target="_blank" rel="noopener noreferrer">http://localhost:8602<ExternalLinkIcon/></a> 由于端口不同，是跨域。</p>
<p>从<a href="http://192.168.101.10:8601" target="_blank" rel="noopener noreferrer">http://192.168.101.10:8601<ExternalLinkIcon/></a> 到 <a href="http://192.168.101.11:8601" target="_blank" rel="noopener noreferrer">http://192.168.101.11:8601<ExternalLinkIcon/></a> 由于主机不同，是跨域。</p>
<p>从<a href="http://192.168.101.10:8601" target="_blank" rel="noopener noreferrer">http://192.168.101.10:8601<ExternalLinkIcon/></a> 到 <a href="https://192.168.101.11:8601" target="_blank" rel="noopener noreferrer">https://192.168.101.10:8601<ExternalLinkIcon/></a> 由于协议不同，是跨域。</p>
<p>注意：服务器之间不存在跨域请求。</p>
<p>浏览器判断是跨域请求会在请求头上添加 origin，表示这个请求来源哪里。</p>
<p>比如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token constant">GET</span> <span class="token operator">/</span> <span class="token constant">HTTP</span><span class="token operator">/</span><span class="token number">1.1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>服务器收到请求判断这个 Origin 是否允许跨域，如果允许则在响应头中说明允许该来源的跨域请求，如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果允许任何域名来源的跨域请求，则响应如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Access</span><span class="token operator">-</span><span class="token class-name">Control</span><span class="token operator">-</span><span class="token class-name">Allow</span><span class="token operator">-</span><span class="token class-name">Origin</span>：<span class="token operator">*</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>解决跨域的方法：</p>
<p>1、JSONP</p>
<p>通过 script 标签的 src 属性进行跨域请求，如果服务端要响应内容则首先读取请求参数 callback 的值，callback 是一个回调函数的名称，服务端读取 callback 的值后将响应内容通过调用 callback 函数的方式告诉请求方。如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015430025.png" alt="image-20230518015430025"></p>
<p>2、添加响应头</p>
<p>服务端在响应头添加 Access-Control-Allow-Origin：*</p>
<p>3、通过 nginx 代理跨域</p>
<p>由于服务端之间没有跨域，浏览器通过 nginx 去访问跨域地址。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015440366.png" alt="image-20230518015440366"></p>
<p>1）浏览器先访问<a href="http://192.168.101.10:8601" target="_blank" rel="noopener noreferrer">http://192.168.101.10:8601<ExternalLinkIcon/></a> nginx 提供的地址，进入页面</p>
<p>2）此页面要跨域访问<a href="http://192.168.101.11:8601" target="_blank" rel="noopener noreferrer">http://192.168.101.11:8601<ExternalLinkIcon/></a> ，不能直接跨域访问<a href="http://www.baidu.com:8601" target="_blank" rel="noopener noreferrer">http://www.baidu.com:8601<ExternalLinkIcon/></a> ，而是访问 nginx 的一个同源地址，比如：<a href="http://192.168.101.11:8601/api" target="_blank" rel="noopener noreferrer">http://192.168.101.11:8601/api<ExternalLinkIcon/></a> ，通过<a href="http://192.168.101.11:8601/api" target="_blank" rel="noopener noreferrer">http://192.168.101.11:8601/api<ExternalLinkIcon/></a> 的代理去访问<a href="http://www.baidu.com:8601" target="_blank" rel="noopener noreferrer">http://www.baidu.com:8601<ExternalLinkIcon/></a>。</p>
<p>这样就实现了跨域访问。</p>
<p>浏览器到<a href="http://192.168.101.11:8601/api" target="_blank" rel="noopener noreferrer">http://192.168.101.11:8601/api<ExternalLinkIcon/></a> 没有跨域</p>
<p>nginx 到<a href="http://www.baidu.com:8601" target="_blank" rel="noopener noreferrer">http://www.baidu.com:8601<ExternalLinkIcon/></a>通过服务端通信，没有跨域。</p>
<p>我们准备使用方案 2 解决跨域问题。在内容管理的 api 工程 config 包下编写 GlobalCorsConfig.java，</p>
<p>或直接从课程资料/项目工程下拷贝，</p>
<p>代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Java</span>
...
<p>重启系统管理服务，前端工程可以正常进入<a href="http://localhost:8601" target="_blank" rel="noopener noreferrer">http://localhost:8601<ExternalLinkIcon/></a>，观察浏览器记录，成功解决跨域。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015513072.png" alt="image-20230518015513072"></p>
<h4 id="_3-8-4-前后端联调" tabindex="-1"><a class="header-anchor" href="#_3-8-4-前后端联调" aria-hidden="true">#</a> <strong>3.8.4 前后端联调</strong></h4>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015523297.png" alt="image-20230518015523297"></p>
<p>启动前端工程，用前端访问后端接口，观察前端界面的数据是否正确。</p>
<p>访问前端首页，进入课程管理：<a href="http://localhost:8601/#/organization/course-list" target="_blank" rel="noopener noreferrer">http://localhost:8601/#/organization/course-list<ExternalLinkIcon/></a></p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015532848.png" alt="image-20230518015532848"></p>
<p>更改课程条件及分页参数测试课程查询列表是否正常显示。</p>
<p>跟踪内容管理服务的输出日志，查看是否正常。</p>
<p>到此基本完成了前后端连调。</p>
<h2 id="_4-课程分类查询" tabindex="-1"><a class="header-anchor" href="#_4-课程分类查询" aria-hidden="true">#</a> <strong>4 课程分类查询</strong></h2>
<h3 id="_4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-1-需求分析" aria-hidden="true">#</a> <strong>4.1 需求分析</strong></h3>
<p>下边根据内容管理模块的业务流程，下一步要实现新增课程，在新增课程界面，有三处信息需要选择，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015551731.png" alt="image-20230518015551731"></p>
<p>课程等级、课程类型来源于数据字典表，此部分的信息前端已从系统管理服务读取。</p>
<p>课程分类信息没有在数据字典表中存储，而是由单独一张课程分类表，存储在内容管理数据库中。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015559803.png" alt="image-20230518015559803"></p>
<p>下边看下 course_category 课程分类表的结构</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015606914.png" alt="image-20230518015606914"></p>
<p>这张表是一个树型结构，通过父结点 id 将各元素组成一个树。</p>
<p>我们可以看下该表的数据，下图是一部分数据：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015621405.png" alt="image-20230518015621405"></p>
<p>现在的需求是需要在内容管理服务中编写一个接口读取该课程分类表的数据，组成一个树型结构返回给前端。</p>
<p>课程分类的 PO 类如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015632267.png" alt="image-20230518015632267"></p>
<p>如果没有此 po 类则需要生成的此表的 po 类拷贝到内容管理模块的 model 工程中，将 mapper 拷贝到内容管理模块的 service 工程中。</p>
<h3 id="_4-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_4-2-接口定义" aria-hidden="true">#</a> <strong>4.2 接口定义</strong></h3>
<p>我们可以点击新增课程，观察前端的请求记录：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015641645.png" alt="image-20230518015641645"></p>
<p><a href="http://localhost:8601/api/content/course-category/tree-nodes" target="_blank" rel="noopener noreferrer">http://localhost:8601/api/content/course-category/tree-nodes<ExternalLinkIcon/></a> 该地址正是前端获取课程分类的接口地址。</p>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token property">"id"</span> <span class="token operator">:</span> <span class="token string">"1-2"</span><span class="token punctuation">,</span>
<span class="token property">"isLeaf"</span> <span class="token operator">:</span> <span class="token null keyword">null</span><span class="token punctuation">,</span>
<span class="token property">"isShow"</span> <span class="token operator">:</span> <span class="token null keyword">null</span><span class="token punctuation">,</span>
<span class="token property">"label"</span> <span class="token operator">:</span> <span class="token string">"移动开发"</span><span class="token punctuation">,</span>
<span class="token property">"name"</span> <span class="token operator">:</span> <span class="token string">"移动开发"</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>所以，定义一个 DTO 类表示分类信息的模型类，如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-接口开发" tabindex="-1"><a class="header-anchor" href="#_4-3-接口开发" aria-hidden="true">#</a> <strong>4.3 接口开发</strong></h3>
<h4 id="_4-3-1-树型表查询" tabindex="-1"><a class="header-anchor" href="#_4-3-1-树型表查询" aria-hidden="true">#</a> <strong>4.3.1 树型表查询</strong></h4>
<p>课程分类表是一个树型结构，其中 parentid 字段为父结点 ID，它是树型结构的标志字段。</p>
<p>如果树的层级固定可以使用表的自连接去查询，比如：我们只查询两级课程分类，可以用下边的 SQL</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果树的层级不确定，此时可以使用 MySQL8 递归实现，使用 with 语法，如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>    <span class="token keyword">WITH</span> <span class="token punctuation">[</span>RECURSIVE<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>cte_name :公共表达式的名称,可以理解为表名,用来表示 as 后面跟着的子查询</p>
<p>col_name :公共表达式包含的列名,可以写也可以不写</p>
<p>下边是一个递归的简单例子：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">with</span> RECURSIVE t1  <span class="token keyword">AS</span>
<span class="token punctuation">(</span>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518015955923.png" alt="image-20230518015955923"></p>
<p>说明：</p>
<p>t1 相当于一个表名</p>
<p>select 1 相当于这个表的初始值，这里使用 UNION ALL 将初始值加入到表中。</p>
<p>n&lt;5 为递归执行的条件，当 n&gt;=5 时结束递归调用。</p>
<p>下边我们使用递归实现课程分类的查询</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">with</span> recursive t1 <span class="token keyword">as</span> <span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查询结果如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020023172.png" alt="image-20230518020023172"></p>
<p>t1 表中初始的数据是 id 等于 1 的记录，即根结点。</p>
<p>通过 inner join t1 t2 on t2.id = t.parentid 找到 id='1'的下级节点 。</p>
<p>通过这种方法就找到了 id='1'的所有下级节点，下级节点包括了所有层级的节点。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>初始节点为 1-1-1，通过递归找到它的父级节点，父级节点包括所有级别的节点。</p>
<p>以上是我们研究了树型表的查询方法，通过递归的方式查询课程分类比较灵活，因为它可以不限制层级。</p>
<p>mysql 为了避免无限递归默认递归次数为 1000，可以通过设置 cte_max_recursion_depth 参数增加递归深度，还可以通过 max_execution_time 限制执行时间，超过此时间也会终止递归操作。</p>
<p>mysql 递归相当于在存储过程中执行若干次 sql 语句，java 程序仅与数据库建立一次链接执行递归操作，所以只要控制好递归深度，控制好数据量性能就没有问题。</p>
<p>思考：如果 java 程序在递归操作中连接数据库去查询数据组装数据，这个性能高吗？</p>
<h4 id="_4-3-2-开发-mapper" tabindex="-1"><a class="header-anchor" href="#_4-3-2-开发-mapper" aria-hidden="true">#</a> <strong>4.3.2 开发 Mapper</strong></h4>
<p>下边我们可自定义 mapper 方法查询课程分类，最终将查询结果映射到 List&lt;CourseCategoryTreeDto&gt;中。</p>
<p>生成课程分类表的 mapper 文件并拷贝至内容管理模块 的 service 工程中。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020103440.png" alt="image-20230518020103440"></p>
<p>1、下边 定义一个 mapper 方法，并定义 sql 语句。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、找到对应 的 mapper.xml 文件，编写 sql 语句。</p>
...
<p>定义 service 接口，调用 mapper 查询课程分类，遍历数据按照接口要求对数据进行封装</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">CourseCategoryService</span> <span class="token punctuation">{</span>
    <span class="token doc-comment comment">/**
     * 课程分类树形结构查询
     *
...
<p>完善 controller 方法，注入 service 调用业务层方法查询课程分类。</p>
...
<p>使用 httpclient 测试：</p>
<p>定义.http 文件</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020249807.png" alt="image-20230518020249807"></p>
<p>运行测试。</p>
<p>完成前后端连调：</p>
<p>打开前端工程，进入新增课程页面。</p>
<p>课程分类下拉框可以正常显示</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020300287.png" alt="image-20230518020300287"></p>
<h2 id="_5-新增课程" tabindex="-1"><a class="header-anchor" href="#_5-新增课程" aria-hidden="true">#</a> <strong>5 新增课程</strong></h2>
<h3 id="_5-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_5-1-需求分析" aria-hidden="true">#</a> <strong>5.1 需求分析</strong></h3>
<h4 id="_5-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_5-1-1-业务流程" aria-hidden="true">#</a> <strong>5.1.1 业务流程</strong></h4>
<p>根据前边对内容管理模块的数据模型分析，课程相关的信息有：课程基本信息、课程营销信息、课程图片信息、课程计划、课程师资信息，所以新增一门课程需要完成这几部分信息的填写。</p>
<p>以下是业务流程：</p>
<p>1、进入课程查询列表</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020316144.png" alt="image-20230518020316144"></p>
<p>2、点击添加课程，选择课程形式为录播。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020329853.png" alt="image-20230518020329853"></p>
<p>3、选择完毕，点击下一步，进入课程基本信息添加界面。</p>
<p>本界面分两部分信息，一部分是课程基本信息上，一部分是课程营销信息。</p>
<p>课程基本信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020339434.png" alt="image-20230518020339434"></p>
<p>课程营销信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020346667.png" alt="image-20230518020346667"></p>
<p>在这个界面中填写课程的基本信息、课程营销信息上。</p>
<p>填写完毕，保存并进行下一步。</p>
<p>4、在此界面填写课程计划信息</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020356327.png" alt="image-20230518020356327">课程计划即课程的大纲目录。</p>
<p>课程计划分为两级，章节和小节。</p>
<p>每个小节需要上传课程视频，用户点击 小节的标题即开始播放视频。</p>
<p>如果是直播课程则会进入直播间。</p>
<p>5、课程 计划填写完毕进入课程师资的管理。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020410188.png" alt="image-20230518020410188"></p>
<p>在课程师资界面维护该课程的授课老师。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020418040.png" alt="image-20230518020418040">至此，一门课程新增完成。</p>
<h4 id="_4-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_4-1-2-数据模型" aria-hidden="true">#</a> <strong>4.1.2 数据模型</strong></h4>
<p>通过业务流程可知，一门课程信息涉及：课程基本信息、课程营销信息、课程计划信息、课程师资信息。</p>
<p>本节开发新增课程按钮功能， 只向课程基本信息、课程营销信息添加记录。</p>
<p>这两部分信息分别在 course_base、course_market 两张表存储。当点击保存按钮时向这两张表插入数据。这两张表是一对一关联关系。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020435271.png" alt="image-20230518020435271">新建课程的初始审核状态为“未提交”、初始发布状态为“未发布”。</p>
<p>生成课程基本信息、课程营销信息的 PO、Mapper 文件</p>
<h3 id="_5-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_5-2-接口定义" aria-hidden="true">#</a> <strong>5.2 接口定义</strong></h3>
<p>根据业务流程，这里先定义提交课程基本信息的接口。</p>
<p>1、接口协议 ：HTTP POST，Content-Type 为 application/json</p>
<p>2、请求及响应结果如下</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020449318.png" alt="image-20230518020449318"></p>
<p>3、接口请求示例如下</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 创建课程
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、定义请求参数类型和响应结构类型</p>
<p>根据接口定义内容，请求参数相比 CourseBase 模型类不一致，需要在 dto 包下自定义，模型类从课程资料/工程目录获取。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020524988.png" alt="image-20230518020524988"></p>
<p>4、定义接口如下</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"新增课程基础信息"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-3-接口开发" tabindex="-1"><a class="header-anchor" href="#_5-3-接口开发" aria-hidden="true">#</a> <strong>5.3 接口开发</strong></h3>
<h4 id="_5-3-1-保存课程基本信息" tabindex="-1"><a class="header-anchor" href="#_5-3-1-保存课程基本信息" aria-hidden="true">#</a> <strong>5.3.1 保存课程基本信息</strong></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编写 service 接口实现类，实现向课程基本信息表保存数据：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-接口测试" tabindex="-1"><a class="header-anchor" href="#_5-4-接口测试" aria-hidden="true">#</a> <strong>5.4 接口测试</strong></h3>
<p>1、首先去完善 controller 方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"新增课程基础信息"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token class-name">CourseBaseInfoDto</span> <span class="token function">createCourseBase</span><span class="token punctuation">(</span><span class="token annotation punctuation">@RequestBody</span> <span class="token class-name">AddCourseDto</span> addCourseDto<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、使用 httpclient 测试</p>
<p>在 xc-content-api.http 中定义：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 创建课程
POST <span class="token punctuation">{</span><span class="token punctuation">{</span>content_host<span class="token punctuation">}</span><span class="token punctuation">}</span>/content/course
Content-Type<span class="token operator">:</span> application/json
...
<h3 id="_5-6-异常处理" tabindex="-1"><a class="header-anchor" href="#_5-6-异常处理" aria-hidden="true">#</a> <strong>5.6 异常处理</strong></h3>
<h4 id="_5-6-1-异常问题分析" tabindex="-1"><a class="header-anchor" href="#_5-6-1-异常问题分析" aria-hidden="true">#</a> <strong>5.6.1 异常问题分析</strong></h4>
<p>在 service 方法中有很多的参数合法性校验，当参数不合法则抛出异常，下边我们测试下异常处理。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>问题：并没有输出我们抛出异常时指定的异常信息。</p>
<p>所以，现在我们的需求是当正常操作时按接口要求返回数据，当非正常流程时要获取异常信息进行记录，并提示给用户。</p>
<p>异常处理除了输出在日志中，还需要提示给用户，前端和后端需要作一些约定：</p>
<p>1、错误提示信息统一以 json 格式返回给前端。</p>
<p>2、以 HTTP 状态码决定当前是否出错，非 200 为操作异常。</p>
<p>如何规范异常信息？</p>
<p>代码中统一抛出项目的自定义异常类型，这样可以统一去捕获这一类或几类的异常。</p>
<p>规范了异常类型就可以去获取异常信息。</p>
<p>如果捕获了非项目自定义的异常类型统一向用户提示“执行过程异常，请重试”的错误信息。</p>
<p>如何捕获异常？</p>
<p>代码统一用 try/catch 方式去捕获代码比较臃肿，可以通过 SpringMVC 提供的控制器增强类统一由一个类去完成异常的捕获。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518020801861.png" alt="image-20230518020801861"></p>
<h4 id="_5-6-2-统一异常处理实现" tabindex="-1"><a class="header-anchor" href="#_5-6-2-统一异常处理实现" aria-hidden="true">#</a> <strong>5.6.2 统一异常处理实现</strong></h4>
<p>根据上边分析的方案，统一在 base 基础工程实现统一异常处理，各模块依赖了 base 基础工程都 可以使用。</p>
<p>首先在 base 基础工程添加需要依赖的包：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1、定义一些通用的异常信息</p>
<p>从课程资料/工程目录 拷贝 CommonError 类到 base 工程 com.xuecheng.base.execption 下。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、自定义异常类型</p>
<p>在 base 工程 com.xuecheng.base.execption 下自定义异常类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>base<span class="token punctuation">.</span>execption</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4、全局异常处理器</p>
<p>从 Spring 3.0 - Spring 3.2 版本之间，对 Spring 架构和 SpringMVC 的 Controller 的异常捕获提供了相应的异常处理。</p>
<ul>
<li>@ExceptionHandler</li>
</ul>
<p> </p>
<ul>
<li>Spring3.0 提供的标识在方法上或类上的注解，用来表明方法的处理异常类型。</li>
</ul>
<p> </p>
<ul>
...
<p> </p>
<ul>
<li>Spring3.2 提供的新注解，从名字上可以看出大体意思是控制器增强， 在项目中来增强 SpringMVC 中的 Controller。通常和**@ExceptionHandler** 结合使用，来处理 SpringMVC 的异常信息。</li>
</ul>
<p> </p>
<ul>
...
<p> </p>
<ul>
<li>Spring3.0 提供的标识在方法上或类上的注解，用状态代码和应返回的原因标记方法或异常类。<br>
调用处理程序方法时，状态代码将应用于 HTTP 响应。</li>
</ul>
...
<p>在内容管理的 api 工程添加 base 工程的依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.xuecheng<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>xuecheng-plus-base<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>version</span><span class="token punctuation">></span></span>0.0.1-SNAPSHOT<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>version</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在异常处理测试之前首先在代码中抛出自定义类型的异常，这里以新增课程的 service 方法为例进行代码修改。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1、首先使用 httpclient 测试</p>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021113470.png" alt="image-20230518021113470"></p>
<p>通过测试发现，前端正常提示代码 中抛出的异常信息。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021121425.png" alt="image-20230518021121425"></p>
<p>至此，项目异常处理的测试完毕，我们在开发中对于业务分支中错误的情况要抛出项目自定义的异常类型。</p>
<h3 id="_5-7-jsr303-校验" tabindex="-1"><a class="header-anchor" href="#_5-7-jsr303-校验" aria-hidden="true">#</a> <strong>5.7 JSR303 校验</strong></h3>
<h4 id="_5-7-1-统一校验的需求" tabindex="-1"><a class="header-anchor" href="#_5-7-1-统一校验的需求" aria-hidden="true">#</a> <strong>5.7.1 统一校验的需求</strong></h4>
<p>前端请求后端接口传输参数，是在 controller 中校验还是在 Service 中校验？</p>
<p>答案是都需要校验，只是分工不同。</p>
<p>Contoller 中校验请求参数的合法性，包括：必填项校验，数据格式校验，比如：是否是符合一定的日期格式，等。</p>
<p>Service 中要校验的是业务规则相关的内容，比如：课程已经审核通过所以提交失败。</p>
<p>Service 中根据业务规则去校验不方便写成通用代码，Controller 中则可以将校验的代码写成通用代码。</p>
<p>早在 JavaEE6 规范中就定义了参数校验的规范，它就是 JSR-303，它定义了 Bean Validation，即对 bean 属性进行校验。</p>
<p>SpringBoot 提供了 JSR-303 的支持，它就是<code v-pre>spring-boot-starter-validation</code>，它的底层使用 Hibernate Validator，Hibernate Validator 是 Bean Validation 的参考实现。</p>
<p>所以，我们准备在 Controller 层使用 spring-boot-starter-validation 完成对请求参数的基本合法性进行校验。</p>
<h4 id="_5-7-2-统一校验实现" tabindex="-1"><a class="header-anchor" href="#_5-7-2-统一校验实现" aria-hidden="true">#</a> <strong>5.7.2 统一校验实现</strong></h4>
<p>首先在 Base 工程添加 spring-boot-starter-validation 的依赖</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 javax.validation.constraints 包下有很多这样的校验注解，直接使用注解定义校验规则即可。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021159233.png" alt="image-20230518021159233"></p>
<p>规则如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021207606.png" alt="image-20230518021207606"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此接口使用 AddCourseDto 模型对象接收参数，所以进入 AddCourseDto 类，在属性上添加校验规则。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>content<span class="token punctuation">.</span>model<span class="token punctuation">.</span>dto</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上边用到了@NotEmpty 和@Size 两个注解，@NotEmpty 表示属性不能为空，@Size 表示限制属性内容的长短。</p>
<p>定义好校验规则还需要开启校验，在 controller 方法中添加@Validated 注解，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"新增课程基础信息"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果校验出错 Spring 会抛出 MethodArgumentNotValidException 异常，我们需要在统一异常处理器中捕获异常，解析出异常信息。</p>
<p>代码 如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启内容管理服务。</p>
<p>使用 httpclient 进行测试，将必填项设置为空，“适用人群” 属性的内容设置 1 个字。</p>
<p>执行测试，接口响应结果如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到校验器生效。</p>
<h4 id="_5-7-3-分组校验" tabindex="-1"><a class="header-anchor" href="#_5-7-3-分组校验" aria-hidden="true">#</a> <strong>5.7.3 分组校验</strong></h4>
<p>有时候在同一个属性上设置一个校验规则不能满足要求，比如：订单编号由系统生成，在添加订单时要求订单编号为空，在更新 订单时要求订单编写不能为空。此时就用到了分组校验，同一个属性定义多个校验规则属于不同的分组，比如：添加订单定义@NULL 规则属于 insert 分组，更新订单定义@NotEmpty 规则属于 update 分组，insert 和 update 是分组的名称，是可以修改的。</p>
<p>下边举例说明</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 Controller 方法中启动校验规则指定要使用的分组名：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"新增课程基础信息"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/course"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次测试，由于这里指定了 Insert 分组，所以抛出 异常信息：添加课程名称不能为空。</p>
<p>如果修改分组为 ValidationGroups.Update.class，异常信息为：修改课程名称不能为空。</p>
<h4 id="_5-7-4-校验规则不满足" tabindex="-1"><a class="header-anchor" href="#_5-7-4-校验规则不满足" aria-hidden="true">#</a> <strong>5.7.4 校验规则不满足？</strong></h4>
<p>如果 javax.validation.constraints 包下的校验规则满足不了需求怎么办？</p>
<p>1、手写校验代码 。</p>
<p>2、自定义校验规则注解。</p>
<p>如何自定义校验规则注解，请自行查阅资料实现。</p>
<h2 id="_6-修改课程" tabindex="-1"><a class="header-anchor" href="#_6-修改课程" aria-hidden="true">#</a> <strong>6 修改课程</strong></h2>
<h3 id="_6-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_6-1-需求分析" aria-hidden="true">#</a> <strong>6.1 需求分析</strong></h3>
<h4 id="_6-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_6-1-1-业务流程" aria-hidden="true">#</a> <strong>6.1.1 业务流程</strong></h4>
<p>1、进入课程列表查询</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021447075.png" alt="image-20230518021447075"></p>
<p>2、点击编辑</p>
<p>因为课程审核通过方可发布，任何时候都 可以编辑，下图是编辑课程的界面：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021502040.png" alt="image-20230518021502040"></p>
<p>进入编辑界面显示出当前课程的信息。</p>
<p>3、修改成功自动进入课程计划编辑页面。</p>
<h4 id="_6-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_6-1-2-数据模型" aria-hidden="true">#</a> <strong>6.1.2 数据模型</strong></h4>
<p>修改课程的涉及到的数据表是课程基本信息表</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021508395.png" alt="image-20230518021508395"></p>
<p>课程营销信息表：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518021515620.png" alt="image-20230518021515620"></p>
<p>1、进入课程编辑界面</p>
<p>界面中显示了课程的当前信息，需要根据课程 id 查询课程基本和课程营销信息，显示在表单上。</p>
<p>2、编辑、提交</p>
<p>修改课程提交的数据比新增课程多了一项课程 id，因为修改课程需要针对某个课程进行修改。</p>
<p>3、保存数据</p>
<p>编辑完成保存课程基础信息和课程营销信息。</p>
<p>更新课程基本信息表中的修改人、修改时间。</p>
<h3 id="_6-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_6-2-接口定义" aria-hidden="true">#</a> <strong>6.2 接口定义</strong></h3>
<h4 id="_6-2-1-查询课程信息" tabindex="-1"><a class="header-anchor" href="#_6-2-1-查询课程信息" aria-hidden="true">#</a> <strong>6.2.1 查询课程信息</strong></h4>
<p>定义根据课程 id 查询课程信息接口。</p>
<p>接口示例如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /content/course/<span class="token number">40</span>
Content-Type<span class="token operator">:</span> application/json
##响应结果
##<span class="token punctuation">{</span>
...
<p>接口定义如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"根据课程id查询课程基础信息"</span><span class="token punctuation">)</span>
...
<p>根据前边的数据模型分析，修改课程提交的数据比新增多了课程 id，接口示例如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 修改课程
PUT /content/course
Content-Type<span class="token operator">:</span> application/json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后返回最新课程信息，采用与新增课程接口返回类型一致的数据模型。</p>
<p>接口定义如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"修改课程基础信息"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-接口开发" tabindex="-1"><a class="header-anchor" href="#_6-3-接口开发" aria-hidden="true">#</a> <strong>6.3 接口开发</strong></h3>
<h4 id="_6-3-1-查询课程信息" tabindex="-1"><a class="header-anchor" href="#_6-3-1-查询课程信息" aria-hidden="true">#</a> <strong>6.3.1 查询课程信息</strong></h4>
<p>查询课程信息的 Service 方法在新增课程接口开发中已实现，无需实现，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//根据课程id查询课程基本信息，包括基本信息和营销信息</span>
<span class="token keyword">public</span> <span class="token class-name">CourseBaseInfoDto</span> <span class="token function">getCourseBaseInfo</span><span class="token punctuation">(</span><span class="token keyword">long</span> courseId<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>需要将查询课程信息的方法提到接口上，这样在 controller 中通过接口调用此方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">CourseBaseInfoService</span> <span class="token punctuation">{</span>
    <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
   <span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试查询课程</p>
<p>用 httpclient 测试查询课程接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>#### 查询课程信息
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-3-2-修改课程信息" tabindex="-1"><a class="header-anchor" href="#_6-3-2-修改课程信息" aria-hidden="true">#</a> <strong>6.3.2 修改课程信息</strong></h4>
<p>修改 Service 修改课程的接口与方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-接口测试-1" tabindex="-1"><a class="header-anchor" href="#_5-4-接口测试-1" aria-hidden="true">#</a> <strong>5.4 接口测试</strong></h3>
<p>接口开发完成进行测试，使用 httpclient 测试</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 根据课程id查询课程信息
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>前端开发完毕进行前后端接口联调。</p>
<p>过程略。</p>
<h2 id="_7-查询课程计划" tabindex="-1"><a class="header-anchor" href="#_7-查询课程计划" aria-hidden="true">#</a> <strong>7 查询课程计划</strong></h2>
<h3 id="_7-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_7-1-需求分析" aria-hidden="true">#</a> <strong>7.1 需求分析</strong></h3>
<h4 id="_7-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_7-1-1-业务流程" aria-hidden="true">#</a> <strong>7.1.1 业务流程</strong></h4>
<p>课程基本信息添加或修改成功将自动进入课程计划编辑器界面，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022034227.png" alt="image-20230518022034227">课程计划即课程的大纲目录。</p>
<p>课程计划分为两级：大章节和不小章节。</p>
<p>本小节完成课程计划信息的查询。</p>
<h4 id="_7-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_7-1-2-数据模型" aria-hidden="true">#</a> <strong>7.1.2 数据模型</strong></h4>
<p>从课程计划查询界面上可以看出整体上是 一个树型结构，课程计划表 teachplan 如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022046973.png" alt="image-20230518022046973"></p>
<p>每个课程计划都有所属课程。</p>
<p>每个课程的课程计划有两个级别，第一级为大章节，grade 为 1、第二级为小章节，grade 为 2</p>
<p>3。第二级的 parentid 为第一级的 id。</p>
<p>课程计划的显示顺序根据排序字段去显示。</p>
<p>根据业务流程中的界面原型，课程计划列表展示时还有课程计划关联的视频信息。</p>
<p>课程计划关联的视频信息在 teachplan_media 表，结构如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022101582.png" alt="image-20230518022101582"></p>
<p>两张表是一对一关系，每个课程计划只能在 teachplan_media 表中存在一个视频。</p>
<p>从课程资料目录下的 db 目录中，从 xcplus_content.sql 文件中找到课程计划表 teachplan、teachplan_media 表的建表语句以及数据初始化语句，并通过 mysql 客户端去执行脚本。</p>
<p>这里使用 DataGrid 客户端工具连接 mysql 并执行脚本。</p>
<h3 id="_7-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_7-2-接口定义" aria-hidden="true">#</a> <strong>7.2 接口定义</strong></h3>
<p>接口示例如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /teachplan/<span class="token number">22</span>/tree-nodes
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-3-接口开发" tabindex="-1"><a class="header-anchor" href="#_7-3-接口开发" aria-hidden="true">#</a> <strong>7.3 接口开发</strong></h3>
<h4 id="_7-3-1-dao-开发" tabindex="-1"><a class="header-anchor" href="#_7-3-1-dao-开发" aria-hidden="true">#</a> <strong>7.3.1 DAO 开发</strong></h4>
<p>Mapper 接口使用 sql 查询课程计划，组成一个树型结构。</p>
<p>在 TeachplanMapper 自定义方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义 mapper.xml 中的 sql 语句，分析如下：</p>
<p>1、一级分类和二级分类通过 teachplan 表的自链接进行，如果只有一级分类其下边没有二级分类，此时也需要显示一级分类，这里使用左连接，左边是一级分类，右边是二级分类。</p>
<p>2、由于当还没有关联 视频时 teachplan_media 对应的记录为空，所以需要 teachplan 和 teachplan_media 左链接。</p>
<p>sql 如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span>
            one<span class="token punctuation">.</span>id             one_id<span class="token punctuation">,</span>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 课程分类树型结构查询映射结果 --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>单元测试方法，略。</p>
<h4 id="_7-3-2-service-开发" tabindex="-1"><a class="header-anchor" href="#_7-3-2-service-开发" aria-hidden="true">#</a> <strong>7.3.2 Service 开发</strong></h4>
<p>定义 service 接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>content<span class="token punctuation">.</span>service</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-接口测试" tabindex="-1"><a class="header-anchor" href="#_6-4-接口测试" aria-hidden="true">#</a> <strong>6.4 接口测试</strong></h3>
<p>1、完善接口层代码</p>
...
<p>找一个有课程计划的课程进行测试</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>#### 查询某个课程的课程计划
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、前后端联调</p>
<p>1）进入课程编辑页面</p>
<p>2）保存进入下一步</p>
<p>观察课程计划获取是否成功。</p>
<p>1）进入新增课程页面</p>
...
<p>由于是新增的课程，课程计划为空。</p>
<h2 id="_8-新增-修改计划" tabindex="-1"><a class="header-anchor" href="#_8-新增-修改计划" aria-hidden="true">#</a> <strong>8 新增/修改计划</strong></h2>
<h3 id="_8-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_8-1-需求分析" aria-hidden="true">#</a> <strong>8.1 需求分析</strong></h3>
<h4 id="_8-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_8-1-1-业务流程" aria-hidden="true">#</a> <strong>8.1.1 业务流程</strong></h4>
<p>1、进入课程计划界面</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022530828.png" alt="image-20230518022530828"></p>
...
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022540482.png" alt="image-20230518022540482"></p>
<h4 id="_8-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_8-1-2-数据模型" aria-hidden="true">#</a> <strong>8.1.2 数据模型</strong></h4>
<p>1、新增第一级课程计划</p>
<p>名称默认为：新章名称 [点击修改]</p>
<p>grade：1</p>
...
<h3 id="_8-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_8-2-接口定义" aria-hidden="true">#</a> <strong>8.2 接口定义</strong></h3>
<p>接口示例如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 新增课程计划--章<span class="token punctuation">,</span>当grade为<span class="token number">1</span>时parentid为<span class="token number">0</span>
POST /teachplan
Content-Type<span class="token operator">:</span> application/json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同一个接口接收新增和修改两个业务请求，以是否传递课程计划 id 来判断是新增还是修改。</p>
<p>如果传递了课程计划 id 说明当前是要修改该课程计划，否则是新增一个课程计划。</p>
<p>定义接收请求参数的数据模型类：</p>
<p>定义 SaveTeachplanDto</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>content<span class="token punctuation">.</span>model<span class="token punctuation">.</span>dto</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"课程计划创建或修改"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-3-接口开发" tabindex="-1"><a class="header-anchor" href="#_8-3-接口开发" aria-hidden="true">#</a> <strong>8.3 接口开发</strong></h3>
<h4 id="_8-3-1-mapper-开发" tabindex="-1"><a class="header-anchor" href="#_8-3-1-mapper-开发" aria-hidden="true">#</a> <strong>8.3.1 Mapper 开发</strong></h4>
<p>根据业务的分析，Mapper 使用自动生成的 mapper 即可满足要求。</p>
<h4 id="_8-3-2-service-开发" tabindex="-1"><a class="header-anchor" href="#_8-3-2-service-开发" aria-hidden="true">#</a> <strong>8.3.2 Service 开发</strong></h4>
<p>定义保存课程计划的 Service 接口。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token doc-comment comment">/**
...
<p>1、完善接口的代码 ，调用 service 方法完成课程计划的创建和修改。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"课程计划创建或修改"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/teachplan"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">saveTeachplan</span><span class="token punctuation">(</span> <span class="token annotation punctuation">@RequestBody</span> <span class="token class-name">SaveTeachplanDto</span> teachplan<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、首先使用 httpclient 做以下测试。</p>
<p>添加章</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 新增课程计划--章
POST <span class="token punctuation">{</span><span class="token punctuation">{</span>content_host<span class="token punctuation">}</span><span class="token punctuation">}</span>/content/teachplan
Content-Type<span class="token operator">:</span> application/json
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 新增课程计划--节<span class="token punctuation">,</span>从数据库找到第一级的课程计划id向其下边添加计划
POST <span class="token punctuation">{</span><span class="token punctuation">{</span>content_host<span class="token punctuation">}</span><span class="token punctuation">}</span>/content/teachplan
Content-Type<span class="token operator">:</span> application/json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、保存课程计划</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 课程课程计划<span class="token punctuation">,</span>需要从数据库找到修改的课程计划id
POST <span class="token punctuation">{</span><span class="token punctuation">{</span>content_host<span class="token punctuation">}</span><span class="token punctuation">}</span>/content/teachplan
Content-Type<span class="token operator">:</span> application/json
...
<h3 id="_8-5-bug-修改" tabindex="-1"><a class="header-anchor" href="#_8-5-bug-修改" aria-hidden="true">#</a> <strong>8.5 Bug 修改</strong></h3>
<p>通过接口测试我们发现：</p>
<p>1、使用 httpclient 测试没有问题</p>
<p>2、前后端联调时发现新增的第一级目录不能显示在列表中。</p>
<p>请自己分析并修复。</p>
<p>3、思考添加课程计划的实现方式是否存在 bug?</p>
<p>如有 bug 进行修改。</p>
<h2 id="_9-项目实战" tabindex="-1"><a class="header-anchor" href="#_9-项目实战" aria-hidden="true">#</a> <strong>9 项目实战</strong></h2>
<h3 id="_9-1-实战环境" tabindex="-1"><a class="header-anchor" href="#_9-1-实战环境" aria-hidden="true">#</a> <strong>9.1 实战环境</strong></h3>
<h4 id="_9-1-1-实战流程" tabindex="-1"><a class="header-anchor" href="#_9-1-1-实战流程" aria-hidden="true">#</a> <strong>9.1.1 实战流程</strong></h4>
<p>项目实战是模拟企业实际开发的场景，自己参考文档独立完成开发任务，项目实战可以有效的培养自己面对需求进行分析与开发的能力。</p>
<p>实战流程如下：</p>
<p>1、由组长将实战的初始代码提交至本组 git 仓库。</p>
<p>2、每位成员从此仓库 clone 项目。</p>
<p>3、小组共同讨论实战功能需求及接口。</p>
<p>4、根据自己小组的情况进行分工，每人至少写一个接口并测试通过、提交至仓库。</p>
<p><strong>注意：每人在开发接口时创建自己的 service、controller 接口和类，不要出现多人共用同一个文件的情况。</strong></p>
<p>5、待功能开发完毕小组成员拉下全部代码，进行交叉测试，测试出来的 bug 信息记录在 word 文档上提交给组长由组长汇总。</p>
<p>6、根据 bug 记录进行修复自己接口中的 bug，修复完成并测试没有问题后提交给 Git。</p>
<p>7、整体流程测试，包括如下：</p>
...
<p>8、项目评比</p>
<p><strong>小组推荐一名成员作工作汇总，老师根据团队协作情况、功能完成情况、演讲能力进行打分（满分 10 分）。</strong></p>
<h4 id="_9-1-2-创建-git-远程仓库" tabindex="-1"><a class="header-anchor" href="#_9-1-2-创建-git-远程仓库" aria-hidden="true">#</a> <strong>9.1.2 创建 Git 远程仓库</strong></h4>
<p>因为组员无法访问组长虚拟机中的 gogs 所以由组长在自己的电脑上安装 gogs，这里提供 windwos 版本安装包，如果安装有问题也可以使用公网的 git 仓库，比如码云。</p>
<p>组长解压 软件工具目录下的 gogs_0.12.10_windows_amd64.zip，安装 gogs</p>
<p>解压后 cmd 进入 gogs 安装目录，输入 gogs.exe web</p>
<p>自动打开安装界面：</p>
<p>第一步填写数据库信息</p>
<p>输入虚拟机中的数据库地址和账号、密码，数据库名称为 gogs_windows，需要提前在数据库中创建 gogs_windows 数据库</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022915355.png" alt="image-20230518022915355"></p>
<p>第二步应用基本设置：</p>
<p>仓库目录可以设置在 gogs 的安装目录下</p>
<p>域名为虚拟域名，组长和组员在自己的 hosts 文件中配置该域名及对应的组长电脑的 IP 地址。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022923890.png" alt="image-20230518022923890"></p>
<p>下边配置日志路径 ，日志路径可以设置在 gogs 的安装目录下</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022937066.png" alt="image-20230518022937066"></p>
<p>下边配置管理员账号和密码：gogs/gogs</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518022946433.png" alt="image-20230518022946433"></p>
<p>输入完毕点击立即安装</p>
<p>安装完毕自动跳转到 http://group1.xuecheng.com:3000/</p>
<p>组长使用管理员账号密码登录，登录后参考 学成在线项目开发环境配置文档去创建组织及仓库，仓库的代码是老师下发的实战基础代码。</p>
<p>组长为组员创建 git 账号，创建完成将账号和密码发给每位组员。</p>
<p>组员需要记住自己的 git 账号和密码，</p>
<h4 id="_9-1-3-拉取代码" tabindex="-1"><a class="header-anchor" href="#_9-1-3-拉取代码" aria-hidden="true">#</a> <strong>9.1.3 拉取代码</strong></h4>
<p>组员拉取本组 git 远程仓库的代码，根据任务分工开始协作开发。</p>
<p>例如：本组的 git 仓库地址为http://group1.xuecheng.com:3000/xuecheng-plus-group01/xuecheng-plus-project.git</p>
<p>本组全体成员拉取此仓库的代码，根据任务分工开始协作开发。</p>
<h3 id="_9-2-删除课程计划" tabindex="-1"><a class="header-anchor" href="#_9-2-删除课程计划" aria-hidden="true">#</a> <strong>9.2 删除课程计划</strong></h3>
<h4 id="_9-2-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_9-2-1-需求分析" aria-hidden="true">#</a> <strong>9.2.1 需求分析</strong></h4>
<p>课程计划添加成功，如果课程还没有提交时可以删除课程计划。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023000689.png" alt="image-20230518023000689"></p>
<p>删除第一级别的大章节时要求大章节下边没有小章节时方可删除。</p>
<p>删除第二级别的小章节的同时需要将 teachplan_media 表关联的信息也删除。</p>
<h4 id="_9-2-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_9-2-2-接口定义" aria-hidden="true">#</a> <strong>9.2.2 接口定义</strong></h4>
<p>删除课程计划的接口定义：</p>
<p>传入课程计划 id 进行删除操作。</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>Request URL<span class="token operator">:</span> /content/teachplan/<span class="token number">246</span>
...
<p>首先使用 httpclient 工具进行测试</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 删除课程计划
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>分以下情况测试：</p>
<p>1、删除大章节，大章节下有小章节时不允许删除。</p>
<p>2、删除大章节，大单节下没有小章节时可以正常删除。</p>
<p>3、删除小章节，同时将关联的信息进行删除。</p>
<h3 id="_9-3-课程计划排序" tabindex="-1"><a class="header-anchor" href="#_9-3-课程计划排序" aria-hidden="true">#</a> <strong>9.3 课程计划排序</strong></h3>
<h4 id="_9-3-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_9-3-1-需求分析" aria-hidden="true">#</a> <strong>9.3.1 需求分析</strong></h4>
<p>课程计划新增后默认排在同级别最后，课程计划排序功能是可以灵活调整课程计划的显示顺序，如下图：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023056190.png" alt="image-20230518023056190"></p>
<p>上移表示将课程计划向上移动。</p>
<p>下移表示将课程计划向下移动。</p>
<p>向上移动后和上边同级的课程计划交换位置，可以将两个课程计划的排序字段值进行交换。</p>
<p>向下移动后和下边同级的课程计划交换位置，可以将两个课程计划的排序字段值进行交换。</p>
<h4 id="_9-3-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_9-3-2-接口定义" aria-hidden="true">#</a> <strong>9.3.2 接口定义</strong></h4>
<p>接口示例如下：</p>
<p>向下移动：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>Java
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参数 1：movedown 为 移动类型，表示向下移动<br>
参数 2：43 为课程计划 id</p>
<p>向上移动：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>Request URL<span class="token operator">:</span> http<span class="token operator">:</span><span class="token comment">//localhost:8601/api/content/teachplan/moveup/43</span>
Request Method<span class="token operator">:</span> POST

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参数 1：moveup 为 移动类型，表示向上移动<br>
参数 2：43 为课程计划 id</p>
<p>每次移动传递两个参数：</p>
<p>1、移动类型: movedown 和 moveup</p>
<p>2、课程计划 id</p>
<h4 id="_9-3-3-接口测试" tabindex="-1"><a class="header-anchor" href="#_9-3-3-接口测试" aria-hidden="true">#</a> <strong>9.3.3 接口测试</strong></h4>
<p>该功能可直接进行前后端联调，可以立即看到 效果。</p>
<p>1、向上移动测试</p>
...
<h3 id="_9-4-师资管理" tabindex="-1"><a class="header-anchor" href="#_9-4-师资管理" aria-hidden="true">#</a> <strong>9.4 师资管理</strong></h3>
<h4 id="_9-4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_9-4-1-需求分析" aria-hidden="true">#</a> <strong>9.4.1 需求分析</strong></h4>
<p>在课程计划维护界面点击下一步进入师资管理界面：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023219405.png" alt="image-20230518023219405"></p>
<p>点击添加教师打开添加界面，如下图，不用实现上传照片。</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023226846.png" alt="image-20230518023226846"></p>
<p>添加成功查询教师信息如下：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023235372.png" alt="image-20230518023235372"></p>
<p>在这个界面可以删除老师，也可以点击编辑，修改教师信息：</p>
<p><img src="@source/notes/project/02/第2章 内容管理模块v3.1/assets/image-20230518023242923.png" alt="image-20230518023242923"></p>
<p>注意：</p>
<p>只允许向机构自己的课程中添加老师、删除老师。</p>
<p>机构 id 统一使用：1232141425L</p>
<h4 id="_9-4-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_9-4-2-接口定义" aria-hidden="true">#</a> <strong>9.4.2 接口定义</strong></h4>
<p>1、查询教师接口请求示例</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>get /courseTeacher/list/<span class="token number">75</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、添加教师请求示例</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>post  /courseTeacher
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>put /courseTeacher
请求参数：
<span class="token punctuation">{</span>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>delete /ourseTeacher/course/<span class="token number">75</span>/<span class="token number">26</span>
...
<p>3、修改教师</p>
<p>4、删除教师</p>
<h3 id="_9-5-删除课程" tabindex="-1"><a class="header-anchor" href="#_9-5-删除课程" aria-hidden="true">#</a> <strong>9.5 删除课程</strong></h3>
<h4 id="_9-5-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_9-5-1-需求分析" aria-hidden="true">#</a> <strong>9.5.1 需求分析</strong></h4>
<p>课程的审核状态为未提交时方可删除。</p>
<p>删除课程需要删除课程相关的基本信息、营销信息、课程计划、课程教师信息。</p>
<h4 id="_9-5-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_9-5-2-接口定义" aria-hidden="true">#</a> <strong>9.5.2 接口定义</strong></h4>
<p>删除课程接口</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>delete  /course/<span class="token number">87</span>
...
<p>找到一门课程进行删除，删除后从数据库确认课程基本信息、课程营销信息、课程计划、课程计划关联信息、课程师资是否删除成功。</p>
</div></template>
