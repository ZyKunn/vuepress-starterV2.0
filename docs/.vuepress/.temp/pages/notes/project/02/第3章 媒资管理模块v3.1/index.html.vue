<template><div><h1 id="第-3-章媒资管理模块-v3-1" tabindex="-1"><a class="header-anchor" href="#第-3-章媒资管理模块-v3-1" aria-hidden="true">#</a> <strong>第 3 章媒资管理模块 v3.1</strong></h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-模块需求分析">1 模块需求分析</router-link><ul><li><router-link to="#_1-1-模块介绍">1.1 模块介绍</router-link></li><li><router-link to="#_1-2-业务流程">1.2 业务流程</router-link></li><li><router-link to="#_1-3-数据模型">1.3 数据模型</router-link></li></ul></li><li><router-link to="#_2-搭建模块环境">2 搭建模块环境</router-link><ul><li><router-link to="#_2-1-架构的问题分析">2.1 架构的问题分析</router-link></li><li><router-link to="#_2-2-搭建-nacos">2.2 搭建 Nacos</router-link></li><li><router-link to="#_2-3-搭建-gateway">2.3 搭建 Gateway</router-link></li><li><router-link to="#_2-4-搭建媒资工程">2.4 搭建媒资工程</router-link></li></ul></li><li><router-link to="#_3-分布式文件系统">3 分布式文件系统</router-link><ul><li><router-link to="#_3-1-什么是分布式文件系统">3.1 什么是分布式文件系统</router-link></li><li><router-link to="#_3-2-minio">3.2 MinIO</router-link></li></ul></li><li><router-link to="#_4-上传图片">4 上传图片</router-link><ul><li><router-link to="#_4-1-需求分析">4.1 需求分析</router-link></li><li><router-link to="#_4-2-准备环境">4.2 准备环境</router-link></li><li><router-link to="#_4-3-接口定义">4.3 接口定义</router-link></li><li><router-link to="#_4-4-接口开发">4.4 接口开发</router-link></li></ul></li><li><router-link to="#_5-上传视频">5 上传视频</router-link><ul><li><router-link to="#_5-1-需求分析">5.1 需求分析</router-link></li><li><router-link to="#_5-2-断点续传技术">5.2 断点续传技术</router-link></li><li><router-link to="#_5-3-接口定义">5.3 接口定义</router-link></li><li><router-link to="#_5-4-上传分块开发">5.4 上传分块开发</router-link></li><li><router-link to="#_5-5-合并分块开发">5.5 合并分块开发</router-link></li><li><router-link to="#_5-6-其它问题">5.6 其它问题</router-link></li></ul></li><li><router-link to="#_7-视频处理">7 视频处理</router-link><ul><li><router-link to="#_7-1-需求">7.1 需求</router-link></li><li><router-link to="#_7-2-分布式任务处理">7.2 分布式任务处理</router-link></li><li><router-link to="#_7-3-技术方案">7.3 技术方案</router-link></li><li><router-link to="#_7-4-查询待处理任务">7.4 查询待处理任务</router-link></li><li><router-link to="#_7-5-开始执行任务">7.5 开始执行任务</router-link></li><li><router-link to="#_7-6-更新任务状态">7.6 更新任务状态</router-link></li><li><router-link to="#_7-7-视频处理">7.7 视频处理</router-link></li><li><router-link to="#_7-8-测试">7.8 测试</router-link></li><li><router-link to="#_7-9-其它问题">7.9 其它问题</router-link></li></ul></li><li><router-link to="#_8-绑定媒资">8 绑定媒资</router-link><ul><li><router-link to="#_8-1-需求分析">8.1 需求分析</router-link></li><li><router-link to="#_8-2-接口定义">8.2 接口定义</router-link></li><li><router-link to="#_8-3-接口开发">8.3 接口开发</router-link></li><li><router-link to="#_8-4-实战-前端代码有问题">8.4 实战（前端代码有问题）</router-link></li></ul></li></ul></nav>
<h2 id="_1-模块需求分析" tabindex="-1"><a class="header-anchor" href="#_1-模块需求分析" aria-hidden="true">#</a> <strong>1 模块需求分析</strong></h2>
<h3 id="_1-1-模块介绍" tabindex="-1"><a class="header-anchor" href="#_1-1-模块介绍" aria-hidden="true">#</a> <strong>1.1 模块介绍</strong></h3>
<p>媒资管理系统是每个在线教育平台所必须具备的，查阅百度百科对它的定义如下：</p>
<p>媒体资源管理(Media Asset Management，MAM)系统是建立在多媒体、网络、数据库和数字存储等先进技术基础上的一个对各种媒体及内容(如视/音频资料、文本文件、图表等)进行数字化存储、管理以及应用的总体解决方案，包括数字媒体的采集、编目、管理、传输和编码转换等所有环节。其主要是满足<a href="https://baike.baidu.com/item/%E5%AA%92%E4%BD%93?fromModule=lemma_inlink" target="_blank" rel="noopener noreferrer">媒体<ExternalLinkIcon/></a>资源拥有者收集、保存、查找、编辑、发布各种信息的要求，为媒体资源的使用者提供访问内容的便捷方法，实现对媒体资源的高效管理，大幅度提高媒体资源的价值。</p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172723493.png" alt="image-20230521172723493"></p>
<h3 id="_1-2-业务流程" tabindex="-1"><a class="header-anchor" href="#_1-2-业务流程" aria-hidden="true">#</a> <strong>1.2 业务流程</strong></h3>
<h4 id="_1-2-1-上传图片" tabindex="-1"><a class="header-anchor" href="#_1-2-1-上传图片" aria-hidden="true">#</a> <strong>1.2.1 上传图片</strong></h4>
<p>教学机构人员在课程信息编辑页面上传课程图片，课程图片统一记录在媒资管理系统。</p>
<p>下图是上传图片的界面：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172736026.png" alt="image-20230521172736026"></p>
<h4 id="_1-2-2-上传视频" tabindex="-1"><a class="header-anchor" href="#_1-2-2-上传视频" aria-hidden="true">#</a> <strong>1.2.2 上传视频</strong></h4>
<p>1、教学机构人员进入媒资管理列表查询自己上传的媒资文件。</p>
<p>点击“媒资管理”</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172741680.png" alt="image-20230521172741680"></p>
<p>进入媒资管理列表页面查询本机构上传的媒资文件。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172746056.png" alt="image-20230521172746056"></p>
<p>2、教育机构用户在&quot;媒资管理&quot;页面中点击 &quot;上传视频&quot; 按钮。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172754168.png" alt="image-20230521172754168"></p>
<p>点击“上传视频”打开上传页面</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172759310.png" alt="image-20230521172759310"></p>
<p>3、选择要上传的文件，自动执行文件上传，视频上传成功会自动处理。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172807448.png" alt="image-20230521172807448"></p>
<h4 id="_1-2-3-处理视频" tabindex="-1"><a class="header-anchor" href="#_1-2-3-处理视频" aria-hidden="true">#</a> <strong>1.2.3 处理视频</strong></h4>
<p>对需要转码处理的视频系统会自动对其处理，处理后生成视频的 URL。</p>
<p>处理视频没有用户界面，完全是后台自动执行。</p>
<h4 id="_1-2-4-审核媒资" tabindex="-1"><a class="header-anchor" href="#_1-2-4-审核媒资" aria-hidden="true">#</a> <strong>1.2.4 审核媒资</strong></h4>
<p>审核媒资包括程序自动审核和人工审核，程序可以通过鉴黄接口(https://www.aliyun.com/product/lvwang?spm=5176.19720258.J_3207526240.51.e93976f4rSq796)审核视频，对有异议的视频由人工进行审核。</p>
<p>1.运营用户登入运营平台并进入媒资管理页面，查找待审核媒资</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172839945.png" alt="image-20230521172839945"></p>
<p>2.点击列表中媒资名称链接，可预览该媒资，若是视频，则播放视频。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172852283.png" alt="image-20230521172852283"></p>
<p>3.点击列表中某媒资后的&quot;审核&quot; 按钮，既完成媒资的审批过程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172906517.png" alt="image-20230521172906517"></p>
<p>点击“审核”，选择审核结果，输入审核意见。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172913161.png" alt="image-20230521172913161"></p>
<h4 id="_1-2-5-绑定媒资" tabindex="-1"><a class="header-anchor" href="#_1-2-5-绑定媒资" aria-hidden="true">#</a> <strong>1.2.5 绑定媒资</strong></h4>
<p>课程计划创建好后需要绑定媒资文件，比如：如果课程计划绑定了视频文件，进入课程在线学习界面后点课程计划名称则在线播放视频。如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172926268.png" alt="image-20230521172926268"></p>
<p>如何将课程计划绑定媒资呢？</p>
<p>1.教育机构用户进入课程管理页面并编辑某一个课程，在&quot;课程大纲&quot;标签页的某一小节后可点击”添加视频“。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172936979.png" alt="image-20230521172936979"></p>
<p>2.弹出添加视频对话框，可通过视频关键字搜索已审核通过的视频媒资。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172943466.png" alt="image-20230521172943466"></p>
<p>3.选择视频媒资，点击提交按钮，完成课程计划绑定媒资流程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172953841.png" alt="image-20230521172953841"></p>
<p>课程计划关联视频后如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521172959743.png" alt="image-20230521172959743"></p>
<h3 id="_1-3-数据模型" tabindex="-1"><a class="header-anchor" href="#_1-3-数据模型" aria-hidden="true">#</a> <strong>1.3 数据模型</strong></h3>
<p>本模块媒资文件相关的数据表如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173006160.png" alt="image-20230521173006160"></p>
<p>媒资文件表：存储文件信息，包括图片、视频、文档等。</p>
<p>media_process: 待处理视频表。</p>
<p>media_process_history: 视频处理历史表，记录已经处理成功的视频信息。</p>
<p>媒资文件与课程计划绑定关系表如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173014279.png" alt="image-20230521173014279"></p>
<h2 id="_2-搭建模块环境" tabindex="-1"><a class="header-anchor" href="#_2-搭建模块环境" aria-hidden="true">#</a> <strong>2 搭建模块环境</strong></h2>
<h3 id="_2-1-架构的问题分析" tabindex="-1"><a class="header-anchor" href="#_2-1-架构的问题分析" aria-hidden="true">#</a> <strong>2.1 架构的问题分析</strong></h3>
<p>当前要开发的是媒资管理服务，目前为止共三个微服务：内容管理、系统管理、媒资管理，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173023640.png" alt="image-20230521173023640"></p>
<p>后期还会添加更多的微服务，当前这种由前端直接请求微服务的方式存在弊端：</p>
<p>如果在前端对每个请求地址都配置绝对路径，非常不利于系统维护，比如下边代码中请求系统管理服务的地址使用的是 localhost</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173032950.png" alt="image-20230521173032950"></p>
<p>当系统上线后这里需要改成公网的域名，如果这种地址非常多则非常麻烦。</p>
<p>基于这个问题可以采用网关来解决，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173044369.png" alt="image-20230521173044369"></p>
<p>这样在前端的代码中只需要指定每个接口的相对路径，如下所示：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173050724.png" alt="image-20230521173050724"></p>
<p>在前端代码的一个固定的地方在接口地址前统一加网关的地址，每个请求统一到网关，由网关将请求转发到具体的微服务。</p>
<p>为什么所有的请求先到网关呢？</p>
<p>有了网关就可以对请求进行路由，路由到具体的微服务，减少外界对接微服务的成本，比如：400 电话，路由的试可以根据请求路径进行路由、根据 host 地址进行路由等， 当微服务有多个实例时可以通过负载均衡算法进行路由，如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173104225.png" alt="image-20230521173104225"></p>
<p>另外，网关还可以实现权限控制、限流等功能。</p>
<p>项目采用 Spring Cloud Gateway 作为网关，网关在请求路由时需要知道每个微服务实例的地址，项目使用 Nacos 作用服务发现中心和配置中心，整体的架构图如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173111174.png" alt="image-20230521173111174"></p>
<p>流程如下：</p>
<p>1、微服务启动，将自己注册到 Nacos，Nacos 记录了各微服务实例的地址。</p>
<p>2、网关从 Nacos 读取服务列表，包括服务名称、服务地址等。</p>
<p>3、请求到达网关，网关将请求路由到具体的微服务。</p>
<p>要使用网关首先搭建 Nacos，Nacos 有两个作用：</p>
<p>1、服务发现中心。</p>
<p>微服务将自身注册至 Nacos，网关从 Nacos 获取微服务列表。</p>
<p>2、配置中心。</p>
<p>微服务众多，它们的配置信息也非常复杂，为了提供系统的可维护性，微服务的配置信息统一在 Nacos 配置。</p>
<h3 id="_2-2-搭建-nacos" tabindex="-1"><a class="header-anchor" href="#_2-2-搭建-nacos" aria-hidden="true">#</a> <strong>2.2 搭建 Nacos</strong></h3>
<h4 id="_2-2-1-服务发现中心" tabindex="-1"><a class="header-anchor" href="#_2-2-1-服务发现中心" aria-hidden="true">#</a> <strong>2.2.1 服务发现中心</strong></h4>
<p>Spring Cloud ：一套规范</p>
<p>Spring Cloud alibaba（类似与接口与实现类的关系）: nacos 服务注册中心，配置中心****</p>
<p>根据上节讲解的网关的架构图，要使用网关首先搭建 Nacos。</p>
<p>首先搭建 Nacos 服务发现中心。</p>
<p>在搭建 Nacos 服务发现中心之前需要搞清楚两个概念：namespace 和 group</p>
<p>namespace：用于区分环境、比如：开发环境、测试环境、生产环境。</p>
<p>group：用于区分项目，比如：xuecheng-plus 项目、xuecheng2.0 项目</p>
<p>首先在 nacos 配置 namespace:</p>
<p>登录 Centos，启动 Naocs，使用 sh /data/soft/restart.sh 将自动启动 Nacos。</p>
<p>访问：http://192.168.101.65:8848/nacos/</p>
<p>账号密码：nacos/nacos</p>
<p>登录成功，点击左侧菜单“命名空间”进入命名空间管理界面，</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173125710.png" alt="image-20230521173125710"></p>
<p>点击“新建命名空间”，填写命名空间的相关信息。如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173132455.png" alt="image-20230521173132455"></p>
<p>使用相同的方法再创建“测试环境”、&quot;生产环境&quot;的命名空间。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173137803.png" alt="image-20230521173137803"></p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173144339.png" alt="image-20230521173144339"></p>
<p>创建成功，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173156276.png" alt="image-20230521173156276"></p>
<p>在教学中可以创建具体班级的命名空间，假如创建 1010 班级的命名空间，如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173201037.png" alt="image-20230521173201037"></p>
<p><code v-pre>注意：如果使用dev1010命名空间，在下边的配置中对namespace配置为dev1010。</code></p>
<p>首先完成各服务注册到 Naocs，下边将内容管理服务注册到 nacos 中。</p>
<p>1) 在 xuecheng-plus-parent 中添加依赖管理</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）在内容管理模块的接口工程、系统管理模块的接口工程中添加如下依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.alibaba.cloud<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>spring-cloud-starter-alibaba-nacos-discovery<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）配置 nacos 的地址</p>
<p>在系统管理的接口工程的配置文件中配置如下信息：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment">##微服务配置</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在内容管理的接口工程的配置文件中配置如下信息：</p>
  ...
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">nacos</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">discovery</span><span class="token punctuation">:</span>
        <span class="token key atrule">namespace</span><span class="token punctuation">:</span> dev
        <span class="token key atrule">group</span><span class="token punctuation">:</span> xuecheng<span class="token punctuation">-</span>plus<span class="token punctuation">-</span>project
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4）重启内容管理服务、系统管理服务。</p>
<p>待微服务启动成功，进入 Nacos 服务查看服务列表</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173400176.png" alt="image-20230521173400176"></p>
<p>在 “开发环境” 命名空间下有两个服务这说明内容管理微服务和系统管理微服务在 Nacos 注册成功。</p>
<p>点击其它一个微服务的“详情”</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173404990.png" alt="image-20230521173404990"></p>
<p>通过上图可以查看微服务实例的地址。</p>
<h4 id="_2-2-2-配置中心" tabindex="-1"><a class="header-anchor" href="#_2-2-2-配置中心" aria-hidden="true">#</a> <strong>2.2.2 配置中心</strong></h4>
<h5 id="_2-2-2-1-配置三要素" tabindex="-1"><a class="header-anchor" href="#_2-2-2-1-配置三要素" aria-hidden="true">#</a> <strong>2.2.2.1 配置三要素</strong></h5>
<p>搭建完成 Nacos 服务发现中心，下边搭建 Nacos 为配置中心，其目的就是通过 Nacos 去管理项目的所有配置。</p>
<p>先将项目中的配置文件分分类：</p>
<p><strong>1、每个项目特有的配置</strong></p>
<p>是指该配置只在有些项目中需要配置，或者该配置在每个项目中配置的值不同。</p>
<p>比如：spring.application.name 每个项目都需要配置但值不一样，以及有些项目需要连接数据库而有些项目不需要，有些项目需要配置消息队列而有些项目不需要。</p>
<p><strong>2、项目所公用的配置</strong></p>
<p>是指在若干项目中配置内容相同的配置。比如：redis 的配置，很多项目用的同一套 redis 服务所以配置也一样。</p>
<p>另外还需要知道 nacos 如何去定位一个具体的配置文件，即：namespace、group、dataid.</p>
<p>1、通过 namespace、group 找到具体的环境和具体的项目。</p>
<p>2、通过 dataid 找到具体的配置文件，dataid 有三部分组成</p>
<p><code v-pre>比如：content-service-dev.yaml配置文件 由（content-service）-（dev）. (yaml)三部分组成</code></p>
<p>content-service：第一部分，它是在 application.yaml 中配置的应用名，即 spring.application.name 的值。</p>
<p>dev：第二部分，它是环境名，通过 spring.profiles.active 指定，</p>
<p>Yaml: 第三部分，它是配置文件 的后缀，目前 nacos 支持 properties、yaml 等格式类型，本项目选择 yaml 格式类型。</p>
<p>所以，如果我们要配置 content-service 工程的配置文件:</p>
<p>在开发环境中配置 content-service-dev.yaml</p>
<p>在测试环境中配置 content-service-test.yaml</p>
<p>在生产环境中配置 content-service-prod.yaml</p>
<p>我们启动项目中传入 spring.profiles.active 的参数决定引用哪个环境的配置文件，例如：传入 spring.profiles.active=dev 表示使用 dev 环境的配置文件即 content-service-dev.yaml。</p>
<h5 id="_2-2-2-2-配置-content-service" tabindex="-1"><a class="header-anchor" href="#_2-2-2-2-配置-content-service" aria-hidden="true">#</a> <strong>2.2.2.2 配置 content-service</strong></h5>
<p>下边以开发环境为例对 content-service 工程的配置文件进行配置，进入 nacos，进入开发环境。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173419195.png" alt="image-20230521173419195"></p>
<p>点击加号，添加一个配置</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173425795.png" alt="image-20230521173425795"></p>
<p>输入 data id、group 以及配置文件内容。</p>
<p>为什么没在 nacos 中配置下边的内容 ？</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">application</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为刚才说了 dataid 第一部分就是 spring.application.name，nacos 客户端要根据此值确定配置文件 名称，所以 spring.application.name 不在 nacos 中配置，而是要在工程的本地进行配置。</p>
<p>在 content-service 工程的 test/resources 中添加 bootstrap.yaml，内容如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">application</span><span class="token punctuation">:</span>
    <span class="token key atrule">name</span><span class="token punctuation">:</span> content<span class="token punctuation">-</span>service
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置完成，运行 content-service 工程 的单元测试文件，能否正常测试，跟踪单元测试方法可以正常读取数据库的数据，说明从 nacos 读取配置信息正常。</p>
<p>通过运行观察控制台打印出下边的信息，NacosRestTemplate.java 通过 Post 方式与 nacos 服务端交互读取配置信息。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>NacosRestTemplate.java:476<span class="token punctuation">]</span> - HTTP method: POST, url: http://192.168.101.65:8848/nacos/v1/cs/configs/listener, body: <span class="token punctuation">{</span>Listening-Configs<span class="token operator">=</span>content-service.yaml?xuecheng-plus-project??dev?content-service-dev.yaml?xuecheng-plus-project?88459b1483b8381eccc2ef462bd59182?dev?content-service?xuecheng-plus-project??dev?, <span class="token assign-left variable">tenant</span><span class="token operator">=</span>dev<span class="token punctuation">}</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-2-3-配置-content-api" tabindex="-1"><a class="header-anchor" href="#_2-2-2-3-配置-content-api" aria-hidden="true">#</a> <strong>2.2.2.3 配置 content-api</strong></h5>
<p>以相同的方法配置 content-api 工程的配置文件，在 nacos 中的开发环境中配置 content-api-dev.yaml，内容如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 content-api 工程 的本地配置 bootstrap.yaml，内容如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment">##微服务配置</span>
<span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">application</span><span class="token punctuation">:</span>
    <span class="token key atrule">name</span><span class="token punctuation">:</span> content<span class="token punctuation">-</span>api
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">extension-configs</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">data-id</span><span class="token punctuation">:</span> content<span class="token punctuation">-</span>service<span class="token punctuation">-</span>$<span class="token punctuation">{</span>spring.profiles.active<span class="token punctuation">}</span>.yaml
    <span class="token key atrule">group</span><span class="token punctuation">:</span> xuecheng<span class="token punctuation">-</span>plus<span class="token punctuation">-</span>project
    <span class="token key atrule">refresh</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果添加多个扩展文件，继续在下添加即可，如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">extension-configs</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">data-id</span><span class="token punctuation">:</span> content<span class="token punctuation">-</span>service<span class="token punctuation">-</span>$<span class="token punctuation">{</span>spring.profiles.active<span class="token punctuation">}</span>.yaml
    <span class="token key atrule">group</span><span class="token punctuation">:</span> xuecheng<span class="token punctuation">-</span>plus<span class="token punctuation">-</span>project
    <span class="token key atrule">refresh</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
  <span class="token punctuation">-</span> <span class="token key atrule">data-id</span><span class="token punctuation">:</span> 填写文件 dataid
    <span class="token key atrule">group</span><span class="token punctuation">:</span> xuecheng<span class="token punctuation">-</span>plus<span class="token punctuation">-</span>project
    <span class="token key atrule">refresh</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动 content-api 工程，查询控制台是否打印出了请求 nacos 的日志，如下:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>NacosRestTemplate.java:476<span class="token punctuation">]</span> - HTTP method: POST, url: http://192.168.101.65:8848/nacos/v1/cs/configs/listener

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>并使用 Httpclient 测试课程查询接口是否可以正常查询。</p>
<h4 id="_2-2-3-公用配置" tabindex="-1"><a class="header-anchor" href="#_2-2-3-公用配置" aria-hidden="true">#</a> <strong>2.2.3 公用配置</strong></h4>
<p>还有一个优化的点是如何在 nacos 中配置项目的公用配置呢？</p>
<p>nacos 提供了 shared-configs 可以引入公用配置。</p>
<p>在 content-api 中配置了 swagger，所有的接口工程 都需要配置 swagger，这里就可以将 swagger 的配置定义为一个公用配置，哪个项目用引入即可。</p>
<p>单独在 xuecheng-plus-common 分组下创建 xuecheng-plus 的公用配置，进入 nacos 的开发环境，添加 swagger-dev.yaml 公用配置</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173736347.png" alt="image-20230521173736347"></p>
<p>删除接口工程中对 swagger 的配置。</p>
<p>项目使用 shared-configs 可以引入公用配置。在接口工程的本地配置文件 中引入公用配置，如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">application</span><span class="token punctuation">:</span>
    <span class="token key atrule">name</span><span class="token punctuation">:</span> content<span class="token punctuation">-</span>api
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">profiles</span><span class="token punctuation">:</span>
    <span class="token key atrule">active</span><span class="token punctuation">:</span> dev
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再以相同 的方法配置日志的公用配置。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173754467.png" alt="image-20230521173754467"></p>
<p>在接口工程和业务工程，引入 loggin-dev.yaml 公用配置文件</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173758499.png" alt="image-20230521173758499"></p>
<p>配置完成，重启 content-api 接口工程，访问 http://localhost:63040/content/swagger-ui.html 查看 swagger 接口文档是否可以正常访问，查看控制台 log4j2 日志输出是否正常。</p>
<h4 id="_2-2-4-配置优先级" tabindex="-1"><a class="header-anchor" href="#_2-2-4-配置优先级" aria-hidden="true">#</a> <strong>2.2.4 配置优先级</strong></h4>
<p>到目前为止已将所有微服务的配置统一在 nacos 进行配置，用到的配置文件有本地的配置文件 bootstrap.yaml 和 nacos 上的配置文件，SpringBoot 读取配置文件 的顺序如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173813332.png" alt="image-20230521173813332"></p>
<p>引入配置文件的形式有：</p>
<p>1、以项目应用名方式引入</p>
<p>2、以扩展配置文件方式引入</p>
<p>3、以共享配置文件 方式引入</p>
...
<p>我们想启动两个内容管理微服务，此时需要在本地指定不同的端口，通过 VM Options 参数，在 IDEA 配置启动参数</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173822900.png" alt="image-20230521173822900"></p>
<p>通过-D 指定参数名和参数值，参数名即在 bootstrap.yml 中配置的 server.port。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173839490.png" alt="image-20230521173839490"></p>
<p>启动 ContentApplication2，发现端口仍然是 63040，这说明本地的配置没有生效。</p>
<p>这时我们想让本地最优先，可以在 nacos 配置文件 中配置如下即可实现：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment">##配置本地优先</span>
<span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">config</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次启动 ContentApplication2，端口为 63041。</p>
<h4 id="_2-2-5-导入配置文件" tabindex="-1"><a class="header-anchor" href="#_2-2-5-导入配置文件" aria-hidden="true">#</a> <strong>2.2.5 导入配置文件</strong></h4>
<p>课程资料中提供了系统用的所有配置文件 nacos_config_export.zip，下边将 nacos_config_export.zip 导入 nacos。</p>
<p>进入具体的命名空间，点击“导入配置”</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173859544.png" alt="image-20230521173859544"></p>
<p>打开导入窗口</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173905236.png" alt="image-20230521173905236"></p>
<p>相同的配置选择覆盖配置。</p>
<p>点击“上传文件”选择资料中的 nacos_config_export.zip 开始导入。</p>
<h4 id="_2-2-6-作业" tabindex="-1"><a class="header-anchor" href="#_2-2-6-作业" aria-hidden="true">#</a> <strong>2.2.6 作业</strong></h4>
<p>按照上边的方法 自行将系统管理服务的配置信息在 nacos 上进行配置。</p>
<h3 id="_2-3-搭建-gateway" tabindex="-1"><a class="header-anchor" href="#_2-3-搭建-gateway" aria-hidden="true">#</a> <strong>2.3 搭建 Gateway</strong></h3>
<p>本项目使用 Spring Cloud Gateway 作为网关，下边创建网关工程。</p>
<p>新建一个网关工程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173930442.png" alt="image-20230521173930442"></p>
<p>工程结构</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521173937510.png" alt="image-20230521173937510"></p>
<p>添加依赖：</p>
...
<span class="token key atrule">spring</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">profiles</span><span class="token punctuation">:</span>
    <span class="token key atrule">active</span><span class="token punctuation">:</span> dev
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 nacos 上配置网关路由策略：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174013064.png" alt="image-20230521174013064"></p>
<p>详细配置如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">server</span><span class="token punctuation">:</span>
...
<span class="token comment">##          filters:</span>
<span class="token comment">##            - StripPrefix=1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动网关工程，通过网关工程访问微服务进行测试。</p>
<p>在 http-client-env.json 中配置网关的地址</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174035750.png" alt="image-20230521174035750"></p>
<p>使用 httpclient 测试课程查询 接口，如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 课程查询列表
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行，观察是否可以正常访问接口 ，如下所示可以正常请求接口。</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>http<span class="token operator">:</span><span class="token comment">//localhost:63010/content/course/list?pageNo=2&amp;pageSize=1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>网关工程搭建完成即可将前端工程中的接口地址改为网关的地址</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174225795.png" alt="image-20230521174225795"></p>
<p>启动前端工程，测试之前开发内容管理模块的功能。</p>
<p>观察网关控制台，通过网关转发课程查询的日志如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Handler is being applied: <span class="token punctuation">{</span>uri<span class="token operator">=</span>http://192.168.101.1:63040/content/course/list?pageNo<span class="token operator">=</span><span class="token number">2</span><span class="token operator">&amp;</span><span class="token assign-left variable">pageSize</span><span class="token operator">=</span><span class="token number">1</span>, <span class="token assign-left variable">method</span><span class="token operator">=</span>POST<span class="token punctuation">}</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-搭建媒资工程" tabindex="-1"><a class="header-anchor" href="#_2-4-搭建媒资工程" aria-hidden="true">#</a> <strong>2.4 搭建媒资工程</strong></h3>
<p>至此网关、Nacos 已经搭建完成，下边将媒资工程导入项目。</p>
<p>从课程资料中获取媒资工程 xuecheng-plus-media，拷贝到项目工程根目录。</p>
<p>右键 pom.xml 转为 maven 工程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174246366.png" alt="image-20230521174246366"></p>
<p>下边做如下配置：</p>
<p>1、创建媒资数据库 xc_media，并导入资料目录中的 xcplus_media.sql</p>
<p>2、修改 nacos 上的 media-service-dev.yaml 配置文件中的数据库链接信息</p>
<p>重启 media-api 工程只要能正常启动成功即可，稍后根据需求写接口。</p>
<h2 id="_3-分布式文件系统" tabindex="-1"><a class="header-anchor" href="#_3-分布式文件系统" aria-hidden="true">#</a> <strong>3 分布式文件系统</strong></h2>
<h3 id="_3-1-什么是分布式文件系统" tabindex="-1"><a class="header-anchor" href="#_3-1-什么是分布式文件系统" aria-hidden="true">#</a> <strong>3.1 什么是分布式文件系统</strong></h3>
<p>要理解分布式文件系统首先了解什么是文件系统。</p>
<p>查阅百度百科：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174256887.png" alt="image-20230521174256887"></p>
<p>文件系统是负责管理和存储文件的系统软件，操作系统通过文件系统提供的接口去存取文件，用户通过操作系统访问磁盘上的文件。</p>
<p>下图指示了文件系统所处的位置：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174301218.png" alt="image-20230521174301218"></p>
<p>常见的文件系统：FAT16/FAT32、NTFS、HFS、UFS、APFS、XFS、Ext4 等 。</p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174316618.png" alt="image-20230521174316618"></p>
<p>通过概念可以简单理解为：一个计算机无法存储海量的文件，通过网络将若干计算机组织起来共同去存储海量的文件，去接收海量用户的请求，这些组织起来的计算机通过网络进行通信，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174324104.png" alt="image-20230521174324104"></p>
<p>好处：</p>
...
<p>1、NFS</p>
<p>阅读百度百科：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174332940.png" alt="image-20230521174332940"></p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174339285.png" alt="image-20230521174339285"></p>
<p>特点：</p>
<p>1）在客户端上映射 NFS 服务器的驱动器。</p>
<p>2）客户端通过网络访问 NFS 服务器的硬盘完全透明。</p>
<p>2、GFS</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174350504.png" alt="image-20230521174350504"></p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174356095.png" alt="image-20230521174356095"></p>
<p>1）GFS 采用主从结构，一个 GFS 集群由一个 master 和大量的 chunkserver 组成。</p>
<p>2）master 存储了数据文件的元数据，一个文件被分成了若干块存储在多个 chunkserver 中。</p>
<p>3）用户从 master 中获取数据元信息，向 chunkserver 存储数据。</p>
<p>3) HDFS</p>
<p>HDFS，是 Hadoop Distributed File System 的简称，是 Hadoop 抽象文件系统的一种实现。HDFS 是一个高度容错性的系统，适合部署在廉价的机器上。HDFS 能提供高吞吐量的数据访问，非常适合大规模数据集上的应用。 HDFS 的文件分布在集群机器上，同时提供副本进行容错及可靠性保证。例如客户端写入读取文件的直接操作都是分布在集群各个机器上的，没有单点性能压力。</p>
<p>下图是 HDFS 的架构图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174405599.png" alt="image-20230521174405599"></p>
<p>1）HDFS 采用主从结构，一个 HDFS 集群由一个名称结点和若干数据结点组成。</p>
...
<p><em>官方网站：<a href="https://www.aliyun.com/product/oss" target="_blank" rel="noopener noreferrer">https://www.aliyun.com/product/oss<ExternalLinkIcon/></a></em></p>
<p>百度对象存储 BOS 提供稳定、安全、高效、高可扩展的云存储服务。您可以将任意数量和形式的非结构化数据存入 BOS，并对数据进行管理和处理。BOS 支持标准、低频、冷和归档存储等多种存储类型，满足多场景的存储需求。</p>
<p><em>官方网站：<a href="https://cloud.baidu.com/product/bos.html" target="_blank" rel="noopener noreferrer">https://cloud.baidu.com/product/bos.html<ExternalLinkIcon/></a></em></p>
<h3 id="_3-2-minio" tabindex="-1"><a class="header-anchor" href="#_3-2-minio" aria-hidden="true">#</a> <strong>3.2 MinIO</strong></h3>
<h4 id="_3-2-1-介绍" tabindex="-1"><a class="header-anchor" href="#_3-2-1-介绍" aria-hidden="true">#</a> <strong>3.2.1 介绍</strong></h4>
<p>本项目采用 MinIO 构建分布式文件系统，MinIO 是一个非常轻量的服务,可以很简单的和其他应用的结合使用，它兼容亚马逊 S3 云存储服务接口，非常适合于存储大容量非结构化的数据，例如图片、视频、日志文件、备份数据和容器/虚拟机镜像等。</p>
<p>它一大特点就是轻量，使用简单，功能强大，支持各种平台，单个文件最大 5TB，兼容 Amazon S3 接口，提供了 Java、Python、GO 等多版本 SDK 支持。</p>
<p>官网：https://min.io</p>
<p>中文：https://www.minio.org.cn/，http://docs.minio.org.cn/docs/</p>
<p>MinIO 集群采用去中心化共享架构，每个结点是对等关系，通过 Nginx 可对 MinIO 进行负载均衡访问。</p>
<p>去中心化有什么好处？</p>
<p>在大数据领域，通常的设计理念都是无中心和分布式。Minio 分布式模式可以帮助你搭建一个高可用的对象存储服务，你可以使用这些存储设备，而不用考虑其真实物理位置。</p>
<p>它将分布在不同服务器上的多块硬盘组成一个对象存储服务。由于硬盘分布在不同的节点上，分布式 Minio 避免了单点故障。如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174422689.png" alt="image-20230521174422689"></p>
<p>Minio 使用<strong>纠删码</strong>技术来保护数据，它是一种恢复丢失和损坏数据的数学算法，它将数据分块冗余的分散存储在各各节点的磁盘上，所有的可用磁盘组成一个集合，上图由 8 块硬盘组成一个集合，当上传一个文件时会通过纠删码算法计算对文件进行分块存储，除了将文件本身分成 4 个数据块，还会生成 4 个校验块，数据块和校验块会分散的存储在这 8 块硬盘上。</p>
<p>使用纠删码的好处是即便丢失一半数量（N/2）的硬盘，仍然可以恢复数据。 比如上边集合中有 4 个以内的硬盘损害仍可保证数据恢复，不影响上传和下载，如果多于一半的硬盘坏了则无法恢复。</p>
<h4 id="_3-2-2-数据恢复演示" tabindex="-1"><a class="header-anchor" href="#_3-2-2-数据恢复演示" aria-hidden="true">#</a> <strong>3.2.2 数据恢复演示</strong></h4>
<p>下边在本机演示 MinIO 恢复数据的过程，在本地创建 4 个目录表示 4 个硬盘。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174429441.png" alt="image-20230521174429441"></p>
<p>下载 minio，下载地址在https://dl.min.io/server/minio/release/，可从课程资料找到MinIO的安装文件minio.zip解压即可使用，CMD进入有minio.exe的目录，运行下边的命令：</p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>minio.exe server D:<span class="token function selector">\develop</span><span class="token function selector">\minio</span>_data<span class="token function selector">\data</span>1  D:<span class="token function selector">\develop</span><span class="token function selector">\minio</span>_data<span class="token function selector">\data</span>2  D:<span class="token function selector">\develop</span><span class="token function selector">\minio</span>_data<span class="token function selector">\data</span>3  D:<span class="token function selector">\develop</span><span class="token function selector">\minio</span>_data<span class="token function selector">\data</span>4

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>启动结果如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174516437.png" alt="image-20230521174516437"></p>
<p>说明如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>WARNING: MINIO_ACCESS_KEY <span class="token operator">and</span> MINIO_SECRET_KEY are deprecated<span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1）老版本使用的 MINIO_ACCESS_KEY 和 MINIO_SECRET_KEY 不推荐使用，推荐使用 MINIO_ROOT_USER 和 MINIO_ROOT_PASSWORD 设置账号和密码。</p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174542920.png" alt="image-20230521174542920"></p>
<p>登录成功：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174550651.png" alt="image-20230521174550651">下一步创建 bucket，桶，它相当于存储文件的目录，可以创建若干的桶。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174556135.png" alt="image-20230521174556135"></p>
<p>输入 bucket 的名称，点击“CreateBucket”，创建成功</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174601980.png" alt="image-20230521174601980"></p>
<p>点击“upload”上传文件。</p>
<p>下边上传几个文件</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174611447.png" alt="image-20230521174611447"></p>
<p>下边去四个目录观察文件的存储情况</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174618445.png" alt="image-20230521174618445"></p>
...
<h4 id="_3-2-3-测试-docker-环境" tabindex="-1"><a class="header-anchor" href="#_3-2-3-测试-docker-环境" aria-hidden="true">#</a> <strong>3.2.3 测试 Docker 环境</strong></h4>
<p>开发阶段和生产阶段统一使用 Docker 下的 MINIO。</p>
<p>在下发的虚拟机中已安装了 MinIO 的镜像和容器，执行 sh /data/soft /restart.sh 启动 Docker 下的 MinIO</p>
<p>启动完成登录 MinIO 查看是否正常。</p>
<p>访问http://192.168.101.65:9000</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174632760.png" alt="image-20230521174632760">本项目创建两个 buckets：</p>
<p>mediafiles： 普通文件</p>
<p>video：视频文件</p>
<h4 id="_3-2-4-sdk" tabindex="-1"><a class="header-anchor" href="#_3-2-4-sdk" aria-hidden="true">#</a> <strong>3.2.4 SDK</strong></h4>
<h5 id="_3-2-4-1-上传文件" tabindex="-1"><a class="header-anchor" href="#_3-2-4-1-上传文件" aria-hidden="true">#</a> <strong>3.2.4.1 上传文件</strong></h5>
<p>MinIO 提供多个语言版本 SDK 的支持，下边找到 java 版本的文档：</p>
<p>地址：https://docs.min.io/docs/java-client-quickstart-guide.html</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 media-service 工程添加此依赖。</p>
<p>参数说明：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参考示例在 media-service 工程中 测试上传文件功能，</p>
<p>首先创建一个用于测试的 bucket</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174732420.png" alt="image-20230521174732420"></p>
<p>点击“Manage”修改 bucket 的访问权限</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174737096.png" alt="image-20230521174737096"></p>
<p>选择 public 权限</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174743840.png" alt="image-20230521174743840"></p>
<p>在 xuecheng-plus-media-service 工程 的 test 下编写测试代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>media</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行 upload 方法，分别测试向桶的根目录上传文件以及子目录上传文件。</p>
<p>上传成功，通过 web 控制台查看文件，并预览文件。</p>
<p>说明：</p>
<p>设置 contentType 可以通过 com.j256.simplemagic.ContentType 枚举类查看常用的 mimeType（媒体类型）</p>
<p>通过扩展名得到 mimeType，代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//根据扩展名取出mimeType</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>完善上边的代码 如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-2-4-2-删除文件" tabindex="-1"><a class="header-anchor" href="#_3-2-4-2-删除文件" aria-hidden="true">#</a> <strong>3.2.4.2 删除文件</strong></h5>
<p>下边测试删除文件</p>
<p>参考：https://docs.min.io/docs/java-client-api-reference#removeObject</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-2-4-3-查询文件" tabindex="-1"><a class="header-anchor" href="#_3-2-4-3-查询文件" aria-hidden="true">#</a> <strong>3.2.4.3 查询文件</strong></h5>
<p>通过查询文件查看文件是否存在 minio 中。</p>
<p>参考：https://docs.min.io/docs/java-client-api-reference#getObject</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//查询文件</span>
<span class="token annotation punctuation">@Test</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>校验文件的完整性，对文件计算出 md5 值，比较原始文件的 md5 和目标文件的 md5，一致则说明完整</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//校验文件的完整性对文件的内容进行md5</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-上传图片" tabindex="-1"><a class="header-anchor" href="#_4-上传图片" aria-hidden="true">#</a> <strong>4 上传图片</strong></h2>
<h3 id="_4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-1-需求分析" aria-hidden="true">#</a> <strong>4.1 需求分析</strong></h3>
<h4 id="_4-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_4-1-1-业务流程" aria-hidden="true">#</a> <strong>4.1.1 业务流程</strong></h4>
<p>课程图片是宣传课程非常重要的信息，在新增课程界面上传课程图片，也可以修改课程图片。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174916606.png" alt="image-20230521174916606"></p>
<p>上传课程图片总体上包括两部分：</p>
<p>1、上传课程图片前端请求媒资管理服务将文件上传至分布式文件系统，并且在媒资管理数据库保存文件信息。</p>
<p>2、上传图片成功保存图片地址到课程基本信息表中。</p>
<p>详细流程如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174923069.png" alt="image-20230521174923069"></p>
<p>1、前端进入上传图片界面</p>
<p>2、上传图片，请求媒资管理服务。</p>
<p>3、媒资管理服务将图片文件存储在 MinIO。</p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174930515.png" alt="image-20230521174930515"></p>
<p>各字段描述如下：</p>
<h3 id="_4-2-准备环境" tabindex="-1"><a class="header-anchor" href="#_4-2-准备环境" aria-hidden="true">#</a> <img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174935560.png" alt="image-20230521174935560"><strong>4.2 准备环境</strong></h3>
<p>首先在 minio 配置 bucket，bucket 名称为：mediafiles，并设置 bucket 的权限为公开。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174942568.png" alt="image-20230521174942568"></p>
<p>在 nacos 配置中 minio 的相关信息，进入 media-service-dev.yaml:</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521174948380.png" alt="image-20230521174948380"></p>
<p>配置信息如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">minio</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 media-service 工程编写 minio 的配置类：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-接口定义" tabindex="-1"><a class="header-anchor" href="#_4-3-接口定义" aria-hidden="true">#</a> <strong>4.3 接口定义</strong></h3>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"上传文件"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接口定义好后可以用 httpclient 工具测试一下</p>
<p>使用 httpclient 测试</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 上传文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-接口开发" tabindex="-1"><a class="header-anchor" href="#_4-4-接口开发" aria-hidden="true">#</a> <strong>4.4 接口开发</strong></h3>
<h4 id="_4-4-1-dao-开发" tabindex="-1"><a class="header-anchor" href="#_4-4-1-dao-开发" aria-hidden="true">#</a> <strong>4.4.1 DAO 开发</strong></h4>
<p>根据需求分析 DAO 层实现向 media_files 表插入一条记录，使用 media_files 表生成的 mapper 即可。</p>
<h4 id="_4-4-2-service-开发" tabindex="-1"><a class="header-anchor" href="#_4-4-2-service-开发" aria-hidden="true">#</a> <strong>4.4.2 Service 开发</strong></h4>
<p>Service 方法需要提供一个更加通用的保存文件的方法。</p>
<p>定义请求参数类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>media<span class="token punctuation">.</span>model<span class="token punctuation">.</span>dto</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、再进行前后端联调测试</p>
<p>在新增课程、编辑课程界面上传图，保存课程信息后再次进入编辑课程界面，查看是否可以正常保存课程图片信息。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175306531.png" alt="image-20230521175306531"></p>
<p>上图图片完成后，进入媒资管理，查看文件列表中是否有刚刚上传的图片信息。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175312589.png" alt="image-20230521175312589"></p>
<h4 id="_4-4-5-service-事务优化" tabindex="-1"><a class="header-anchor" href="#_4-4-5-service-事务优化" aria-hidden="true">#</a> <strong>4.4.5 Service 事务优化</strong></h4>
<p>上边的 service 方法优化后并测试通过，现在思考关于 uploadFile 方法的是否应该开启事务。</p>
<p>目前是在 uploadFile 方法上添加@Transactional，当调用 uploadFile 方法前会开启数据库事务，如果上传文件过程时间较长那么数据库的事务持续时间就会变长，这样数据库链接释放就慢，最终导致数据库链接不够用。</p>
<p>我们只将 addMediaFilesToDb 方法添加事务控制即可,uploadFile 方法上的@Transactional 注解去掉。</p>
<p>优化后如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们人为在 int insert = mediaFilesMapper.insert(mediaFiles);下边添加一个异常代码 int a=1/0;</p>
<p>测试是否事务控制。<code v-pre>很遗憾，事务控制失败</code>。</p>
<p>方法上已经添加了@Transactional 注解为什么该方法不能被事务控制呢？</p>
<p>如果是在 uploadFile 方法上添加@Transactional 注解就可以控制事务，去掉则不行。</p>
<blockquote>
<p>现在的问题其实是一个非事务方法调同类一个事务方法，事务无法控制，这是为什么？</p>
</blockquote>
<p>下边分析原因：</p>
<p>如果在 uploadFile 方法上添加@Transactional 注解，代理对象执行此方法前会开启事务，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175414648.png" alt="image-20230521175414648"></p>
<p>如果在 uploadFile 方法上没有@Transactional 注解，代理对象执行此方法前不进行事务控制，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175420395.png" alt="image-20230521175420395"></p>
<blockquote>
<p>所以判断该方法是否可以事务控制必须保证是通过代理对象调用此方法，且此方法上添加了@Transactional 注解。</p>
</blockquote>
<p>现在在 addMediaFilesToDb 方法上添加@Transactional 注解，也不会进行事务控制是因为并不是通过代理对象执行的 addMediaFilesToDb 方法。为了判断在 uploadFile 方法中去调用 addMediaFilesToDb 方法是否是通过代理对象去调用，我们可以打断点跟踪。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175426352.png" alt="image-20230521175426352"></p>
<p>我们发现在 uploadFile 方法中去调用 addMediaFilesToDb 方法不是通过代理对象去调用。</p>
<p>如何解决呢？通过代理对象去调用 addMediaFilesToDb 方法即可解决。</p>
<p>在 MediaFileService 的实现类中注入 MediaFileService 的代理对象，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Autowired</span>
<span class="token class-name">MediaFileService</span> currentProxy<span class="token punctuation">;</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将 addMediaFilesToDb 方法提成接口。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * <span class="token keyword">@description</span> 将文件信息添加到文件表
 * <span class="token keyword">@param</span> <span class="token parameter">companyId</span>  机构id
 * <span class="token keyword">@param</span> <span class="token parameter">fileMd5</span>  文件md5值
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用 addMediaFilesToDb 方法的代码处改为如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次测试事务是否可以正常控制。</p>
<h2 id="_5-上传视频" tabindex="-1"><a class="header-anchor" href="#_5-上传视频" aria-hidden="true">#</a> <strong>5 上传视频</strong></h2>
<h3 id="_5-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_5-1-需求分析" aria-hidden="true">#</a> <strong>5.1 需求分析</strong></h3>
<p>1、教学机构人员进入媒资管理列表查询自己上传的媒资文件。</p>
<p>点击“媒资管理”</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175523775.png" alt="image-20230521175523775"></p>
<p>进入媒资管理列表页面查询本机构上传的媒资文件。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175528444.png" alt="image-20230521175528444"></p>
<p>2、教育机构用户在&quot;媒资管理&quot;页面中点击 &quot;上传视频&quot; 按钮。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175534003.png" alt="image-20230521175534003"></p>
<p>点击“上传视频”打开上传页面</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175539244.png" alt="image-20230521175539244"></p>
<p>3、选择要上传的文件，自动执行文件上传。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175544353.png" alt="image-20230521175544353"></p>
<p>4、视频上传成功会自动处理，处理完成可以预览视频。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175550024.png" alt="image-20230521175550024"></p>
<h3 id="_5-2-断点续传技术" tabindex="-1"><a class="header-anchor" href="#_5-2-断点续传技术" aria-hidden="true">#</a> <strong>5.2 断点续传技术</strong></h3>
<h4 id="_5-2-1-什么是断点续传" tabindex="-1"><a class="header-anchor" href="#_5-2-1-什么是断点续传" aria-hidden="true">#</a> <strong>5.2.1 什么是断点续传</strong></h4>
...
<p>断点续传流程如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175557288.png" alt="image-20230521175557288"></p>
<p>流程如下：</p>
<p>1、前端上传前先把文件分成块</p>
<p>2、一块一块的上传，上传中断后重新上传，已上传的分块则不用再上传</p>
<p>3、各分块上传完成最后在服务端合并文件</p>
<h4 id="_5-2-2-分块与合并测试" tabindex="-1"><a class="header-anchor" href="#_5-2-2-分块与合并测试" aria-hidden="true">#</a> <strong>5.2.2 分块与合并测试</strong></h4>
<p>为了更好的理解文件分块上传的原理，下边用 java 代码测试文件的分块与合并。</p>
<p>文件分块的流程如下：</p>
<p>1、获取源文件长度</p>
...
<p>文件合并的测试代码 ：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//测试文件合并方法</span>
    <span class="token annotation punctuation">@Test</span>
...
<p>下图是上传视频的整体流程：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521175658020.png" alt="image-20230521175658020"></p>
<p>1、前端对文件进行分块。</p>
...
<h4 id="_5-2-4-minio-合并文件测试" tabindex="-1"><a class="header-anchor" href="#_5-2-4-minio-合并文件测试" aria-hidden="true">#</a> <strong>5.2.4 minio 合并文件测试</strong></h4>
<p>1、将分块文件上传至 minio</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//将分块文件上传至minio</span>
<span class="token annotation punctuation">@Test</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、通过 minio 的合并文件</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//合并文件，要求分块文件最小5M</span>
<span class="token annotation punctuation">@Test</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 minio 合并文件报错：java.lang.IllegalArgumentException: source testbucket/chunk/0: size 1048576 must be greater than 5242880</p>
<p>minio 合并文件默认分块最小 5M，我们将分块改为 5M 再次测试。</p>
<h3 id="_5-3-接口定义" tabindex="-1"><a class="header-anchor" href="#_5-3-接口定义" aria-hidden="true">#</a> <strong>5.3 接口定义</strong></h3>
<p>根据上传视频流程，定义接口，与前端的约定是操作成功返回{code:0}否则返回{code:-1}</p>
<p>从课程资料中拷贝 RestResponse.java 类到 base 工程下的 model 包下。</p>
<p>定义接口如下：</p>
...
<h4 id="_5-4-1-dao-开发" tabindex="-1"><a class="header-anchor" href="#_5-4-1-dao-开发" aria-hidden="true">#</a> <strong>5.4.1 DAO 开发</strong></h4>
<p>向媒资数据库的文件表插入记录，使用自动生成的 Mapper 接口即可满足要求。</p>
<h4 id="_5-4-2-service-开发" tabindex="-1"><a class="header-anchor" href="#_5-4-2-service-开发" aria-hidden="true">#</a> <strong>5.4.2 Service 开发</strong></h4>
<h5 id="_5-4-2-1-检查文件和分块" tabindex="-1"><a class="header-anchor" href="#_5-4-2-1-检查文件和分块" aria-hidden="true">#</a> <strong>5.4.2.1 检查文件和分块</strong></h5>
<p>接口完成进行接口实现，首先实现检查文件方法和检查分块方法。</p>
<p>在 MediaFileService 中定义 service 接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_5-4-2-3-上传分块测试" tabindex="-1"><a class="header-anchor" href="#_5-4-2-3-上传分块测试" aria-hidden="true">#</a> <strong>5.4.2.3 上传分块测试</strong></h5>
<p>完善接口层：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span>value <span class="token operator">=</span> <span class="token string">"文件上传前检查文件"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/upload/checkfile"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token class-name">RestResponse</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">Boolean</span><span class="token punctuation">></span></span> <span class="token function">checkfile</span><span class="token punctuation">(</span>
        <span class="token annotation punctuation">@RequestParam</span><span class="token punctuation">(</span><span class="token string">"fileMd5"</span><span class="token punctuation">)</span> <span class="token class-name">String</span> fileMd5
<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
<p>前端对文件分块的大小为 5MB，SpringBoot web 默认上传文件的大小限制为 1MB，这里需要在 media-api 工程修改配置如下：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">servlet</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>max-file-size：单个文件的大小限制</p>
<p>Max-request-size: 单次请求的大小限制</p>
<h3 id="_5-5-合并分块开发" tabindex="-1"><a class="header-anchor" href="#_5-5-合并分块开发" aria-hidden="true">#</a> <strong>5.5 合并分块开发</strong></h3>
<h4 id="_5-5-1-service-开发" tabindex="-1"><a class="header-anchor" href="#_5-5-1-service-开发" aria-hidden="true">#</a> <strong>5.5.1 service 开发</strong></h4>
<p>定义 service 接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<p>进入 service 方法逐行跟踪。</p>
<p>2、断点续传测试</p>
<p>上传一部分后，停止刷新浏览器再重新上传，通过浏览器日志发现已经上传过的分块不再重新上传</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180052105.png" alt="image-20230521180052105"></p>
<h3 id="_5-6-其它问题" tabindex="-1"><a class="header-anchor" href="#_5-6-其它问题" aria-hidden="true">#</a> <strong>5.6 其它问题</strong></h3>
<h4 id="_5-6-1-分块文件清理问题" tabindex="-1"><a class="header-anchor" href="#_5-6-1-分块文件清理问题" aria-hidden="true">#</a> <strong>5.6.1 分块文件清理问题</strong></h4>
<p>上传一个文件进行分块上传，上传一半不传了，之前上传到 minio 的分块文件要清理吗？怎么做的？</p>
<p>1、在数据库中有一张文件表记录 minio 中存储的文件信息。</p>
<p>2、文件开始上传时会写入文件表，状态为上传中，上传完成会更新状态为上传完成。</p>
<p>3、当一个文件传了一半不再上传了说明该文件没有上传完成，会有定时任务去查询文件表中的记录，如果文件未上传完成则删除 minio 中没有上传成功的文件目录。</p>
<h2 id="_7-视频处理" tabindex="-1"><a class="header-anchor" href="#_7-视频处理" aria-hidden="true">#</a> <strong>7 视频处理</strong></h2>
<h3 id="_7-1-需求" tabindex="-1"><a class="header-anchor" href="#_7-1-需求" aria-hidden="true">#</a> <strong>7.1 需求</strong></h3>
<h4 id="_7-1-1-总体需求" tabindex="-1"><a class="header-anchor" href="#_7-1-1-总体需求" aria-hidden="true">#</a> <strong>7.1.1 总体需求</strong></h4>
<p>视频上传成功需要对视频的格式进行转码处理，比如：avi 转成 mp4。如何用 Java 程序对视频进行处理呢？当视频比较多的时候我们如何可以高效处理。</p>
<p>在一些云平台上对象存储产品就具有文件处理的功能，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180100640.png" alt="image-20230521180100640"></p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180105909.png" alt="image-20230521180105909"></p>
<p>所以一般做文件存储的服务都需要对文件进行处理，例如对视频进行转码处理，可能由于文件量较大需要使用多线程等技术进行高效处理。</p>
<h4 id="_7-7-2-什么是视频编码" tabindex="-1"><a class="header-anchor" href="#_7-7-2-什么是视频编码" aria-hidden="true">#</a> <strong>7.7.2 什么是视频编码</strong></h4>
<p>视频上传成功后需要对视频进行转码处理。</p>
<p>什么是视频编码？查阅百度百科如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180115190.png" alt="image-20230521180115190"></p>
<p>详情参考 ：<a href="https://baike.baidu.com/item/%E8%A7%86%E9%A2%91%E7%BC%96%E7%A0%81/839038" target="_blank" rel="noopener noreferrer">https://baike.baidu.com/item/视频编码/839038<ExternalLinkIcon/></a></p>
<p>首先我们要分清文件格式和编码格式：</p>
<p>文件格式：是指.mp4、.avi、.rmvb 等 这些不同扩展名的视频文件的文件格式 ，视频文件的内容主要包括视频和音频，其文件格式是按照一 定的编码格式去编码，并且按照该文件所规定的封装格式将视频、音频、字幕等信息封装在一起，播放器会根据它们的封装格式去提取出编码，然后由播放器解码，最终播放音视频。</p>
<p>音视频编码格式：通过音视频的压缩技术，将视频格式转换成另一种视频格式，通过视频编码实现流媒体的传输。比如：一个.avi 的视频文件原来的编码是 a，通过编码后编码格式变为 b，音频原来为 c，通过编码后变为 d。</p>
<p>音视频编码格式各类繁多，主要有几下几类：</p>
<p>MPEG 系列</p>
<p>（由 ISO[国际标准组织机构]下属的 MPEG[运动图象专家组]开发 ）视频编码方面主要是 Mpeg1（vcd 用的就是它）、Mpeg2（DVD 使用）、Mpeg4（的 DVDRIP 使用的都是它的变种，如：divx，xvid 等）、Mpeg4 AVC（正热门）；音频编码方面主要是 MPEG Audio Layer 1/2、MPEG Audio Layer 3（大名鼎鼎的 mp3）、MPEG-2 AAC 、MPEG-4 AAC 等等。注意：DVD 音频没有采用 Mpeg 的。</p>
<p>H.26X 系列</p>
<p>（由 ITU[国际电传视讯联盟]主导，侧重网络传输，注意：只是视频编码）</p>
<p>包括 H.261、H.262、H.263、H.263+、H.263++、H.264（就是 MPEG4 AVC-合作的结晶）</p>
<p>目前最常用的编码标准是视频 H.264，音频 AAC。</p>
<p>提问：</p>
<p>H.264 是编码格式还是文件格式？</p>
<p>mp4 是编码格式还是文件格式？</p>
<h4 id="_7-7-3-ffmpeg-的基本使用" tabindex="-1"><a class="header-anchor" href="#_7-7-3-ffmpeg-的基本使用" aria-hidden="true">#</a> <strong>7.7.3 FFmpeg 的基本使用</strong></h4>
<p><strong>流媒体程序员</strong></p>
<p>我们将视频录制完成后，使用视频编码软件对视频进行编码，本项目 使用 FFmpeg 对视频进行编码 。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180125862.png" alt="image-20230521180125862"></p>
<p>FFmpeg 被许多开源项目采用，QQ 影音、暴风影音、VLC 等。</p>
<p>下载：FFmpeg <a href="https://www.ffmpeg.org/download.html#build-windows" target="_blank" rel="noopener noreferrer">https://www.ffmpeg.org/download.html#build-windows<ExternalLinkIcon/></a></p>
<p>请从课程资料目录解压 ffmpeg.zip,并将解压得到的 exe 文件加入环境变量。</p>
<p>测试是否正常：cmd 运行 ffmpeg -v</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180131520.png" alt="image-20230521180131520"></p>
<p>安装成功，作下简单测试</p>
<p>将一个.avi 文件转成 mp4、mp3、gif 等。</p>
<p>比如我们将 nacos.avi 文件转成 mp4，运行如下命令：</p>
<p>D:\soft\ffmpeg\ffmpeg.exe -i 1.avi 1.mp4</p>
<p>可以将 ffmpeg.exe 配置到环境变量 path 中，进入视频目录直接运行：ffmpeg.exe -i 1.avi 1.mp4</p>
<p>转成 mp3：ffmpeg -i nacos.avi nacos.mp3</p>
<p>转成 gif：ffmpeg -i nacos.avi nacos.gif</p>
<p>官方文档（英文）：<a href="http://ffmpeg.org/ffmpeg.html" target="_blank" rel="noopener noreferrer">http://ffmpeg.org/ffmpeg.html<ExternalLinkIcon/></a></p>
<h4 id="_7-7-4-视频处理工具类" tabindex="-1"><a class="header-anchor" href="#_7-7-4-视频处理工具类" aria-hidden="true">#</a> <strong>7.7.4 视频处理工具类</strong></h4>
<p>将课程资料目录中的 util.zip 解压，将解压出的工具类拷贝至 base 工程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180142400.png" alt="image-20230521180142400"></p>
<p>其中 Mp4VideoUtil 类是用于将视频转为 mp4 格式，是我们项目要使用的工具类。</p>
<p>下边看下这个类的代码，并进行测试。</p>
<p>我们要通过 ffmpeg 对视频转码，Java 程序调用 ffmpeg，使用 java.lang.ProcessBuilder 去完成，具体在 Mp4VideoUtil 类的 63 行，下边进行简单的测试，下边的代码运行本机安装的 QQ 软件。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对 Mp4VideoUtil 类需要学习使用方法，下边代码将一个 avi 视频转为 mp4 视频，如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行 main 方法，最终在控制台输出 success 表示执行成功。</p>
<h3 id="_7-2-分布式任务处理" tabindex="-1"><a class="header-anchor" href="#_7-2-分布式任务处理" aria-hidden="true">#</a> <strong>7.2 分布式任务处理</strong></h3>
<h4 id="_7-2-1-什么是分布式任务调度" tabindex="-1"><a class="header-anchor" href="#_7-2-1-什么是分布式任务调度" aria-hidden="true">#</a> <strong>7.2.1 什么是分布式任务调度</strong></h4>
<p>如何去高效处理一批任务呢？</p>
<p>1、多线程</p>
<p>多线程是充分利用单机的资源。</p>
<p>2、分布式加多线程</p>
...
<p>方案 2 可扩展性更强。</p>
<p>方案 2 是一种分布式任务调度的处理方案。</p>
<p>什么是分布式任务调度？</p>
<p>我们可以先思考一下下面业务场景的解决方案：</p>
<p>每隔 24 小时执行数据备份任务。</p>
<p>12306 网站会根据车次不同，设置几个时间点分批次放票。</p>
<p>某财务系统需要在每天上午 10 点前结算前一天的账单数据，统计汇总。</p>
<p>商品成功发货后，需要向客户发送短信提醒。</p>
<p>类似的场景还有很多，我们该如何实现？</p>
<p><strong>多线程方式实现：</strong></p>
<p>学过多线程的同学，可能会想到，我们可以开启一个线程，每 sleep 一段时间，就去检查是否已到预期执行时间。</p>
...
<p>Jdk 也为我们提供了相关支持，如 Timer、ScheduledExecutor，下边我们了解下。</p>
<p><strong>Timer 方式实现</strong>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Timer 的优点在于简单易用，每个 Timer 对应一个线程，因此可以同时启动多个 Timer 并行执行多个任务，同一个 Timer 中的任务是串行执行。</p>
<p><strong>ScheduledExecutor 方式实现</strong>：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Java 5 推出了基于线程池设计的 ScheduledExecutor，其设计思想是，每一个被调度的任务都会由线程池中一个线程去执行，因此任务是并发执行的，相互之间不会受到干扰。</p>
<p>Timer 和 ScheduledExecutor 都仅能提供基于开始时间与重复间隔的任务调度，不能胜任更加复杂的调度需求。比如，设置每月第一天凌晨 1 点执行任务、复杂调度任务的管理、任务间传递数据等等。</p>
<p><strong>第三方 Quartz 方式实现，项目地址：https://github.com/quartz-scheduler/quartz</strong></p>
<p>Quartz 是一个功能强大的任务调度框架，它可以满足更多更复杂的调度需求，Quartz 设计的核心类包括 Scheduler, Job 以及 Trigger。其中，Job 负责定义需要执行的任务，Trigger 负责设置调度策略，Scheduler 将二者组装在一起，并触发任务开始执行。Quartz 支持简单的按时间间隔调度、还支持按日历调度方式，通过设置 CronTrigger 表达式（包括：秒、分、时、日、月、周、年）进行任务调度。</p>
<p>下边是一个例子代码：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过以上内容我们学习了什么是任务调度，任务调度所解决的问题，以及任务调度的多种实现方式。</p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180334738.png" alt="image-20230521180334738"></p>
...
<p>1、并行任务调度</p>
<p>并行任务调度实现靠多线程，如果有大量任务需要调度，此时光靠多线程就会有瓶颈了，因为一台计算机 CPU 的处理能力是有限的。</p>
...
<h4 id="_7-2-2-xxl-job-介绍" tabindex="-1"><a class="header-anchor" href="#_7-2-2-xxl-job-介绍" aria-hidden="true">#</a> <strong>7.2.2 XXL-JOB 介绍</strong></h4>
<p>XXL-JOB 是一个轻量级分布式任务调度平台，其核心设计目标是开发迅速、学习简单、轻量级、易扩展。现已开放源代码并接入多家公司线上产品线，开箱即用。</p>
<p>官网：https://www.xuxueli.com/xxl-job/</p>
<p>文档：https://www.xuxueli.com/xxl-job/#%E3%80%8A%E5%88%86%E5%B8%83%E5%BC%8F%E4%BB%BB%E5%8A%A1%E8%B0%83%E5%BA%A6%E5%B9%B3%E5%8F%B0XXL-JOB%E3%80%8B</p>
<p>XXL-JOB 主要有调度中心、执行器、任务：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180414046.png" alt="image-20230521180414046"></p>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180423515.png" alt="image-20230521180423515"></p>
...
<h4 id="_7-2-3-搭建-xxl-job" tabindex="-1"><a class="header-anchor" href="#_7-2-3-搭建-xxl-job" aria-hidden="true">#</a> <strong>7.2.3 搭建 XXL-JOB</strong></h4>
<h5 id="_7-2-3-1-调度中心" tabindex="-1"><a class="header-anchor" href="#_7-2-3-1-调度中心" aria-hidden="true">#</a> <strong>7.2.3.1 调度中心</strong></h5>
<p>首先下载 XXL-JOB</p>
<p>GitHub：<a href="https://github.com/xuxueli/xxl-job" target="_blank" rel="noopener noreferrer">https://github.com/xuxueli/xxl-job<ExternalLinkIcon/></a></p>
<p>码云：<a href="https://gitee.com/xuxueli0323/xxl-job" target="_blank" rel="noopener noreferrer">https://gitee.com/xuxueli0323/xxl-job<ExternalLinkIcon/></a></p>
<p>项目使用 2.3.1 版本： https://github.com/xuxueli/xxl-job/releases/tag/2.3.1</p>
<p>也可从课程资料目录获取，解压 xxl-job-2.3.1.zip</p>
<p>使用 IDEA 打开解压后的目录</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180432547.png" alt="image-20230521180432547"></p>
<p>xxl-job-admin：调度中心</p>
<p>xxl-job-core：公共依赖</p>
<p>xxl-job-executor-samples：执行器 Sample 示例（选择合适的版本执行器，可直接使用）</p>
<p>：xxl-job-executor-sample-springboot：Springboot 版本，通过 Springboot 管理执行器，推荐这种方式；</p>
<p>：xxl-job-executor-sample-frameless：无框架版本；</p>
<p>doc :文档资料，包含数据库脚本</p>
<p>在下发的虚拟机的 MySQL 中已经创建了 xxl_job_2.3.1 数据库</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180442150.png" alt="image-20230521180442150"></p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180447626.png" alt="image-20230521180447626"></p>
<p>执行 sh /data/soft/restart.sh 自动启动 xxl-job 调度中心</p>
<p>访问：http://192.168.101.65:8088/xxl-job-admin/</p>
<p>账号和密码：admin/123456</p>
<p>如果无法使用虚拟机运行 xxl-job 可以在本机 idea 运行 xxl-job 调度中心。</p>
<h5 id="_7-2-3-2-执行器" tabindex="-1"><a class="header-anchor" href="#_7-2-3-2-执行器" aria-hidden="true">#</a> <strong>7.2.3.2 执行器</strong></h5>
<p>下边配置执行器，执行器负责与调度中心通信接收调度中心发起的任务调度请求。</p>
<p>1、下边进入调度中心添加执行器</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180502712.png" alt="image-20230521180502712"></p>
<p>点击新增，填写执行器信息，appname 是前边在 nacos 中配置 xxl 信息时指定的执行器的应用名。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180513326.png" alt="image-20230521180513326"></p>
<p>添加成功：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180518819.png" alt="image-20230521180518819"></p>
<p>2、首先在媒资管理模块的 service 工程添加依赖，在项目的父工程已约定了版本 2.3.1</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、在 nacos 下的 media-service-dev.yaml 下配置 xxl-job</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">xxl</span><span class="token punctuation">:</span>
...
<p>4、配置 xxl-job 的执行器</p>
<p>将 xxl-job 示例工程下配置类拷贝到媒资管理的 service 工程下</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180556533.png" alt="image-20230521180556533"></p>
<p>拷贝至：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180603161.png" alt="image-20230521180603161"></p>
<p>到此完成媒资管理模块 service 工程配置 xxl-job 执行器，在 xxl-job 调度中心添加执行器，下边准备测试执行器与调度中心是否正常通信，因为接口工程依赖了 service 工程，所以启动媒资管理模块的接口工程。</p>
<p>启动后观察日志，出现下边的日志表示执行器在调度中心注册成功</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180613249.png" alt="image-20230521180613249"></p>
<p>同时观察调度中心中的执行器界面</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180617606.png" alt="image-20230521180617606"></p>
<p>在线机器地址处已显示 1 个执行器。</p>
<h5 id="_7-2-3-3-执行任务" tabindex="-1"><a class="header-anchor" href="#_7-2-3-3-执行任务" aria-hidden="true">#</a> <strong>7.2.3.3 执行任务</strong></h5>
<p>下边编写任务，参考示例工程中任务类的编写方法，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180640610.png" alt="image-20230521180640610"></p>
<p>在媒资服务 service 包下新建 jobhandler 存放任务类，下边参考示例工程编写一个任务类</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下边在调度中心添加任务，进入任务管理</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180658297.png" alt="image-20230521180658297"></p>
<p>点击新增，填写任务信息</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180703948.png" alt="image-20230521180703948"></p>
<p>注意红色标记处：</p>
<p><strong>调度类型：</strong></p>
<p>固定速度指按固定的间隔定时调度。</p>
<p>Cron，通过 Cron 表达式实现更丰富的定时调度策略。</p>
<p>Cron 表达式是一个字符串，通过它可以定义调度策略，格式如下：</p>
<p>{秒数} {分钟} {小时} {日期} {月份} {星期} {年份(可为空)}</p>
<p>xxl-job 提供图形界面去配置：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180714771.png" alt="image-20230521180714771"></p>
<p>一些例子如下：</p>
<p>30 10 1 * * ? 每天 1 点 10 分 30 秒触发</p>
<p>0/30 * * * * ? 每 30 秒触发一次</p>
<p>* 0/10 * * * ? 每 10 分钟触发一次</p>
<p><strong>运行模式</strong>有 BEAN 和 GLUE，bean 模式较常用就是在项目工程中编写执行器的任务代码，GLUE 是将任务代码编写在调度中心。</p>
<p><strong>JobHandler</strong>即任务方法名，填写任务方法上边@XxlJob 注解中的名称。</p>
<p>**路由策略：**当执行器集群部署时，调度中心向哪个执行器下发任务，这里选择第一个表示只向第一个执行器下发任务，路由策略的其它选项稍后在分片广播章节详细解释。</p>
<p>高级配置的其它配置项稍后在分片广播章节详细解释。</p>
<p>添加成功，启动任务</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180724944.png" alt="image-20230521180724944"></p>
<p>通过调度日志查看任务执行情况</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180729915.png" alt="image-20230521180729915"></p>
<p>下边启动媒资管理的 service 工程，启动执行器。</p>
<p>观察执行器方法的执行。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180735194.png" alt="image-20230521180735194"></p>
<p>如果要停止任务需要在调度中心操作</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180741294.png" alt="image-20230521180741294"></p>
<p>任务跑一段时间注意清理日志</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180747339.png" alt="image-20230521180747339"></p>
<h4 id="_7-2-4-分片广播" tabindex="-1"><a class="header-anchor" href="#_7-2-4-分片广播" aria-hidden="true">#</a> <strong>7.2.4 分片广播</strong></h4>
<p>掌握了 xxl-job 的基本使用，下边思考如何进行分布式任务处理呢？如下图，我们会启动多个执行器组成一个集群，去执行任务。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180752964.png" alt="image-20230521180752964"></p>
<blockquote>
<p>执行器在集群部署下调度中心有哪些调度策略呢？</p>
</blockquote>
<p>查看 xxl-job 官方文档，阅读高级配置相关的内容：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>高级配置：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下边要重点说的是分片广播策略，分片是指是调度中心以执行器为维度进行分片，将集群中的执行器标上序号：0，1，2，3...，广播是指每次调度会向集群中的所有执行器发送任务调度，请求中携带分片参数。</p>
<p>如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180836425.png" alt="image-20230521180836425"></p>
<p>每个执行器收到调度请求同时接收分片参数。</p>
<p>xxl-job 支持动态扩容执行器集群从而动态增加分片数量，当有任务量增加可以部署更多的执行器到集群中，调度中心会动态修改分片的数量。</p>
<p><strong>作业分片适用哪些场景呢？</strong></p>
<p>分片任务场景：10 个执行器的集群来处理 10w 条数据，每台机器只需要处理 1w 条数据，耗时降低 10 倍；</p>
<p>广播任务场景：广播执行器同时运行 shell 脚本、广播集群节点进行缓存更新等。</p>
<p>所以，广播分片方式不仅可以充分发挥每个执行器的能力，并且根据分片参数可以控制任务是否执行，最终灵活控制了执行器集群分布式处理任务。</p>
<p><strong>使用说明：</strong></p>
<p>&quot;分片广播&quot; 和普通任务开发流程一致，不同之处在于可以获取分片参数进行分片业务处理。</p>
<p>Java 语言任务获取分片参数方式：</p>
<p>BEAN、GLUE 模式(Java)，可参考 Sample 示例执行器中的示例任务&quot;ShardingJobHandler&quot;：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 2、分片广播任务
 */</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在调度中心添加任务</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180911147.png" alt="image-20230521180911147"></p>
<p>添加成功：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180917665.png" alt="image-20230521180917665"></p>
<p>启动任务，观察日志</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180922827.png" alt="image-20230521180922827"></p>
<p>下边启动两个执行器实例，观察每个实例的执行情况</p>
<p>首先在 nacos 中配置 media-service 的本地优先配置：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>##配置本地优先
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将 media-service 启动两个实例</p>
<p>两个实例的在启动时注意端口不能冲突：</p>
<p>实例 1 在 VM options 处添加：-Dserver.port=63051 -Dxxl.job.executor.port=9998</p>
<p>实例 2 在 VM options 处添加：-Dserver.port=63050 -Dxxl.job.executor.port=9999</p>
<p>例如：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180941555.png" alt="image-20230521180941555"></p>
<p>启动两个实例</p>
<p>观察任务调度中心，稍等片刻执行器有两个</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180947517.png" alt="image-20230521180947517"></p>
<p>观察两个执行实例的日志：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180953607.png" alt="image-20230521180953607"></p>
<p>另一实例的日志如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521180957825.png" alt="image-20230521180957825"></p>
<p>从日志可以看每个实例的分片序号不同。</p>
<p>如果其中一个执行器挂掉，只剩下一个执行器在工作，稍等片刻调用中心发现少了一个执行器将动态调整总分片数为 1。</p>
<p>到此作业分片任务调试完成，此时我们可以思考：</p>
<blockquote>
<p>当一次分片广播到来，各执行器如何根据分片参数去分布式执行任务，保证执行器之间执行的任务不重复呢？</p>
</blockquote>
<h3 id="_7-3-技术方案" tabindex="-1"><a class="header-anchor" href="#_7-3-技术方案" aria-hidden="true">#</a> <strong>7.3 技术方案</strong></h3>
<h4 id="_7-3-1-作业分片方案" tabindex="-1"><a class="header-anchor" href="#_7-3-1-作业分片方案" aria-hidden="true">#</a> <strong>7.3.1 作业分片方案</strong></h4>
<p>掌握了 xxl-job 的分片广播调度方式，下边思考如何分布式去执行学成在线平台中的视频处理任务。</p>
<p>任务添加成功后，对于要处理的任务会添加到待处理任务表中，现在启动多个执行器实例去查询这些待处理任务，<strong>此时如何保证多个执行器不会查询到重复的任务呢？</strong></p>
<p>XXL-JOB 并不直接提供数据处理的功能，它只会给执行器分配好分片序号，在向执行器任务调度的同时下发分片总数以及分片序号等参数，执行器收到这些参数根据自己的业务需求去利用这些参数。</p>
<p>下图表示了多个执行器获取视频处理任务的结构：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181030647.png" alt="image-20230521181030647"></p>
<p>每个执行器收到广播任务有两个参数：分片总数、分片序号。每个执行从数据表取任务时可以让任务 id 模上 分片总数，如果等于分片序号则执行此任务。</p>
<p>上边两个执行器实例那么分片总数为 2，序号为 0、1，从任务 1 开始，如下：</p>
<p>1 % 2 = 1 执行器 2 执行</p>
<p>2 % 2 = 0 执行器 1 执行</p>
<p>3 % 2 = 1 执行器 2 执行</p>
<p>以此类推.</p>
<h4 id="_7-3-2-保证任务不重复执行" tabindex="-1"><a class="header-anchor" href="#_7-3-2-保证任务不重复执行" aria-hidden="true">#</a> <strong>7.3.2 保证任务不重复执行</strong></h4>
<blockquote>
...
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181043641.png" alt="image-20230521181043641"></p>
<p>其次，再看阻塞处理策略，阻塞处理策略就是当前执行器正在执行任务还没有结束时调度中心进行任务调度，此时该如何处理。</p>
<p>查看文档如下：
单机串行（默认）：调度请求进入单机执行器后，调度请求进入 FIFO 队列并以串行方式运行；
丢弃后续调度：调度请求进入单机执行器后，发现执行器存在运行的调度任务，本次请求将会被丢弃并标记为失败；
覆盖之前调度：调度请求进入单机执行器后，发现执行器存在运行的调度任务，将会终止运行中的调度任务并清空队列，然后运行本地调度任务；</p>
...
<h4 id="_7-3-3-视频处理方案" tabindex="-1"><a class="header-anchor" href="#_7-3-3-视频处理方案" aria-hidden="true">#</a> <strong>7.3.3 视频处理方案</strong></h4>
<p>确定了分片方案，下边梳理整个视频上传及处理的业务流程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181122420.png" alt="image-20230521181122420"></p>
<p>上传视频成功向视频处理待处理表添加记录。</p>
<p>视频处理的详细流程如下：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181128453.png" alt="image-20230521181128453"></p>
<p>1、任务调度中心广播作业分片。</p>
<p>2、执行器收到广播作业分片，从数据库读取待处理任务，读取未处理及处理失败的任务。</p>
<p>3、执行器更新任务为处理中，根据任务内容从 MinIO 下载要处理的文件。</p>
<p>4、执行器启动多线程去处理任务。</p>
<p>5、任务处理完成，上传处理后的视频到 MinIO。</p>
<p>6、将更新任务处理结果，如果视频处理完成除了更新任务处理结果以外还要将文件的访问地址更新至任务处理表及文件表中，最后将任务完成记录写入历史表。</p>
<h3 id="_7-4-查询待处理任务" tabindex="-1"><a class="header-anchor" href="#_7-4-查询待处理任务" aria-hidden="true">#</a> <strong>7.4 查询待处理任务</strong></h3>
<h4 id="_7-4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_7-4-1-需求分析" aria-hidden="true">#</a> <strong>7.4.1 需求分析</strong></h4>
<p>查询待处理任务只处理未提交及处理失败的任务，任务处理失败后进行重试，最多重试 3 次。</p>
<p>任务处理成功将待处理记录移动到历史任务表。</p>
<p>下图是待处理任务表：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181136042.png" alt="image-20230521181136042"></p>
<p>历史任务表与待处理任务表的结构相同。</p>
<h4 id="_7-4-2-添加待处理任务" tabindex="-1"><a class="header-anchor" href="#_7-4-2-添加待处理任务" aria-hidden="true">#</a> <strong>7.4.2 添加待处理任务</strong></h4>
<p>上传视频成功向视频处理待处理表添加记录，暂时只添加对 avi 视频的处理记录。</p>
<p>根据 MIME Type 去判断是否是 avi 视频，下边列出部分 MIME Type</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181143845.png" alt="image-20230521181143845"></p>
<p>avi 视频的 MIME Type 是 video/x-msvideo</p>
<p>修改文件信息入库方法，如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Transactional</span>
<span class="token keyword">public</span> <span class="token class-name">MediaFiles</span> <span class="token function">addMediaFilesToDb</span><span class="token punctuation">(</span><span class="token class-name">Long</span> companyId<span class="token punctuation">,</span> <span class="token class-name">String</span> fileMd5<span class="token punctuation">,</span> <span class="token class-name">UploadFileParamsDto</span> uploadFileParamsDto<span class="token punctuation">,</span> <span class="token class-name">String</span> bucket<span class="token punctuation">,</span> <span class="token class-name">String</span> objectName<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">//从数据库查询文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进行前后端测试，上传 4 个 avi 视频，观察待处理任务表是否存在记录，记录是否完成</p>
<h4 id="_7-4-3-查询待处理任务" tabindex="-1"><a class="header-anchor" href="#_7-4-3-查询待处理任务" aria-hidden="true">#</a> <strong>7.4.3 查询待处理任务</strong></h4>
<p><strong>如何保证查询到的待处理视频记录不重复？</strong></p>
<p>编写根据分片参数获取待处理任务的 DAO 方法，定义 DAO 接口如下：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义 Service 接口，查询待处理</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-5-开始执行任务" tabindex="-1"><a class="header-anchor" href="#_7-5-开始执行任务" aria-hidden="true">#</a> <strong>7.5 开始执行任务</strong></h3>
<h4 id="_7-5-1-分布式锁" tabindex="-1"><a class="header-anchor" href="#_7-5-1-分布式锁" aria-hidden="true">#</a> <strong>7.5.1 分布式锁</strong></h4>
<p>为了避免多线程去争抢同一个任务可以使用 synchronized 同步锁去解决，如下代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">synchronized</span><span class="token punctuation">(</span>锁对象<span class="token punctuation">)</span><span class="token punctuation">{</span>
   执行任务<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token punctuation">}</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>synchronized 只能保证同一个虚拟机中多个线程去争抢锁。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181420329.png" alt="image-20230521181420329"></p>
<p>如果是多个执行器分布式部署，并不能保证同一个视频只有一个执行器去处理。</p>
<p>现在要实现分布式环境下所有虚拟机中的线程去同步执行就需要让多个虚拟机去共用一个锁，虚拟机可以分布式部署，锁也可以分布式部署，如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181425785.png" alt="image-20230521181425785"></p>
<p>虚拟机都去抢占同一个锁，锁是一个单独的程序提供加锁、解锁服务。</p>
<p>该锁已不属于某个虚拟机，而是分布式部署，由多个虚拟机所共享，这种锁叫<strong>分布式锁</strong>。</p>
<p>实现分布式锁的方案有很多，常用的如下：</p>
<p>1、基于数据库实现分布锁</p>
<p>利用数据库主键唯一性的特点，或利用数据库唯一索引、行级锁的特点，多个线程同时去更新相同的记录，谁更新成功谁就抢到锁。</p>
<p>2、基于 redis 实现锁</p>
<p>redis 提供了分布式锁的实现方案，比如：SETNX、set nx、redisson 等。</p>
<p>拿 SETNX 举例说明，SETNX 命令的工作过程是去 set 一个不存在的 key，多个线程去设置同一个 key 只会有一个线程设置成功，设置成功的的线程拿到锁。</p>
<p>3、使用 zookeeper 实现</p>
<p>zookeeper 是一个分布式协调服务，主要解决分布式程序之间的同步的问题。zookeeper 的结构类似的文件目录，多线程向 zookeeper 创建一个子目录(节点)只会有一个创建成功，利用此特点可以实现分布式锁，谁创建该结点成功谁就获得锁。</p>
<h4 id="_7-5-2-开启任务" tabindex="-1"><a class="header-anchor" href="#_7-5-2-开启任务" aria-hidden="true">#</a> <strong>7.5.2 开启任务</strong></h4>
<p>下边基于数据库方式实现分布锁，开始执行任务将任务执行状态更新为 4 表示任务执行中。</p>
<p>下边的 sql 语句可以实现更新操作：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">update</span> media_process m <span class="token keyword">set</span> m<span class="token punctuation">.</span><span class="token keyword">status</span><span class="token operator">=</span><span class="token string">'4'</span> <span class="token keyword">where</span>  m<span class="token punctuation">.</span>id<span class="token operator">=</span>?

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是多个线程去执行该 sql 都将会执行成功，但需求是只能有一个线程抢到锁，所以此 sql 无法满足需求。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>多个线程同时执行上边的 sql 只会有一个线程执行成功。</p>
<p><strong>什么是乐观锁、悲观锁？</strong></p>
<p>synchronized 是一种悲观锁，在执行被 synchronized 包裹的代码时需要首先获取锁，没有拿到锁则无法执行，是总悲观的认为别的线程会去抢，所以叫悲观锁。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-6-更新任务状态" tabindex="-1"><a class="header-anchor" href="#_7-6-更新任务状态" aria-hidden="true">#</a> <strong>7.6 更新任务状态</strong></h3>
<p>任务处理完成需要更新任务处理结果，任务执行成功更新视频的 URL、及任务处理结果，将待处理任务记录删除，同时向历史任务表添加记录。</p>
<p>在 MediaFileProcessService 接口添加方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-7-视频处理" tabindex="-1"><a class="header-anchor" href="#_7-7-视频处理" aria-hidden="true">#</a> <strong>7.7 视频处理</strong></h3>
<p>视频采用并发处理，每个视频使用一个线程去处理，每次处理的视频数量不要超过 cpu 核心数。</p>
<p>所有视频处理完成结束本次执行，为防止代码异常出现无限期等待则添加超时设置，到达超时时间还没有处理完成仍结束任务。</p>
<p>定义任务类 VideoTask 如下：</p>
...
<h4 id="_7-8-1-基本测试" tabindex="-1"><a class="header-anchor" href="#_7-8-1-基本测试" aria-hidden="true">#</a> <strong>7.8.1 基本测试</strong></h4>
<p>进入 xxl-job 调度中心添加执行器和视频处理任务</p>
<p>在 xxl-job 配置任务调度策略：</p>
<p>1）配置阻塞处理策略为：丢弃后续调度。</p>
<p>2）配置视频处理调度时间间隔不用根据视频处理时间去确定，可以配置的小一些，如：5 分钟，即使到达调度时间如果视频没有处理完会丢弃调度请求。</p>
<p>配置完成开始测试视频处理：</p>
<p>1、首先上传至少 4 个视频，非 mp4 格式。</p>
<p>2、在 xxl-job 启动视频处理任务</p>
<p>3、观察媒资管理服务后台日志</p>
<h4 id="_7-8-2-失败测试" tabindex="-1"><a class="header-anchor" href="#_7-8-2-失败测试" aria-hidden="true">#</a> <strong>7.8.2 失败测试</strong></h4>
<p>1、先停止调度中心的视频处理任务。</p>
<p>2、上传视频，手动修改待处理任务表中 file_path 字段为一个不存在的文件地址</p>
<p>3、启动任务</p>
<p>观察任务处理失败后是否会重试，并记录失败次数。</p>
<h4 id="_7-8-3-抢占任务测试" tabindex="-1"><a class="header-anchor" href="#_7-8-3-抢占任务测试" aria-hidden="true">#</a> <strong>7.8.3 抢占任务测试</strong></h4>
<p>1、修改调度中心中视频处理任务的阻塞处理策略为“覆盖之间的调度”</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181651102.png" alt="image-20230521181651102"></p>
<p>2、在抢占任务代码处打断点并选择支持多线程方式</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181657594.png" alt="image-20230521181657594"></p>
<p>3、在抢占任务代码处的下边两行代码分别打上断点，避免观察时代码继续执行。</p>
<p>4、启动任务</p>
<p>此时多个线程执行都停留在断点处</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181704394.png" alt="image-20230521181704394"></p>
<p>依次放行，观察同一个任务只会被一个线程抢占成功。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181709767.png" alt="image-20230521181709767"></p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181714516.png" alt="image-20230521181714516"></p>
<h3 id="_7-9-其它问题" tabindex="-1"><a class="header-anchor" href="#_7-9-其它问题" aria-hidden="true">#</a> <strong>7.9 其它问题</strong></h3>
<h4 id="_7-9-1-任务补偿机制" tabindex="-1"><a class="header-anchor" href="#_7-9-1-任务补偿机制" aria-hidden="true">#</a> <strong>7.9.1 任务补偿机制</strong></h4>
<p>如果有线程抢占了某个视频的处理任务，如果线程处理过程中挂掉了，该视频的状态将会一直是处理中，其它线程将无法处理，这个问题需要用补偿机制。</p>
<p>单独启动一个任务找到待处理任务表中超过执行期限但仍在处理中的任务，将任务的状态改为执行失败。</p>
<p>任务执行期限是处理一个视频的最大时间，比如定为 30 分钟，通过任务的启动时间去判断任务是否超过执行期限。</p>
<p>大家思考这个 sql 该如何实现？</p>
<p>大家尝试自己实现此任务补偿机制。</p>
<h4 id="_7-9-2-达到最大失败次数" tabindex="-1"><a class="header-anchor" href="#_7-9-2-达到最大失败次数" aria-hidden="true">#</a> <strong>7.9.2 达到最大失败次数</strong></h4>
<p>当任务达到最大失败次数时一般就说明程序处理此视频存在问题，这种情况就需要人工处理，在页面上会提示失败的信息，人工可手动执行该视频进行处理，或通过其它转码工具进行视频转码，转码后直接上传 mp4 视频。</p>
<h2 id="_8-绑定媒资" tabindex="-1"><a class="header-anchor" href="#_8-绑定媒资" aria-hidden="true">#</a> <strong>8 绑定媒资</strong></h2>
...
<p>到目前为止，媒资管理已完成文件上传、视频处理、我的媒资功能等基本功能，其它模块可以使用媒资文件，本节要讲解课程计划绑定媒资文件。</p>
<p>如何将课程计划绑定媒资呢？</p>
<p>首先进入课程计划界面，然后选择要绑定的视频进行绑定即可。</p>
<p>具体的业务流程如下：</p>
<p>1.教育机构用户进入课程管理页面并编辑某一个课程，在&quot;课程大纲&quot;标签页的某一小节后可点击”添加视频“。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181734951.png" alt="image-20230521181734951"></p>
<p>2.弹出添加视频对话框，可通过视频关键字搜索已审核通过的视频媒资。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181740422.png" alt="image-20230521181740422"></p>
<p>3.选择视频媒资，点击提交按钮，完成课程计划绑定媒资流程。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181746130.png" alt="image-20230521181746130"></p>
<p>课程计划关联视频后如下图：</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181753498.png" alt="image-20230521181753498"></p>
<p>点击已经绑定的视频名称即可解除绑定。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181759166.png" alt="image-20230521181759166"></p>
<h4 id="_8-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_8-1-2-数据模型" aria-hidden="true">#</a> <strong>8.1.2 数据模型</strong></h4>
<p>课程计划绑定媒资文件后存储至课程计划绑定媒资表</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521181804767.png" alt="image-20230521181804767"></p>
<h3 id="_8-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_8-2-接口定义" aria-hidden="true">#</a> <strong>8.2 接口定义</strong></h3>
<p>根据业务流程，用户进入课程计划列表，首先确定向哪个课程计划添加视频，点击”添加视频“后用户选择视频，选择视频，点击提交，前端以 json 格式请求以下参数：</p>
<p>提交媒资文件 id、文件名称、教学计划 id</p>
<p>示例如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此接口在内容管理模块提供。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 TeachplanController 类中定义接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span>value <span class="token operator">=</span> <span class="token string">"课程计划和媒资信息绑定"</span><span class="token punctuation">)</span>
...
<h4 id="_8-3-1-dao-开发" tabindex="-1"><a class="header-anchor" href="#_8-3-1-dao-开发" aria-hidden="true">#</a> <strong>8.3.1 DAO 开发</strong></h4>
<p>对 teachplanMedia 表自动生成 Mapper。</p>
...
<p>1、使用 httpclient 测试</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 课程计划绑定视频
...
<p>向指定课程计划添加视频</p>
<h3 id="_8-4-实战-前端代码有问题" tabindex="-1"><a class="header-anchor" href="#_8-4-实战-前端代码有问题" aria-hidden="true">#</a> <strong>8.4 实战（前端代码有问题）</strong></h3>
<p>根据接口定义实现解除绑定功能。</p>
<p>点击已经绑定的视频名称即可解除绑定。</p>
<p><img src="@source/notes/project/02/第3章 媒资管理模块v3.1/assets/image-20230521182028374.png" alt="image-20230521182028374"></p>
<p>接口定义如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>delete /teachplan/association/media/<span class="token punctuation">{</span>teachPlanId<span class="token punctuation">}</span>/<span class="token punctuation">{</span>mediaId<span class="token punctuation">}</span>

返回<span class="token number">200</span>状态码表示成功。


</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>开发完成使用 httpclient 测试、前后端联调</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>#### 课程计划接触视频绑定
