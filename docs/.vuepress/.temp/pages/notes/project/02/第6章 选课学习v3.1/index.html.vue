<template><div><h1 id="第-6-章-选课学习-v3-1" tabindex="-1"><a class="header-anchor" href="#第-6-章-选课学习-v3-1" aria-hidden="true">#</a> <strong>第 6 章 选课学习 v3.1</strong></h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-模块需求分析">1 模块需求分析</router-link><ul><li><router-link to="#_1-1-模块介绍">1.1 模块介绍</router-link></li><li><router-link to="#_1-2-业务流程">1.2 业务流程</router-link></li></ul></li><li><router-link to="#_2-添加选课">2 添加选课</router-link><ul><li><router-link to="#_2-1-需求分析">2.1 需求分析</router-link></li><li><router-link to="#_2-2-接口开发">2.2 接口开发</router-link></li><li><router-link to="#_2-3-接口测试">2.3 接口测试</router-link></li></ul></li><li><router-link to="#_3-支付">3 支付</router-link><ul><li><router-link to="#_3-1-需求分析">3.1 需求分析</router-link></li><li><router-link to="#_3-2-支付接口调研">3.2 支付接口调研</router-link></li><li><router-link to="#_3-3-准备开发环境">3.3 准备开发环境</router-link></li><li><router-link to="#_3-4-支付接口测试">3.4 支付接口测试</router-link></li><li><router-link to="#_3-5-生成支付二维码">3.5 生成支付二维码</router-link></li><li><router-link to="#_3-6-查询支付结果">3.6 查询支付结果</router-link></li><li><router-link to="#_3-7-接收支付通知">3.7 接收支付通知</router-link></li></ul></li><li><router-link to="#_4-支付通知">4 支付通知</router-link><ul><li><router-link to="#_4-1-需求分析">4.1 需求分析</router-link></li><li><router-link to="#_4-2-技术方案">4.2 技术方案</router-link></li><li><router-link to="#_4-3-发送支付结果">4.3 发送支付结果</router-link></li><li><router-link to="#_4-4-接收支付结果">4.4 接收支付结果</router-link></li><li><router-link to="#_4-5-通知支付结果测试">4.5 通知支付结果测试</router-link></li></ul></li><li><router-link to="#_4-在线学习">4 在线学习</router-link><ul><li><router-link to="#_4-1-需求分析-1">4.1 需求分析</router-link></li><li><router-link to="#_4-2-查询课程信息">4.2 查询课程信息</router-link></li><li><router-link to="#_4-3-获取视频">4.3 获取视频</router-link></li><li><router-link to="#_4-4-我的课表">4.4 我的课表</router-link></li></ul></li></ul></nav>
...
<p>模块整体流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154802958.png" alt="image-20230611154802958"></p>
<h3 id="_1-2-业务流程" tabindex="-1"><a class="header-anchor" href="#_1-2-业务流程" aria-hidden="true">#</a> <strong>1.2 业务流程</strong></h3>
<h4 id="_1-2-1-学习引导" tabindex="-1"><a class="header-anchor" href="#_1-2-1-学习引导" aria-hidden="true">#</a> <strong>1.2.1 学习引导</strong></h4>
<p>用户通过搜索课程、课程推荐等信息进入课程详情页面，点击“马上学习” 引导进入学习界面去学习。</p>
<p>流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154832783.png" alt="image-20230611154832783">1、进入课程详情点击马上学习</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154838147.png" alt="image-20230611154838147">2、课程免费时引导加入我的课程表、或进入学习界面。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154844659.png" alt="image-20230611154844659"></p>
<p>3、课程收费时引导去支付、或试学。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154849591.png" alt="image-20230611154849591"></p>
<h4 id="_1-2-2-选课流程" tabindex="-1"><a class="header-anchor" href="#_1-2-2-选课流程" aria-hidden="true">#</a> <strong>1.2.2 选课流程</strong></h4>
<p>选课是将课程加入我的课程表的过程。</p>
<p>对免费课程选课后可直接加入我的课程表，对收费课程选课后需要下单支付成功系统自动加入我的课程表。</p>
<p>流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154901217.png" alt="image-20230611154901217"></p>
<h4 id="_1-2-3-支付流程" tabindex="-1"><a class="header-anchor" href="#_1-2-3-支付流程" aria-hidden="true">#</a> <strong>1.2.3 支付流程</strong></h4>
<p>本项目与第三方支付平台对接完成支付操作。</p>
<p>流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154906310.png" alt="image-20230611154906310"></p>
<h4 id="_1-2-4-在线学习" tabindex="-1"><a class="header-anchor" href="#_1-2-4-在线学习" aria-hidden="true">#</a> <strong>1.2.4 在线学习</strong></h4>
<p>选课成功用户可以在线学习，对于免费课程无需选课即可在线学习。</p>
<p>流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154911811.png" alt="image-20230611154911811"></p>
<h4 id="_1-2-5-免费课程续期" tabindex="-1"><a class="header-anchor" href="#_1-2-5-免费课程续期" aria-hidden="true">#</a> <strong>1.2.5 免费课程续期</strong></h4>
<p>免费课程加入我的课程表默认为 1 年有效期，到期用户可申请续期，流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611154916637.png" alt="image-20230611154916637"></p>
<h2 id="_2-添加选课" tabindex="-1"><a class="header-anchor" href="#_2-添加选课" aria-hidden="true">#</a> <strong>2 添加选课</strong></h2>
<h3 id="_2-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_2-1-需求分析" aria-hidden="true">#</a> <strong>2.1 需求分析</strong></h3>
<h4 id="_2-1-1-数据模型" tabindex="-1"><a class="header-anchor" href="#_2-1-1-数据模型" aria-hidden="true">#</a> <strong>2.1.1 数据模型</strong></h4>
<p>选课是将课程加入我的课程表的过程，根据选课的业务流程进行详细分析，业务流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155104121.png" alt="image-20230611155104121"></p>
...
<p>结构如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155108997.png" alt="image-20230611155108997"></p>
<p>选课类型：免费课程、收费课程。</p>
<p>选课状态：选课成功、待支付、选课删除。</p>
<p>对于免费课程：课程价格为 0，有效期默认 365，开始服务时间为选课时间，结束服务时间为选课时间加 1 年后的时间，选课状态为选课成功。</p>
...
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155115475.png" alt="image-20230611155115475"></p>
<h4 id="_2-1-2-执行流程" tabindex="-1"><a class="header-anchor" href="#_2-1-2-执行流程" aria-hidden="true">#</a> <strong>2.1.2 执行流程</strong></h4>
<p>在学习引导处，可以直接将免费课程加入我的课程表，如下图：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155120825.png" alt="image-20230611155120825"></p>
<p>对于收费课程先创建选课记录表，支付成功后，收到支付结果由系统自动加入我的课程表。</p>
<p>执行流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155126023.png" alt="image-20230611155126023"></p>
<h3 id="_2-2-接口开发" tabindex="-1"><a class="header-anchor" href="#_2-2-接口开发" aria-hidden="true">#</a> <strong>2.2 接口开发</strong></h3>
<h4 id="_2-2-1-部署学习中心工程" tabindex="-1"><a class="header-anchor" href="#_2-2-1-部署学习中心工程" aria-hidden="true">#</a> <strong>2.2.1 部署学习中心工程</strong></h4>
<p>从课程资料拷贝学习中心服务工程到自己的工程目录，结构如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155131637.png" alt="image-20230611155131637">注意去修改 nacos 的命名空间。</p>
<p>创建数据库 xc_learning，并导入数据</p>
<p>修改数据库的连接，改成自己的数据库。</p>
<p>nacos 配置文件：learning-api-dev.yaml</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>learning-service-dev.yaml</p>
...
<p>内容管理服务提供查询课程信息接口，此接口从课程发布表查询。</p>
<p>此接口主要提供其它微服务远程调用，所以此接口不用授权，本项目标记此类接口统一以 /r 开头。</p>
<p>在课程发布 controller 类中定义课程发布信息查询接口。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于是在网关处进行令牌校验，所以在微服务处不再校验令牌的合法性，修改内容管理 content-api 工程的 ResouceServerConfig 类，屏蔽 authenticated()。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>学生中心服务远程调用内容管理服务的查询课程发布信息接口。</p>
<p>导入的学习中心工程已经存在 ContentServiceClient 接口，通过此接口远程调用课程查询接口。</p>
<p>编写测试接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>在进行 feign 远程调用时会将字符串转成 LocalDateTime，在 CoursePublish 类中 LocalDateTime 的属性上边添加如下代码：</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-2-5-添加选课接口" tabindex="-1"><a class="header-anchor" href="#_2-2-5-添加选课接口" aria-hidden="true">#</a> <strong>2.2.5 添加选课接口</strong></h4>
<h5 id="_2-2-5-1-接口分析" tabindex="-1"><a class="header-anchor" href="#_2-2-5-1-接口分析" aria-hidden="true">#</a> <strong>2.2.5.1 接口分析</strong></h5>
<p>本接口支持免费课程选课、收费课程选课。</p>
<p>免费课程选课：添加选课记录、添加我的课程表。</p>
<p>收费课程选课：添加选课记录。</p>
<h5 id="_2-2-5-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_2-2-5-2-接口定义" aria-hidden="true">#</a> <strong>2.2.5.2 接口定义</strong></h5>
<p>1、请求参数：课程 id、当前用户 id</p>
<p>2、响应结果：选课记录信息、学习资格</p>
<p>学习资格：[{&quot;code&quot;:&quot;702001&quot;,&quot;desc&quot;:&quot;正常学习&quot;},{&quot;code&quot;:&quot;702002&quot;,&quot;desc&quot;:&quot;没有选课或选课后没有支付&quot;},{&quot;code&quot;:&quot;702003&quot;,&quot;desc&quot;:&quot;已过期需要申请续期或重新支付&quot;}]</p>
<p>接口定义如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-3-添加免费课程" tabindex="-1"><a class="header-anchor" href="#_2-2-5-3-添加免费课程" aria-hidden="true">#</a> <strong>2.2.5.3 添加免费课程</strong></h5>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-4-添加我的课程表" tabindex="-1"><a class="header-anchor" href="#_2-2-5-4-添加我的课程表" aria-hidden="true">#</a> <strong>2.2.5.4 添加我的课程表</strong></h5>
<p>我的课程表的记录来源于选课记录，选课记录成功将课程信息添加到我的课程表。</p>
<p>如果我的课程表已存在课程可能已经过期，如果有新的选课记录则需要更新我的课程表中的现有信息。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-5-添加收费课程" tabindex="-1"><a class="header-anchor" href="#_2-2-5-5-添加收费课程" aria-hidden="true">#</a> <strong>2.2.5.5 添加收费课程</strong></h5>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token comment">//添加收费课程</span>
<span class="token keyword">public</span> <span class="token class-name">XcChooseCourse</span> <span class="token function">addChargeCoruse</span><span class="token punctuation">(</span><span class="token class-name">String</span> userId<span class="token punctuation">,</span><span class="token class-name">CoursePublish</span> coursepublish<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-6-获取学习资格" tabindex="-1"><a class="header-anchor" href="#_2-2-5-6-获取学习资格" aria-hidden="true">#</a> <strong>2.2.5.6 获取学习资格</strong></h5>
<p>定义获取学习资格接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">MyCourseTablesService</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-7-service-接口完善" tabindex="-1"><a class="header-anchor" href="#_2-2-5-7-service-接口完善" aria-hidden="true">#</a> <strong>2.2.5.7 service 接口完善</strong></h5>
<p>完善 Service 接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Transactional</span>
<span class="token annotation punctuation">@Override</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_2-2-5-8-完善-controller" tabindex="-1"><a class="header-anchor" href="#_2-2-5-8-完善-controller" aria-hidden="true">#</a> <strong>2.2.5.8 完善 controller</strong></h5>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Autowired</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-接口测试" tabindex="-1"><a class="header-anchor" href="#_2-3-接口测试" aria-hidden="true">#</a> <strong>2.3 接口测试</strong></h3>
<h4 id="_2-3-1-单元测试" tabindex="-1"><a class="header-anchor" href="#_2-3-1-单元测试" aria-hidden="true">#</a> <strong>2.3.1 单元测试</strong></h4>
<p>1、准备测试环境</p>
...
<p>5、生成令牌，为方便生成令牌暂时将 PasswordAuthServiceImpl 类中的验证码屏蔽</p>
<p>6、使用 httpclient 测试如下：</p>
<div class="language-http line-numbers-mode" data-ext="http"><pre v-pre class="language-http"><code>#### 添加选课
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-2-前后端联调" tabindex="-1"><a class="header-anchor" href="#_2-3-2-前后端联调" aria-hidden="true">#</a> <strong>2.3.2 前后端联调</strong></h4>
<p>测试流程：</p>
...
<p>1、进入课程详情点击马上学习</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155550670.png" alt="image-20230611155550670"></p>
<p>2、课程免费时引导加入我的课程表、或进入学习界面。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155554764.png" alt="image-20230611155554764"></p>
<h2 id="_3-支付" tabindex="-1"><a class="header-anchor" href="#_3-支付" aria-hidden="true">#</a> <strong>3 支付</strong></h2>
<h3 id="_3-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_3-1-需求分析" aria-hidden="true">#</a> <strong>3.1 需求分析</strong></h3>
<h4 id="_3-1-1-执行流程" tabindex="-1"><a class="header-anchor" href="#_3-1-1-执行流程" aria-hidden="true">#</a> <strong>3.1.1 执行流程</strong></h4>
<p>用户去学习收费课程时引导其去支付，如下图：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155559312.png" alt="image-20230611155559312"></p>
<p>当用户点击“微信支付”或支付宝支付时执行流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155603305.png" alt="image-20230611155603305"></p>
...
<h4 id="_3-1-2-通用订单服务设计" tabindex="-1"><a class="header-anchor" href="#_3-1-2-通用订单服务设计" aria-hidden="true">#</a> <strong>3.1.2 通用订单服务设计</strong></h4>
<p>在本项目中不仅选课需要下单、购买学习资料、老师一对一答疑等所以收费项目都需要下单支付。</p>
<p>所以本项目设计通用的订单服务，通用的订单服务承接各业务模块的收费支付需求，当用户需要交费时统一生成商品订单并进行支付。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155609750.png" alt="image-20230611155609750"></p>
<p>所有收费业务最终转换为商品订单记录在订单服务的商品订单表。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155614327.png" alt="image-20230611155614327"></p>
<p>以选课为例，选课记录表的 ID 记录在商品订单表的 out_business_id 字段。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155618433.png" alt="image-20230611155618433"></p>
<h3 id="_3-2-支付接口调研" tabindex="-1"><a class="header-anchor" href="#_3-2-支付接口调研" aria-hidden="true">#</a> <strong>3.2 支付接口调研</strong></h3>
<h4 id="_3-2-1-微信支付接口调研" tabindex="-1"><a class="header-anchor" href="#_3-2-1-微信支付接口调研" aria-hidden="true">#</a> <strong>3.2.1 微信支付接口调研</strong></h4>
<p>一般情况下，一个网站要支持在线支付功能通常接入第三方支付平台，比如：微信支付、支付宝、其它的聚合支付平台。</p>
<p>本项目的需求实现手机扫码支付，现在对微信、支付宝的支付接口进行调研。</p>
<p>微信目前提供的支付方式如下：</p>
<p>地址：https://pay.weixin.qq.com/static/product/product_index.shtml</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155624227.png" alt="image-20230611155624227"></p>
<p>1、付款码支付是指用户展示微信钱包内的“付款码”给商户系统扫描后直接完成支付，适用于线下场所面对面收银的场景，例如商超、便利店、餐饮、医院、学校、电影院和旅游景区等具有明确经营地址的实体场所。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155628749.png" alt="image-20230611155628749"></p>
<p>2、JSAPI 支付是指商户通过调用微信支付提供的 JSAPI 接口，在支付场景中调起微信支付模块完成收款</p>
<p>线下场所：调用接口生成二维码，用户扫描二维码后在微信浏览器中打开页面后完成支付</p>
<p>公众号场景：用户在微信公众账号内进入商家公众号，打开某个主页面，完成支付</p>
<p>PC 网站场景：在网站中展示二维码，用户扫描二维码后在微信浏览器中打开页面后完成支付</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155634450.png" alt="image-20230611155634450"></p>
<p>3、小程序支付是指商户通过调用微信支付小程序支付接口，在微信小程序平台内实现支付功能；用户打开商家助手小程序下单，输入支付密码并完成支付后，返回商家小程序。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155637962.png" alt="image-20230611155637962"></p>
<p>4、Native 支付是指商户系统按微信支付协议生成支付二维码，用户再用微信“扫一扫”完成支付的模式。该模式适用于 PC 网站、实体店单品或订单、媒体广告支付等场景。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155642831.png" alt="image-20230611155642831"></p>
<p>5、APP 支付是指商户通过在移动端应用 APP 中集成开放 SDK 调起微信支付模块来完成支付。适用于在移动端 APP 中集成微信支付功能的场景。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155647113.png" alt="image-20230611155647113"></p>
<p>6、刷脸支付是指用户在刷脸设备前通过摄像头刷脸、识别身份后进行的一种支付方式，安全便捷。适用于线下实体场所的收银场景，如商超、餐饮、便利店、医院、学校等。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155651198.png" alt="image-20230611155651198"></p>
<blockquote>
<p>以上接口 native 和 JSAPI 都可以实现 pc 网站实现扫码支付，两者区别是什么？怎么选择？</p>
</blockquote>
<p>JSAPI 除了在 pc 网站扫码支付还可以实现公众号页面内支付，可以实现在手机端 H5 页面唤起微信客户端完成支付。</p>
<p>本项目选择 JSAPI 支付接口。</p>
<p>接口文档：https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter3_1_1.shtml</p>
<blockquote>
<p>如何开通 JSAPI 支付接口?</p>
</blockquote>
<p>以企业身份注册微信公众号<a href="https://mp.weixin.qq.com/" target="_blank" rel="noopener noreferrer">https://mp.weixin.qq.com/<ExternalLinkIcon/></a></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155706237.png" alt="image-20230611155706237"></p>
<p>登录公众号，点击左侧菜单“微信支付”开通微信支付，如下：</p>
<p>需要提供营业执照、身份证等信息。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155710577.png" alt="image-20230611155710577"></p>
<p>点击申请接入，需要注册微信商户号。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155714951.png" alt="image-20230611155714951"></p>
<p>注册微信商户号的过程请参考官方文档，本文档略。参考地址如下：</p>
<p><a href="https://pay.weixin.qq.com/index.php/apply/applyment_home/guide_normal#none" target="_blank" rel="noopener noreferrer">https://pay.weixin.qq.com/index.php/apply/applyment_home/guide_normal#none<ExternalLinkIcon/></a></p>
<p>开通微信支付后即可在微信商户平台（pay.weixin.qq.com）开通 JSAPI 支付。</p>
<p>登录商品平台，进入产品中心，开通 JSAPI 支付：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155720368.png" alt="image-20230611155720368"></p>
<p>注意：JSAPI 支付方式需要在公众号配置回调域名，此域名为已经备案的外网域名。</p>
<p>最后在公众号开发信息中获取：开发者 id、开发者密码。</p>
<h4 id="_3-2-2-支付宝接口调研" tabindex="-1"><a class="header-anchor" href="#_3-2-2-支付宝接口调研" aria-hidden="true">#</a> <strong>3.2.2 支付宝接口调研</strong></h4>
<p>支付宝支付产品如下：</p>
<p>文档：https://b.alipay.com/signing/productSetV2.htm</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155726032.png" alt="image-20230611155726032"></p>
<p>与本项目需求相关的接口：电脑网站支付、手机网站支付。</p>
<p>1、电脑网站支付</p>
<p>PC 网站轻松收款，资金马上到账：用户在商家 PC 网站消费，自动跳转支付宝 PC 网站收银台完成付款。 交易资金直接打入商家支付宝账户，实时到账。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155730666.png" alt="image-20230611155730666"></p>
<p>2、手机网站支付</p>
<p>用户在商家手机网站消费，通过浏览器自动跳转支付宝 APP 或支付宝网页完成付款。 轻松实现和 APP 支付相同的支付体验。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155735458.png" alt="image-20230611155735458"></p>
<p>对比两种支付方式：手机网站支付方式可以在 H5 网页唤起支付宝，手机扫码支付可以使用手机网站支付方式来完成，相比电脑网站支付形式更灵活。</p>
<p>本项目选择手机网站支付方式。</p>
<p>文档：https://opendocs.alipay.com/open/02ivbt</p>
<blockquote>
<p>如何开通支付宝手机网站支付接口？</p>
</blockquote>
<p>进入网址：https://b.alipay.com/signing/productDetailV2.htm?productId=I1011000290000001001</p>
<p>点击：立即开通</p>
<p>上传营业执照等资料，提交审核，根据提示进行开通。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611155748587.png" alt="image-20230611155748587"></p>
<h3 id="_3-3-准备开发环境" tabindex="-1"><a class="header-anchor" href="#_3-3-准备开发环境" aria-hidden="true">#</a> <strong>3.3 准备开发环境</strong></h3>
<h4 id="_3-3-1-支付宝开发环境" tabindex="-1"><a class="header-anchor" href="#_3-3-1-支付宝开发环境" aria-hidden="true">#</a> <strong>3.3.1 支付宝开发环境</strong></h4>
<p>第三方支付接口流程大同小异，考虑开发及教学的方便性，支付宝提供支付宝沙箱环境开发支付接口，在教学中接入支付宝手机网站支付接口。</p>
<p>1、配置沙箱环境</p>
...
<p>网站必须通过 ICP 备案。如为个体工商户，网站备案主体需要与支付宝账户主体名称一致；</p>
<p>如为个体工商户，则团购不开放，且古玩、珠宝等奢侈品、投资类行业无法申请本产品。</p>
<p>详细参见：<a href="https://docs.open.alipay.com/203" target="_blank" rel="noopener noreferrer">https://docs.open.alipay.com/203<ExternalLinkIcon/></a></p>
<p>本文档使用支付宝沙箱进行开发测试，这里主要介绍支付宝沙箱环境配置。</p>
<p>详细参见：<a href="https://docs.open.alipay.com/200/105311/" target="_blank" rel="noopener noreferrer">https://docs.open.alipay.com/200/105311/<ExternalLinkIcon/></a></p>
<p>开发过程需要三个支付参数：app_id、应用私钥、支付宝公钥，下边在支付宝开发平台配置沙箱环境。</p>
<p>进入支付宝开放平台：https://open.alipay.com/</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160557635.png" alt="image-20230611160557635"></p>
<p>点击登录，使用自己的支付宝账号扫码登录即可。</p>
<p>登录成功，进入控制台：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160602595.png" alt="image-20230611160602595"></p>
<p>在控制台首页最下方 点击进入沙箱环境</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160605932.png" alt="image-20230611160605932"></p>
<p>进入沙箱环境页面列出了应用信息，其中就有我们需要的 appid。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160608908.png" alt="image-20230611160608908"></p>
<p>点击“查看”，查看密钥，开发需要支付宝公钥和应用私钥，稍后我们需要使用它们进行开发测试。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160614175.png" alt="image-20230611160614175"></p>
<p>根据测试需要进行充值（沙箱环境为虚拟充值）</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160618118.png" alt="image-20230611160618118"></p>
<p>2、模拟器</p>
...
<p>安装成功，启动模拟器</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160623067.png" alt="image-20230611160623067"></p>
<p>下一步在模拟器安装支付宝：</p>
<p>选择课程资料中支付宝安装包 wallet_101521226_client_release_201812261416.apk（沙箱版本）</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160627678.png" alt="image-20230611160627678"></p>
<p>安装成功后支付宝客户端的快捷方式出现在桌面上。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160632712.png" alt="image-20230611160632712"></p>
<p>使用沙箱环境的买家账号登录沙箱版本的支付宝。</p>
<p>查看沙箱环境的账号：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160636353.png" alt="image-20230611160636353"></p>
<h4 id="_3-3-2-创建订单服务" tabindex="-1"><a class="header-anchor" href="#_3-3-2-创建订单服务" aria-hidden="true">#</a> <strong>3.3.2 创建订单服务</strong></h4>
<p>拷贝课程资料目录下的订单服务工程 xuecheng-plus-orders 到自己的工程目录。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160641126.png" alt="image-20230611160641126"></p>
<p>创建 xc_orders 数据库，并导入 xcplus_orders.sql</p>
<p>修改 nacos 中 orders-service-dev.yaml 的数据库连接参数。</p>
<h3 id="_3-4-支付接口测试" tabindex="-1"><a class="header-anchor" href="#_3-4-支付接口测试" aria-hidden="true">#</a> <strong>3.4 支付接口测试</strong></h3>
<h4 id="_3-4-1-阅读接口定义" tabindex="-1"><a class="header-anchor" href="#_3-4-1-阅读接口定义" aria-hidden="true">#</a> <strong>3.4.1 阅读接口定义</strong></h4>
<p>手机网站支付接入流程详细参见：<a href="https://docs.open.alipay.com/203/105285/" target="_blank" rel="noopener noreferrer">https://docs.open.alipay.com/203/105285/<ExternalLinkIcon/></a></p>
<p>1、接口交互流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160650446.png" alt="image-20230611160650446"></p>
<p>1）用户在商户的 H5 网站下单支付后，商户系统按照<a href="https://docs.open.alipay.com/203/107090" target="_blank" rel="noopener noreferrer">手机网站支付接口 alipay.trade.wap.pay<ExternalLinkIcon/></a>API 的参数规范生成订单数据</p>
<p>2）前端页面通过 Form 表单的形式请求到支付宝。此时支付宝会自动将页面跳转至支付宝 H5 收银台页面，如果用户手机上安装了支付宝 APP，则自动唤起支付宝 APP。</p>
<p>3）输入支付密码完成支付。</p>
<p>4）用户在支付宝 APP 或 H5 收银台完成支付后，会根据商户在手机网站支付 API 中传入的前台回跳地址 return_url 自动跳转回商户页面，同时在 URL 请求中以 Query String 的形式附带上支付结果参数，详细回跳参数见“手机网站支付接口 alipay.trade.wap.pay”<a href="https://docs.open.alipay.com/203/107090#s2" target="_blank" rel="noopener noreferrer">前台回跳参数<ExternalLinkIcon/></a>。</p>
<p>5）支付宝还会根据原始支付 API 中传入的异步通知地址 notify_url，通过 POST 请求的形式将支付结果作为参数通知到商户系统，详情见<a href="https://docs.open.alipay.com/203/105286" target="_blank" rel="noopener noreferrer">支付结果异步通知<ExternalLinkIcon/></a>。</p>
<p>2、接口定义</p>
<p>文档：https://opendocs.alipay.com/open/203/107090</p>
<p>接口定义：外部商户请求支付宝创建订单并支付</p>
<p>公共参数</p>
<p><strong>请求地址</strong>：</p>
<p>开发中使用沙箱地址：<a href="https://openapi.alipaydev.com/gateway.do" target="_blank" rel="noopener noreferrer">https://openapi.alipaydev.com/gateway.do<ExternalLinkIcon/></a></p>
<p>请求参数：</p>
<p>详细查阅https://opendocs.alipay.com/open/203/107090</p>
<p>一部分由 sdk 设置，一部分需要编写程序时指定。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160700930.png" alt="image-20230611160700930"></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160707737.png" alt="image-20230611160707737"></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160711897.png" alt="image-20230611160711897"></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160714869.png" alt="image-20230611160714869"></p>
<p>其它扩展参数参见接口文档。</p>
<p>3、示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160731156.png" alt="image-20230611160731156"></p>
<h4 id="_3-4-3-支付接口测试" tabindex="-1"><a class="header-anchor" href="#_3-4-3-支付接口测试" aria-hidden="true">#</a> <strong>3.4.3 支付接口测试</strong></h4>
<h5 id="_3-4-3-1-编写下单代码" tabindex="-1"><a class="header-anchor" href="#_3-4-3-1-编写下单代码" aria-hidden="true">#</a> <strong>3.4.3.1 编写下单代码</strong></h5>
<p>根据接口流程，首先在订单服务编写测试类请求支付宝下单的接口。</p>
<p>在订单服务 api 工程添加依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下载示例代码https://opendocs.alipay.com/open/203/105910</p>
<p>拷贝示例代码，修改、测试。</p>
<p>拷贝 AlipayConfig.java 到订单服务的 service 工程。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-4-3-2-生成二维码" tabindex="-1"><a class="header-anchor" href="#_3-4-3-2-生成二维码" aria-hidden="true">#</a> <strong>3.4.3.2 生成二维码</strong></h5>
<p>用户在前端使用支付宝沙箱通过扫码请求下单接口，我们需要生成订单服务的下单接口的二维码。</p>
<p>ZXing 是一个开源的类库，是用 Java 编写的多格式的 1D / 2D 条码图像处理库，使用 ZXing 可以生成、识别 QR Code（二维码）。常用的二维码处理库还有 zbar，近几年已经不再更新代码，下边介绍 ZXing 生成二维码的方法。</p>
<p>1）引入依赖</p>
<p>在 base 工程 pom.xml 中添加依赖：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）生成二维码方法</p>
<p>拷贝课程资料中 utils 下的 QRCodeUtil.java 到 base 工程 util 包下。</p>
<p>测试根据内容生成二维码方法，在 QRCodeUtil 中添加 main 方法如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 main 方法输入二维码图片的 base64 串，如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将 base64 串复制到浏览器地址后回车将展示一个二维码，用户用手机扫此二维码将请求至http://www.itcast.cn/。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160853225.png" alt="image-20230611160853225"></p>
<h5 id="_3-4-3-3-接口测试" tabindex="-1"><a class="header-anchor" href="#_3-4-3-3-接口测试" aria-hidden="true">#</a> <strong>3.4.3.3 接口测试</strong></h5>
<p>1、生成订单服务下单接口的二维码</p>
<p>修改二维码生成的代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
      <span class="token class-name">QRCodeUtil</span> qrCodeUtil <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">QRCodeUtil</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 main 方法，复制输出到控制台的 base64 串。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>打开模拟器，在模拟器中打开浏览器，将 base64 串复制到浏览器的地址栏。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160927317.png" alt="image-20230611160927317"></p>
<p>使用截屏工具进行截屏，稍后使用支付宝沙箱客户端扫此图片。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160931802.png" alt="image-20230611160931802"></p>
<p>2、启动订单服务</p>
<p>3、打开模拟器，在模拟器中打开支付宝沙箱客户端，并使用沙箱客户端账号密码登录。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160938363.png" alt="image-20230611160938363"></p>
<p>点击扫一扫选择相册中刚才截屏的二维码</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160944292.png" alt="image-20230611160944292"></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160950503.png" alt="image-20230611160950503"></p>
<p>扫码后如果提示系统繁忙再重试</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611160958247.png" alt="image-20230611160958247"></p>
<p>如果提示请求勿重复提交则需要修改下单测试代码中指定的 out_trade_no 商品订单号，订单号在每个商户是唯一的，每次支付前修改 out_trade_no 为一个没有使用过的订单号。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161005577.png" alt="image-20230611161005577"></p>
<p>修改订单号后重启订单服务，再使用沙箱支付宝客户端扫码</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161011597.png" alt="image-20230611161011597"></p>
<p>输入支付密码进行支付。</p>
<p>支付密码为沙箱账号的支付密码，此支付所扣款为沙箱账号的虚拟货币余额。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161021705.png" alt="image-20230611161021705"></p>
<p>支付成功界面：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161029711.png" alt="image-20230611161029711"></p>
<h4 id="_3-4-4-支付结果查询接口" tabindex="-1"><a class="header-anchor" href="#_3-4-4-支付结果查询接口" aria-hidden="true">#</a> <strong>3.4.4 支付结果查询接口</strong></h4>
<p>支付完成可以调用第三方支付平台的支付结果查询接口 查询支付结果。</p>
<p>文档：https://opendocs.alipay.com/open/02ivbt</p>
<p>示例代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>刚才订单付款成功，可以使用 out_trade_no 商品订单号或支付宝的交易流水号 trade_no 去查询支付结果。</p>
<p>out_trade_no 商品订单号: 是在下单请求时指定的商品订单号。</p>
<p>支付宝的交易流水号 trade_no：是支付完成后支付宝通知支付结果时发送的 trade_no</p>
<p>我们使用 out_trade_no 商品订单号去查询，代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>orders<span class="token punctuation">.</span>api</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行代码，输出如下：</p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>
调用成功
TRADE_SUCCESS

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出结果即是调用支付宝查询接口查询到的支付结果</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161115931.png" alt="image-20230611161115931"></p>
<p>参考文档https://opendocs.alipay.com/open/02ivbt 查阅每个参数的意义。</p>
<p>我们主要需要下边的参数：</p>
...
<h4 id="_3-4-5-支付结果通知接口" tabindex="-1"><a class="header-anchor" href="#_3-4-5-支付结果通知接口" aria-hidden="true">#</a> <strong>3.4.5 支付结果通知接口</strong></h4>
<h5 id="_3-4-5-1-准备环境" tabindex="-1"><a class="header-anchor" href="#_3-4-5-1-准备环境" aria-hidden="true">#</a> <strong>3.4.5.1 准备环境</strong></h5>
<p>对于手机网站支付产生的交易，支付宝会通知商户支付结果，有两种通知方式，通过 return_url、notify_url 进行通知，使用 return_url 不能保证通知到位，推荐使用 notify_url 完成支付结构通知。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161122366.png" alt="image-20230611161122366"></p>
<p>具体的使用方法是在调用下单接口的 API 中传入的异步通知地址 notify_url，通过 POST 请求的形式将支付结果作为参数通知到商户系统。详情可查看 <a href="https://opendocs.alipay.com/support/01raw4" target="_blank" rel="noopener noreferrer">支付宝异步通知说明<ExternalLinkIcon/></a> 。</p>
<p>文档：https://opendocs.alipay.com/open/203/105286</p>
<p>根据下单执行流程，订单服务收到支付结果需要对内容进行验签，验签过程如下：</p>
<p>在通知返回参数列表中，除去 sign、sign_type 两个参数外，凡是通知返回回来的参数皆是待验签的参数。将剩下参数进行 url_decode，然后进行字典排序，组成字符串，得到待签名字符串； 生活号异步通知组成的待验签串里需要保留 sign_type 参数。</p>
<p>将签名参数（sign）使用 base64 解码为字节码串；</p>
<p>使用 RSA 的验签方法，通过签名字符串、签名参数（经过 base64 解码）及支付宝公钥验证签名。</p>
<p>验证签名正确后，必须再严格按照如下描述校验通知数据的正确性。</p>
<p>在上述验证通过后，商户必须根据支付宝不同类型的业务通知，正确的进行不同的业务处理，并且过滤重复的通知结果数据。</p>
<p>通过验证 out_trade_no、total_amount、appid 参数的正确性判断通知请求的合法性。</p>
<p>验证的过程可以参考 sdk demo 代码，下载 sdk demo 代码，https://opendocs.alipay.com/open/203/105910</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161134639.png" alt="image-20230611161134639"></p>
<p>参考 demo 中的 alipay.trade.wap.pay-java-utf-8\WebContent\ notify_url.jsp</p>
<p>另外，支付宝通知订单服务的地址必须为外网域名且备案通过可以正常访问。</p>
<p>此接口仍然使用内网穿透技术。</p>
<h5 id="_3-4-5-2-编写测试代码" tabindex="-1"><a class="header-anchor" href="#_3-4-5-2-编写测试代码" aria-hidden="true">#</a> <strong>3.4.5.2 编写测试代码</strong></h5>
<p>1、在下单请求时设置通知地址 request.setNotifyUrl(&quot;商户自己的 notify_url 地址&quot;);</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、编写接收通知接口，接收参数并验签</p>
<p>参考课程资料下的 alipay.trade.wap.pay-java-utf-8\WebContent\notify_url.jsp</p>
<p>代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>1、重启订单服务，并在接收通知接口中打上断点</p>
<p>2、配置内网穿透的本地端口为订单服务端口，启动内网穿透客户端。</p>
<p>3、打开模拟器、支付宝沙箱，扫码、支付。</p>
<p>4、观察接收订单支付数据等是否正常。</p>
<h3 id="_3-5-生成支付二维码" tabindex="-1"><a class="header-anchor" href="#_3-5-生成支付二维码" aria-hidden="true">#</a> <strong>3.5 生成支付二维码</strong></h3>
<h4 id="_3-5-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_3-5-1-需求分析" aria-hidden="true">#</a> <strong>3.5.1 需求分析</strong></h4>
<h5 id="_3-5-1-1-执行流程" tabindex="-1"><a class="header-anchor" href="#_3-5-1-1-执行流程" aria-hidden="true">#</a> <strong>3.5.1.1 执行流程</strong></h5>
<p>再次打开课程支付引导界面，<code v-pre>点击“支付宝支付”按钮系统该如何处理？</code></p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161211867.png" alt="image-20230611161211867"></p>
<p>点击“支付宝支付”此时打开支付二维码，用户扫码支付。</p>
<p>所以首先需要生成支付二维码，用户扫描二维码开始请求支付宝下单，在向支付宝下单前需要添加选课记录、创建商品订单、生成支付记录。</p>
<p>生成二维码执行流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161217060.png" alt="image-20230611161217060"></p>
<p>执行流程：</p>
<p>1、前端调用学习中心服务的添加选课接口。</p>
<p>2、添加选课成功请求订单服务生成支付二维码接口。</p>
<p>3、生成二维码接口：创建商品订单、生成支付记录、生成二维码。</p>
<p>4、将二维码返回到前端，用户扫码。</p>
<p>用户扫码支付流程如下：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161222339.png" alt="image-20230611161222339"></p>
<p>执行流程：</p>
<p>1、用户输入支付密码，支付成功。</p>
<p>2、接收第三方平台通知的支付结果。</p>
<p>3、根据支付结果更新支付记录的支付状态为支付成功。</p>
<h5 id="_3-5-1-2-数据模型" tabindex="-1"><a class="header-anchor" href="#_3-5-1-2-数据模型" aria-hidden="true">#</a> <strong>3.5.1.2 数据模型</strong></h5>
<p>订单支付模式的核心由三张表组成：订单表、订单明细表、支付记录表。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161228016.png" alt="image-20230611161228016"></p>
<p>订单表：记录订单信息</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161232342.png" alt="image-20230611161232342"></p>
<p>订单明细表记录订单的详细信息</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161235094.png" alt="image-20230611161235094"></p>
<p>支付记录表记录每次支付的详细信息</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161238383.png" alt="image-20230611161238383"></p>
<blockquote>
<p>为什么创建支付记录表？</p>
</blockquote>
<p>在请求微信、支付宝或其它第三方支付平台下单接口时需要传入商户的订单号，如果将我们系统的商品订单号直接传给第三方支付平台，<strong>当支付交易关闭或其它什么原因就导致第三方支付平台报“订单号已存在”，此时我们系统的订单将无法完成支付</strong>，我们的需求是用户什么时候想支付都可以完成支付。</p>
<p>解决以上问题的方案是：</p>
<p>1、用户每次发起支付都创建一个新的支付记录 ，此支付记录与商品订单关联。</p>
<p>2、将支付记录的流水号传给第三方支付系统的下单接口，这样即可解决上边的问题。</p>
<p>3、不过在程序中要考虑重复支付的问题。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161245410.png" alt="image-20230611161245410"></p>
<h4 id="_3-5-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_3-5-2-接口定义" aria-hidden="true">#</a> <strong>3.5.2 接口定义</strong></h4>
<p>在订单服务中定义生成支付二维码接口。</p>
<p>请求：订单信息</p>
<p>响应：支付记录及二维码</p>
<p>下边先定义模型类再定义接口：</p>
<p>请求的订单模型类：</p>
...
<h5 id="_3-5-3-1-保存商品订单" tabindex="-1"><a class="header-anchor" href="#_3-5-3-1-保存商品订单" aria-hidden="true">#</a> <strong>3.5.3.1 保存商品订单</strong></h5>
<p>定义保存订单信息接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>年月日时分秒毫秒+随机数</p>
<p>2、高并发场景</p>
<p>年月日时分秒毫秒+随机数+redis 自增序列</p>
<p>3、订单号中加上业务标识</p>
<p>订单号加上业务标识方便客服，比如：第 10 位是业务类型，第 11 位是用户类型等。</p>
<p>4、雪花算法</p>
<p>雪花算法是推特内部使用的分布式环境下的唯一 ID 生成算法，它基于时间戳生成，保证有序递增，加以入计算机硬件等元素，可以满足高并发环境下 ID 不重复。</p>
<p>本项目订单号生成采用雪花算法。</p>
<p>第二：商品订单的数据来源于选课记录，在订单表需要存入选课记录的 ID，这里需要作好幂等处理。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-5-3-2-创建支付记录" tabindex="-1"><a class="header-anchor" href="#_3-5-3-2-创建支付记录" aria-hidden="true">#</a> <strong>3.5.3.2 创建支付记录</strong></h5>
<p>编写创建支付记录的方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-5-3-3-生成支付二维码" tabindex="-1"><a class="header-anchor" href="#_3-5-3-3-生成支付二维码" aria-hidden="true">#</a> <strong>3.5.3.3 生成支付二维码</strong></h5>
<p>1、在 nacos 中 orders-service-dev.yaml 配置二维码的 url</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、完善创建订单 service 方法:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-5-3-5-扫码下单接口" tabindex="-1"><a class="header-anchor" href="#_3-5-3-5-扫码下单接口" aria-hidden="true">#</a> <strong>3.5.3.5 扫码下单接口</strong></h5>
<p>生成了支付二维码，用户扫码请求第三方支付平台下单，下单成功用户完成支付。</p>
<p>1、定义用户扫码请求下单接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、定义查询支付记录的 Service 接口与实现方法</p>
<p>扫码下单传入的是支付记录号，根据支付记录号查询支付记录。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、完善扫码下单接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Value</span><span class="token punctuation">(</span><span class="token string">"${pay.alipay.APP_ID}"</span><span class="token punctuation">)</span>
<span class="token class-name">String</span> <span class="token constant">APP_ID</span><span class="token punctuation">;</span>
<span class="token annotation punctuation">@Value</span><span class="token punctuation">(</span><span class="token string">"${pay.alipay.APP_PRIVATE_KEY}"</span><span class="token punctuation">)</span>
...
<p>2、发布一门收费课程。</p>
<p>3、使用资料目录中的新模板 course_template.ftl</p>
<p>测试流程：</p>
<p>1、进入收费课程详细页面，点击马上学习。</p>
<p>2、跟踪浏览器及微服务，观察选课记录是否创建成功、商品订单是否创建成功、支付记录是否创建成功。</p>
<p>3、观察生成二维码是否成功</p>
<p>4、使用模拟器扫码测试，是否可以正常支付。</p>
<p>如果报订单参数异常报如下错误，需要检查请求支付宝的下单数据是否正确。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161524922.png" alt="image-20230611161524922"></p>
<h4 id="_3-5-4-重复支付问题" tabindex="-1"><a class="header-anchor" href="#_3-5-4-重复支付问题" aria-hidden="true">#</a> <strong>3.5.4 重复支付问题</strong></h4>
<p>上边实现中，扫码下单时会根据支付记录号判断是否支付完成，生成二维码时也会判断订单的状态是否支付完成，如果支付完成将不再重新支付，即使这样做也无法绝对避免重复支付。</p>
<p>正常情况下同一个用户的同一个订单不会存在并发扫码支付的问题，但系统是可能存在重复支付的问题的，解决该问题需要单独定义任务，每隔 24 小时查询前一天的订单是否存在重复支付的问题，如果存在则调用第三方支付平台的退款接口进行退款。</p>
<h3 id="_3-6-查询支付结果" tabindex="-1"><a class="header-anchor" href="#_3-6-查询支付结果" aria-hidden="true">#</a> <strong>3.6 查询支付结果</strong></h3>
<h4 id="_3-6-1-接口定义" tabindex="-1"><a class="header-anchor" href="#_3-6-1-接口定义" aria-hidden="true">#</a> <strong>3.6.1 接口定义</strong></h4>
<p>根据前边我们调研的获取支付结果的接口，包括：主动查询支付结果、被动接收支付结果。</p>
<p>这里先实现主动查询支付结果，当支付完成用户点击 “支付完成” 将请求第三方支付平台查询支付结果。</p>
<p>在 OrderController 类中定义接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<h5 id="_3-6-2-1-service-总体接口" tabindex="-1"><a class="header-anchor" href="#_3-6-2-1-service-总体接口" aria-hidden="true">#</a> <strong>3.6.2.1 service 总体接口</strong></h5>
<p>1、定义查询支付结果的 service</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token doc-comment comment">/**
 * 请求支付宝查询支付结果
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、service 实现如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token class-name">PayRecordDto</span> <span class="token function">queryPayResult</span><span class="token punctuation">(</span><span class="token class-name">String</span> payNo<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-6-2-2-查询支付结果" tabindex="-1"><a class="header-anchor" href="#_3-6-2-2-查询支付结果" aria-hidden="true">#</a> <strong>3.6.2.2 查询支付结果</strong></h5>
<p>定义从支付宝查询支付结果的方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token doc-comment comment">/**
 * 请求支付宝查询支付结果
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-6-2-3-保存支付结果" tabindex="-1"><a class="header-anchor" href="#_3-6-2-3-保存支付结果" aria-hidden="true">#</a> <strong>3.6.2.3 保存支付结果</strong></h5>
<p>1、定义保存支付结果的接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token doc-comment comment">/**
 * <span class="token keyword">@description</span> 保存支付宝支付结果
...
<p>完成生成支付二维码</p>
<p>用支付宝扫码但不支付</p>
<p>使用 httpclient 请求查询支付结果，查询失败</p>
<div class="language-http line-numbers-mode" data-ext="http"><pre v-pre class="language-http"><code>
#### 查询支付结果
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>用支付宝扫码再次完成支付</p>
<p>使用 httpclient 请求查询支付结果，支付结果为成功，并更新支付记录状态和订单状态。</p>
<p>3、使用前后端联调</p>
<blockquote>
<p>拷贝资料目录中 LocalDateTimeConfig.java 到 base 工程下，处理 long 转 string 精度损失的问题。</p>
</blockquote>
<p>使用最新的门户代码 xc-ui-pc-static-portal.zip</p>
<h3 id="_3-7-接收支付通知" tabindex="-1"><a class="header-anchor" href="#_3-7-接收支付通知" aria-hidden="true">#</a> <strong>3.7 接收支付通知</strong></h3>
<h4 id="_3-7-1-接口定义" tabindex="-1"><a class="header-anchor" href="#_3-7-1-接口定义" aria-hidden="true">#</a> <strong>3.7.1 接口定义</strong></h4>
<p>支付完成后第三方支付系统会主动通知支付结果，要实现主动通知需要在请求支付系统下单时传入 NotifyUrl，这里有两个 url：NotifyUrl 和 ReturnUrl，ReturnUrl 是支付完成后支付系统携带支付结果重定向到 ReturnUrl 地址，NotifyUrl 是支付完成后支付系统在后台定时去通知，使用 NotifyUrl 比使用 ReturnUrl 有保证。</p>
<p>根据接口描述：https://opendocs.alipay.com/open/203/105286的内容下边在订单服务定义接收支付结果通知的接口。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>接收支付结果通知接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>支付成功更新订单表的状态为空。</p>
<h2 id="_4-支付通知" tabindex="-1"><a class="header-anchor" href="#_4-支付通知" aria-hidden="true">#</a> <strong>4 支付通知</strong></h2>
...
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161756277.png" alt="image-20230611161756277"></p>
...
<h3 id="_4-2-技术方案" tabindex="-1"><a class="header-anchor" href="#_4-2-技术方案" aria-hidden="true">#</a> <strong>4.2 技术方案</strong></h3>
<p>使用消息队列进行异步通知需要保证消息的可靠性，即生产端将消息成功通知到消费端。</p>
<p>消息从生产端发送到消费端经历了如下过程：</p>
<p>1、消息发送到交换机</p>
<p>2、消息由交换机发送到队列</p>
<p>3、消息者收到消息进行处理</p>
<p>保证消息的可靠性需要保证以上过程的可靠性，本项目使用 RabbitMQ 可以通过如下方面保证消息的可靠性。</p>
<p>1、生产者确认机制</p>
<p>发送消息前使用数据库事务将消息保证到数据库表中</p>
<p>成功发送到交换机将消息从数据库中删除</p>
<p>2、mq 持久化</p>
<p>mq 收到消息进行持久化，当 mq 重启即使消息没有消费完也不会丢失。</p>
<p>需要配置交换机持久化、队列持久化、发送消息时设置持久化。</p>
<p>3、消费者确认机制</p>
<p>消费者消费成功自动发送 ack，否则重试消费。</p>
<h3 id="_4-3-发送支付结果" tabindex="-1"><a class="header-anchor" href="#_4-3-发送支付结果" aria-hidden="true">#</a> <strong>4.3 发送支付结果</strong></h3>
<h4 id="_4-3-1-订单服务集成-mq" tabindex="-1"><a class="header-anchor" href="#_4-3-1-订单服务集成-mq" aria-hidden="true">#</a> <strong>4.3.1 订单服务集成 MQ</strong></h4>
<p>订单服务通过消息队列将支付结果发给学习中心服务，消息队列采用发布订阅模式。</p>
<p>1、订单服务创建支付结果通知交换机。</p>
<p>2、学习中心服务绑定队列到交换机。</p>
<p>项目使用 RabbitMQ 作为消息队列，在课前下发的虚拟上已经安装了 RabbitMQ.</p>
<p>执行 docker start rabbitmq 启动 RabbitMQ。访问：http://192.168.101.65:15672/</p>
<p>账户密码：guest/guest</p>
<p>交换机为 Fanout 广播模式。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在 nacos 配置 rabbitmq-dev.yaml 为通用配置文件</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、在订单服务接口工程引入 rabbitmq-dev.yaml 配置文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4、拷贝资料中 MQ 配置类到订单服务的 service 工程。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>orders<span class="token punctuation">.</span>config</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启订单服务，登录 rabbitmq，查看交换机自动创建成功</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161913619.png" alt="image-20230611161913619"></p>
<p>查看队列自动成功</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611161916603.png" alt="image-20230611161916603"></p>
<h4 id="_4-3-2-发送支付结果" tabindex="-1"><a class="header-anchor" href="#_4-3-2-发送支付结果" aria-hidden="true">#</a> <strong>4.3.2 发送支付结果</strong></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编写接口实现方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">notifyPayResult</span><span class="token punctuation">(</span><span class="token class-name">MqMessage</span> message<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-接收支付结果" tabindex="-1"><a class="header-anchor" href="#_4-4-接收支付结果" aria-hidden="true">#</a> <strong>4.4 接收支付结果</strong></h3>
<h4 id="_4-4-1-学习中心服务集成-mq" tabindex="-1"><a class="header-anchor" href="#_4-4-1-学习中心服务集成-mq" aria-hidden="true">#</a> <strong>4.4.1 学习中心服务集成 MQ</strong></h4>
<p>1、在学习中心服务添加消息队列依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.springframework.boot<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>spring-boot-starter-amqp<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在学习中心服务接口工程引入 rabbitmq-dev.yaml 配置文件</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">shared-configs</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">data-id</span><span class="token punctuation">:</span> rabbitmq<span class="token punctuation">-</span>$<span class="token punctuation">{</span>spring.profiles.active<span class="token punctuation">}</span>.yaml
    <span class="token key atrule">group</span><span class="token punctuation">:</span> xuecheng<span class="token punctuation">-</span>plus<span class="token punctuation">-</span>common
    <span class="token key atrule">refresh</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、添加配置类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 MyCourseTablesService 中定义保存选课成功的接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编写接口实现方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Transactional</span>
<span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">boolean</span> <span class="token function">saveChooseCourseSuccess</span><span class="token punctuation">(</span><span class="token class-name">String</span> chooseCourseId<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-5-通知支付结果测试" tabindex="-1"><a class="header-anchor" href="#_4-5-通知支付结果测试" aria-hidden="true">#</a> <strong>4.5 通知支付结果测试</strong></h3>
<p>测试准备：</p>
<p>1、找一门已发布的收费课程。</p>
<p>2、如果在我的课程表存储则删除。</p>
...
<h2 id="_4-在线学习" tabindex="-1"><a class="header-anchor" href="#_4-在线学习" aria-hidden="true">#</a> <strong>4 在线学习</strong></h2>
<h3 id="_4-1-需求分析-1" tabindex="-1"><a class="header-anchor" href="#_4-1-需求分析-1" aria-hidden="true">#</a> <strong>4.1 需求分析</strong></h3>
<p>用户通过课程详情界面点击马上学习 进入 视频插放界面进行视频点播。</p>
<p>获取视频资源时进行学习资格校验，如下图：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162129552.png" alt="image-20230611162129552"></p>
...
<p>详细流程如下图：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162136288.png" alt="image-20230611162136288"></p>
<h3 id="_4-2-查询课程信息" tabindex="-1"><a class="header-anchor" href="#_4-2-查询课程信息" aria-hidden="true">#</a> <strong>4.2 查询课程信息</strong></h3>
<p>在视频点播页面需要查询课程信息，课程上线后也需要访问/api/content/course/whole/{courseId}</p>
<p>课程预览时请求获取课程的接口为：/open/content/course/whole/{courseId}</p>
<p>在 nginx 中进行配置：</p>
<p>/open、/api 在 nginx 的配置如下：<code v-pre>(已经配置的不要重复配置)</code></p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>
        #api
...
<p>进入内容管理服务 api 工程 CoursePublishController 类，定义查询课程预览信息接口如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启内容管理服务，进入学习界面查看课程计划、课程名称等信息是否显示正常。</p>
<h3 id="_4-3-获取视频" tabindex="-1"><a class="header-anchor" href="#_4-3-获取视频" aria-hidden="true">#</a> <strong>4.3 获取视频</strong></h3>
<h4 id="_4-3-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-3-1-需求分析" aria-hidden="true">#</a> <strong>4.3.1 需求分析</strong></h4>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162226958.png" alt="image-20230611162226958"></p>
<h4 id="_4-3-2-接口定义" tabindex="-1"><a class="header-anchor" href="#_4-3-2-接口定义" aria-hidden="true">#</a> <strong>4.3.2 接口定义</strong></h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<p>在学习中心服务 service 工程中定义媒资管理 Feignclient</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>FeignClient 接口的降级类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>xuecheng<span class="token punctuation">.</span>learning<span class="token punctuation">.</span>feignclient</span><span class="token punctuation">;</span>
...
<p>1、完善接口</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ApiOperation</span><span class="token punctuation">(</span><span class="token string">"获取视频"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@GetMapping</span><span class="token punctuation">(</span><span class="token string">"/open/learn/getvideo/{courseId}/{teachplanId}/{mediaId}"</span><span class="token punctuation">)</span>
...
<p>可修改选课记录表中的课程 id 为不存在进行测试，测试完再恢复原样。</p>
<p>3）收费课程没有选课是否可以正常学习</p>
<p>可修改选课记录表中的课程 id 为不存在进行测试，测试完再恢复原样。</p>
<h3 id="_4-4-我的课表" tabindex="-1"><a class="header-anchor" href="#_4-4-我的课表" aria-hidden="true">#</a> <strong>4.4 我的课表</strong></h3>
<h4 id="_4-4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-4-1-需求分析" aria-hidden="true">#</a> <strong>4.4.1 需求分析</strong></h4>
<h5 id="_4-4-1-1-业务流程" tabindex="-1"><a class="header-anchor" href="#_4-4-1-1-业务流程" aria-hidden="true">#</a> <strong>4.4.1.1 业务流程</strong></h5>
<p>登录网站，点击“我的学习”进入个人中心，</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162342280.png" alt="image-20230611162342280"></p>
<p>个人中心首页显示我的课程表：</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162345470.png" alt="image-20230611162345470"></p>
<p>我的课表中显示了选课成功的免费课程、收费课程。最近学习课程显示了当前用户最近学习的课程信息。</p>
<p>点击继续学习进入当前学习章节的视频继续学习。</p>
<p>点击课程评价进入课程评价界面。</p>
<h5 id="_4-4-1-2-配置-nginx" tabindex="-1"><a class="header-anchor" href="#_4-4-1-2-配置-nginx" aria-hidden="true">#</a> <strong>4.4.1.2 配置 nginx</strong></h5>
<p>在 nginx 配置用户中心 server ,如下：</p>
...
<p>在 MyCourseTablesController 中定义我的课程表接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
...
<h5 id="_4-4-3-1dao" tabindex="-1"><a class="header-anchor" href="#_4-4-3-1dao" aria-hidden="true">#</a> <strong>4.4.3.1DAO</strong></h5>
<p>使用自动生成的 mapper 即可实现分页查询。</p>
<h5 id="_4-4-3-2-service" tabindex="-1"><a class="header-anchor" href="#_4-4-3-2-service" aria-hidden="true">#</a> <strong>4.4.3.2 Service</strong></h5>
<p>在 service 中定义我的课程表接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<p>登录网站，点击“我的学习”进入个人中心，查看我的课程表中课程是否是当前用户所选课程。</p>
<p><img src="@source/notes/project/02/第6章 选课学习v3.1/assets/image-20230611162451588.png" alt="image-20230611162451588"></p>
</div></template>
